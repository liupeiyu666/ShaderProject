...
namespace Cinemachine.Timeline
{
    ...
    {        
            ...
            PlayableGraph graph, GameObject go, int inputCount)
        {
            ...
            {
               // Debug.LogError("===========:" + item.sourceObject+"   "+ item.outputTargetType+"   "+ item.streamName+"   "+ pd.GetGenericBinding(item.sourceObject));
            }
            Debug.LogError("-----------:CreateTrackMixer");
            //outputs.GetEnumerator().Current.outputTargetType
