...
namespace Cinemachine.Timeline
{
    public sealed class CinemachineMixer : PlayableBehaviour
    {
        ...
        {
             Debug.LogError("---------------"+ "OnBehaviourPlay:  "+ playable.GetGraph().GetRootPlayable(0)+"   " + Time.frameCount);
        ...
        public override void PrepareData(Playable playable, FrameData info)
        {
            ...
            //   Debug.LogError("PrepareData" + Time.frameCount);
            base.PrepareData(playable, info);
        }
        public override void PrepareFrame(Playable playable, FrameData info)
        {
          //  Debug.LogError("     ---MMMPrepareData   " + info.weight + "    " + Time.frameCount);
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            {
                //  Debug.LogError(i+"----------GetInputCount:"+ playable.GetPlayableType()+ "   GetInputCount:" + playable.GetInputCount()+ "   GetOutputCount:" + playable.GetOutputCount()+"   "+ playable.GetOutput(0).GetPlayableType()+ "   "+ playable.GetInputWeight(i)+"   "+Time.frameCount);
            //    Debug.LogError(i + "----------GetInputCount:" +  "   " + playable.GetInputWeight(i) + "   " + Time.frameCount);
