...
namespace Cinemachine
{
    ...
    public class CinemachineFreeLook : CinemachineVirtualCameraBase
    {
        ...
        /// <summary>If enabled, this lens setting will apply to all three child rigs, otherwise the child rig lens settings will be used
        /// 如果为True则所有的rig共享一个lenssetting，反之则每个rig单独设置
        /// </summary>
        ...
        /// <summary>Controls how automatic recentering of the X axis is accomplished
        /// 控制如何返回x的中心
        /// </summary>
