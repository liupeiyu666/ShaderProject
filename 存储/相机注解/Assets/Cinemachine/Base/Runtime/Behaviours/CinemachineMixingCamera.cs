...
namespace Cinemachine
{
    ...
    /// 混合相机，按照相机顺序依次根据权重进行混合，同时将权重最高的相机设置为当前激活的相机。
    /// 每个相机的权重赋值，需要外部脚本进行。
    ...
    public class CinemachineMixingCamera : CinemachineVirtualCameraBase
    {
        ...
        /// <summary>Set the weight of the child at an index.
        /// 设置相机权重
        /// </summary>
        /// <param name="index">The child index. Only immediate CinemachineVirtualCameraBase 
        /// children are counted.</param>
        ...
        /// <summary>Get the weight of the child CinemachineVirtualCameraBase.
        /// 获取相机的权重
        /// </summary>
        ...
        /// <summary>Set the weight of the child CinemachineVirtualCameraBase.
        /// 设置某个相机的权重
        /// </summary>
        /// <param name="vcam">The child camera.</param>
        /// <param name="w">The weight to set.  Can be any non-negative number.</param>
        ...
        /// <summary>Rebuild the cached list of child cameras.
        /// 获取自己子节点下的相机，并按照顺序赋予对应的下标
        /// </summary>
