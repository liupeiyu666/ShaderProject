...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/FogEffect_SkyBox_Texture_AlphaBlend" {
Properties {
...
void main()
{
    ...
    vs_COLOR0.xyz = in_COLOR0.xyz * _SkyBoxColor.xyz;
...
#endif
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(_EmissionScaler);
    u_xlat16_2.xyz = u_xlat16_1.xyz * vec3(_SkyBoxColorScaler);
    u_xlat16_1.xyz = (-u_xlat16_1.xyz) * vec3(_SkyBoxColorScaler) + vs_COLOR1.xyz;
