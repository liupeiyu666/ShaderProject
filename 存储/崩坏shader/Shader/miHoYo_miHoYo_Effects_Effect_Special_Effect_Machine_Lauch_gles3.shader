...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Effects/Effect_Special/Effect/Machine_Lauch" {
Properties {
...
void main()
{
    ...
    u_xlat0 = u_xlat0 * _LightTime;
    u_xlat16_1.xy = vec2(vs_TEXCOORD1.x + float(-0.5), vs_TEXCOORD1.y + float(-0.5));
    u_xlat16_1.x = dot(u_xlat16_1.xy, u_xlat16_1.xy);
    u_xlat16_1.x = sqrt(u_xlat16_1.x);
    u_xlat16_1.x = (-u_xlat0) * _LightSpeed + u_xlat16_1.x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(abs(u_xlat16_1.x)<_LightWidth);
#else
    u_xlatb0 = abs(u_xlat16_1.x)<_LightWidth;
#endif
    u_xlat10_6 = texture(_LightMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_6 = u_xlat10_6 * _InsideEmission;
    u_xlat6.xyz = vec3(u_xlat16_6) * _LightColor.xyz;
    u_xlat16_1 = vs_COLOR0 * _MainColor;
    u_xlat16_1 = u_xlat16_1 * vec4(vec4(_OutsideEmission, _OutsideEmission, _OutsideEmission, _OutsideEmission));
    u_xlat10_2 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_1 = u_xlat16_1 * u_xlat10_2;
    u_xlat16_2.xyz = (bool(u_xlatb0)) ? u_xlat6.xyz : u_xlat16_1.xyz;
    u_xlat3.xyz = u_xlat6.xyz * vec3(1.5, 1.5, 1.5);
    u_xlat16_4.x = (-_ModeTime) * _LightSpeed + vs_TEXCOORD2.y;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(0.0>=u_xlat16_4.x);
#else
    u_xlatb0 = 0.0>=u_xlat16_4.x;
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb21 = !!(abs(u_xlat16_4.x)<_LightWidth);
#else
    u_xlatb21 = abs(u_xlat16_4.x)<_LightWidth;
#endif
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlatb5 = u_xlat16_4.x>=0.0;
#endif
    u_xlatb11 = u_xlatb0 && u_xlatb21;
    u_xlatb0 = u_xlatb0 || u_xlatb5;
    u_xlatb5 = u_xlatb21 && u_xlatb5;
    u_xlatb0 = u_xlatb21 && u_xlatb0;
    u_xlat16_4.w = (u_xlatb0) ? 0.5 : u_xlat16_1.w;
    u_xlat16_1.xyz = (bool(u_xlatb11)) ? u_xlat3.xyz : u_xlat16_1.xyz;
    u_xlat16_2.w = u_xlat16_1.w;
    u_xlat16_4.xyz = (bool(u_xlatb5)) ? u_xlat6.xyz : u_xlat16_1.xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(0.0<_UseScript);
#else
    u_xlatb0 = 0.0<_UseScript;
#endif
    u_xlat16_0 = (bool(u_xlatb0)) ? u_xlat16_4 : u_xlat16_2;
