...
void main()
{
    ...
    u_xlat10_1 = texture(_MatCap, vs_TEXCOORD1.xy);
    u_xlat16_0 = u_xlat10_0 * u_xlat10_1;
    u_xlat16_0 = u_xlat16_0 + u_xlat16_0;
    u_xlat16_2.xyz = (-u_xlat16_0.xyz) * _Color.xyz + vs_COLOR1.xyz;
...
void main()
{
    ...
    u_xlat1.x = in_NORMAL0.x * hlslcc_mtx4x4unity_WorldToObject[0].x;
    u_xlat1.y = in_NORMAL0.x * hlslcc_mtx4x4unity_WorldToObject[1].x;
    u_xlat1.z = in_NORMAL0.x * hlslcc_mtx4x4unity_WorldToObject[2].x;
    u_xlat2.x = in_NORMAL0.y * hlslcc_mtx4x4unity_WorldToObject[0].y;
    u_xlat2.y = in_NORMAL0.y * hlslcc_mtx4x4unity_WorldToObject[1].y;
    u_xlat2.z = in_NORMAL0.y * hlslcc_mtx4x4unity_WorldToObject[2].y;
    u_xlat1.xyz = u_xlat1.xyz + u_xlat2.xyz;
    u_xlat2.x = in_NORMAL0.z * hlslcc_mtx4x4unity_WorldToObject[0].z;
    u_xlat2.y = in_NORMAL0.z * hlslcc_mtx4x4unity_WorldToObject[1].z;
    u_xlat2.z = in_NORMAL0.z * hlslcc_mtx4x4unity_WorldToObject[2].z;
    u_xlat1.xyz = u_xlat1.xyz + u_xlat2.xyz;
...
#endif
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(u_xlat16_2) + vs_COLOR1.xyz;
    SV_Target0.w = u_xlat16_0.w;
    return;
}
