...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/Metal Floor (With Pow)" {
Properties {
...
void main ()
{
  highp vec4 ShadowColor_1;
  highp vec4 baseTexColor_2;
  highp vec4 outColor_3;
  lowp vec4 tmpvar_4;
  tmpvar_4 = texture2D (_MainTex, xlv_TEXCOORD0);
  baseTexColor_2 = tmpvar_4;
  lowp vec4 tmpvar_5;
  tmpvar_5 = texture2D (_ShadowTex, xlv_TEXCOORD5);
  ShadowColor_1 = tmpvar_5;
  highp vec4 tmpvar_6;
  tmpvar_6.xyz = (((baseTexColor_2.xyz * _Color.xyz) * (
    (((2.0 * ShadowColor_1.xyz) * ShadowColor_1.w) + 1.0)
   - ShadowColor_1.w)) * _LightMapIntensity);
  tmpvar_6.w = _BloomFactor;
  outColor_3.w = tmpvar_6.w;
  mediump vec3 srcColor_7;
  srcColor_7 = tmpvar_6.xyz;
  mediump vec3 fogColor_8;
  fogColor_8 = xlv_COLOR1.xyz;
  mediump float factor_9;
  factor_9 = xlv_COLOR1.w;
  mediump vec3 tmpvar_10;
  tmpvar_10 = mix (srcColor_7, fogColor_8, vec3(factor_9));
  outColor_3.xyz = tmpvar_10;
...
void main ()
{
  ...
  srcColor_8 = tmpvar_6.xyz;
  mediump vec3 fogColor_9;
  fogColor_9 = xlv_COLOR1.xyz;
  mediump float factor_10;
  factor_10 = xlv_COLOR1.w;
  tmpvar_7 = (fogColor_9 + (srcColor_8 * clamp (factor_10, 0.0, 1.0)));
  outColor_3.xyz = tmpvar_7;
  gl_FragData[0] = outColor_3;
}
...
void main ()
{
  highp vec4 reflColor_1;
  highp vec2 brushedValue_2;
  highp float fresnel_3;
  highp vec4 ShadowColor_4;
  highp vec4 baseTexColor_5;
  highp vec4 outColor_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture2D (_MainTex, xlv_TEXCOORD0);
  baseTexColor_5 = tmpvar_7;
  lowp vec4 tmpvar_8;
  tmpvar_8 = texture2D (_ShadowTex, xlv_TEXCOORD5);
  ShadowColor_4 = tmpvar_8;
  highp vec3 tmpvar_9;
  tmpvar_9 = normalize((_WorldSpaceCameraPos - xlv_TEXCOORD3));
  mediump float tmpvar_10;
  mediump vec3 I_11;
  I_11 = tmpvar_9;
  mediump float power_12;
  power_12 = _FresnelParams.x;
  mediump float scale_13;
  scale_13 = _FresnelParams.y;
  mediump float bias_14;
  bias_14 = _FresnelParams.z;
  tmpvar_10 = (bias_14 + max (0.0, (
    pow (clamp ((1.0 - dot (I_11, xlv_TEXCOORD4)), 0.001, 1.0), power_12)
   * scale_13)));
  fresnel_3 = tmpvar_10;
  lowp vec2 tmpvar_15;
  tmpvar_15 = texture2D (_BrushedNormalMap, xlv_TEXCOORD1).xy;
  brushedValue_2 = tmpvar_15;
  brushedValue_2 = ((brushedValue_2 * 2.0) - 1.0);
  highp vec2 tmpvar_16;
  tmpvar_16.x = _BrushScaleX;
  tmpvar_16.y = _BrushScaleY;
  brushedValue_2 = (brushedValue_2 * tmpvar_16);
  highp vec2 tmpvar_17;
  tmpvar_17 = ((xlv_TEXCOORD2.xy / xlv_TEXCOORD2.w) + brushedValue_2);
  lowp vec4 tmpvar_18;
  tmpvar_18 = texture2D (_ReflectionTex, tmpvar_17);
  reflColor_1 = tmpvar_18;
  highp vec4 tmpvar_19;
  tmpvar_19 = max (vec4(0.0, 0.0, 0.0, 0.0), reflColor_1);
  reflColor_1.w = tmpvar_19.w;
  reflColor_1.xyz = ((tmpvar_19.xyz * tmpvar_19.xyz) * _ReflectionEmissionAdjust);
  reflColor_1.xyz = (reflColor_1.xyz * baseTexColor_5.w);
  highp vec4 tmpvar_20;
  tmpvar_20.xyz = (((baseTexColor_5.xyz * _Color.xyz) * (
    (((2.0 * ShadowColor_4.xyz) * ShadowColor_4.w) + 1.0)
   - ShadowColor_4.w)) * _LightMapIntensity);
  tmpvar_20.w = _BloomFactor;
  highp vec4 tmpvar_21;
  tmpvar_21 = mix (tmpvar_20, reflColor_1, vec4(fresnel_3));
  outColor_6.w = tmpvar_21.w;
  mediump vec3 srcColor_22;
  srcColor_22 = tmpvar_21.xyz;
  mediump vec3 fogColor_23;
  fogColor_23 = xlv_COLOR1.xyz;
  mediump float factor_24;
  factor_24 = xlv_COLOR1.w;
  mediump vec3 tmpvar_25;
  tmpvar_25 = mix (srcColor_22, fogColor_23, vec3(factor_24));
  outColor_6.xyz = tmpvar_25;
...
void main ()
{
  ...
  srcColor_23 = tmpvar_21.xyz;
  mediump vec3 fogColor_24;
  fogColor_24 = xlv_COLOR1.xyz;
  mediump float factor_25;
  factor_25 = xlv_COLOR1.w;
  tmpvar_22 = (fogColor_24 + (srcColor_23 * clamp (factor_25, 0.0, 1.0)));
