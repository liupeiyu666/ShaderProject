...
void main()
{
    u_xlat10_0.x = texture(_SecondReflectMask, vs_TEXCOORD4.xy).x;
    u_xlat16_1.x = log2(u_xlat10_0.x);
    u_xlat16_1.x = u_xlat16_1.x * _SecondReflectPower;
    u_xlat16_1.x = exp2(u_xlat16_1.x);
    u_xlat10_0.x = texture(_ReflectMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_1.x = _SecondReflectIntensity * u_xlat16_1.x + (-u_xlat10_0.x);
    u_xlat16_1.x = _SecondReflectFactor * u_xlat16_1.x + u_xlat10_0.x;
    u_xlat16_6.x = dot(vs_TEXCOORD3.xyz, vs_TEXCOORD2.xyz);
    u_xlat16_6.x = u_xlat16_6.x + u_xlat16_6.x;
    u_xlat16_6.xyz = vs_TEXCOORD2.xyz * (-u_xlat16_6.xxx) + vs_TEXCOORD3.xyz;
    u_xlat10_0.xyz = texture(_EnvTex, u_xlat16_6.xyz).xyz;
    u_xlat16_0.xyz = u_xlat16_1.xxx * u_xlat10_0.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(_Reflectivity);
    u_xlat10_2.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat0.xyz = u_xlat10_2.xyz * _Color.xyz + u_xlat16_0.xyz;
    u_xlat16_1.xyz = u_xlat10_2.xyz * vec3(_Emission);
    ...
    u_xlat0.x = abs(u_xlat0.x) * _Magnitude + _MinValue;
    ...
    u_xlatb15 = 0.0<_LigthMapIntPingPong;
#endif
    u_xlat16_3.xyz = (bool(u_xlatb15)) ? u_xlat0.xyz : u_xlat2.xyz;
    u_xlat16_4.xyz = (-u_xlat16_3.xyz) + vs_COLOR1.xyz;
    u_xlat16_3.xyz = vs_COLOR1.www * u_xlat16_4.xyz + u_xlat16_3.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * _EmissionColor.xyz + (-u_xlat16_3.xyz);
    SV_Target0.xyz = vec3(vec3(_EmissionFactor, _EmissionFactor, _EmissionFactor)) * u_xlat16_1.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture(_EnvTex, u_xlat16_5.xyz).xyz;
    u_xlat16_0.xyz = u_xlat16_1.xxx * u_xlat10_0.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(_Reflectivity);
    u_xlat10_2.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat0.xyz = u_xlat10_2.xyz * _Color.xyz + u_xlat16_0.xyz;
    ...
    u_xlatb12 = 0.0<_LigthMapIntPingPong;
#endif
    u_xlat16_3.xyz = (bool(u_xlatb12)) ? u_xlat0.xyz : u_xlat2.xyz;
...
#endif
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(u_xlat16_13) + vs_COLOR1.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * _EmissionColor.xyz + (-u_xlat16_3.xyz);
    SV_Target0.xyz = vec3(vec3(_EmissionFactor, _EmissionFactor, _EmissionFactor)) * u_xlat16_1.xyz + u_xlat16_3.xyz;
    SV_Target0.w = _BloomFactor;
    return;
