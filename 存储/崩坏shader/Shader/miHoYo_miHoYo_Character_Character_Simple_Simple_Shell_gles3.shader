...
void main()
{
    ...
    u_xlatb6 = u_xlati6==0;
#endif
    u_xlat1.xy = (-vec2(u_xlat3)) * vec2(1.70000005, 1.5) + vec2(u_xlat0);
    u_xlat1.xy = u_xlat1.xy + vec2(1.0, 1.0);
    u_xlat1.xy = floor(u_xlat1.xy);
    u_xlat1.xy = max(u_xlat1.xy, vec2(0.0, 0.0));
    u_xlati1.xy = ivec2(u_xlat1.xy);
#ifdef UNITY_ADRENO_ES3
    u_xlatb9 = !!(u_xlati1.x==0);
#else
    u_xlatb9 = u_xlati1.x==0;
#endif
    u_xlatb6 = u_xlatb9 && u_xlatb6;
    u_xlat0 = u_xlat3 * 1.70000005 + (-u_xlat0);
...
#endif
    u_xlat3 = _SPTransitionBloomFactor + (-_BloomFactor);
    u_xlat0 = u_xlat0 * u_xlat3 + _BloomFactor;
    u_xlat16_2 = _SPOpaqueness * _BloomFactor;
    u_xlat16_2 = (u_xlati1.y != 0) ? _BloomFactor : u_xlat16_2;
    SV_Target0.w = (u_xlatb6) ? u_xlat0 : u_xlat16_2;
    SV_Target0.xyz = vec3(0.0, 0.0, 0.0);
    return;
}
