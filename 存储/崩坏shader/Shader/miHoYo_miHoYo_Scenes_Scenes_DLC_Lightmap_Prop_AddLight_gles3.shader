...
void main()
{
    ...
    u_xlat10_1.xyz = texture(_ShadowTex, vs_TEXCOORD0.zw).xyz;
    ...
    u_xlat10 = dot(u_xlat0.xyz, u_xlat4.xyz);
    u_xlat10 = u_xlat10 + u_xlat10;
    u_xlat0.xy = u_xlat4.xy * (-vec2(u_xlat10)) + u_xlat0.xy;
    u_xlat0.xy = (-u_xlat4.xy) + u_xlat0.xy;
    u_xlat0.xy = vec2(vec2(_MetalRef, _MetalRef)) * u_xlat0.xy + u_xlat4.xy;
    u_xlat0.xy = u_xlat0.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
#ifdef UNITY_ADRENO_ES3
    u_xlatb10.x = !!(0.0<_EnableMatcapSpecular);
#else
    u_xlatb10.x = 0.0<_EnableMatcapSpecular;
#endif
    if(u_xlatb10.x){
        u_xlat1.xy = u_xlat0.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
    ...
    u_xlat0.xyz = u_xlat16_0.xyz * u_xlat16_3.xyz + u_xlat1.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_3.xyz;
    u_xlat16_17 = (-u_xlat10_15) + 1.0;
    u_xlat16_2.xyz = vec3(u_xlat16_17) * u_xlat16_2.xyz;
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat10_15) + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat10_1.xyz = texture(_ShadowTex, vs_TEXCOORD0.zw).xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb16 = !!(0.5<_ReceiveDynamicShadow);
#else
    u_xlatb16 = 0.5<_ReceiveDynamicShadow;
#endif
    if(u_xlatb16){
        u_xlat3.xy = vs_TEXCOORD2.xy / vs_TEXCOORD2.ww;
        u_xlat10_16 = texture(_DynamicSceneShadowVolumeBuffer, u_xlat3.xy).x;
        u_xlat16_17 = u_xlat10_16;
    } else {
        u_xlat16_17 = 1.0;
    //ENDIF
    }
    u_xlat16_17 = (-u_xlat16_17) + 1.0;
    u_xlat16_17 = (-_ShadowIntegration) * u_xlat16_17 + 1.0;
    u_xlat16_4.x = dot(vs_TEXCOORD4.xyz, u_xlat16_2.xyz);
    u_xlat16_9 = dot(vs_TEXCOORD5.xyz, u_xlat16_2.xyz);
    u_xlat16_2.x = dot(vs_TEXCOORD6.xyz, u_xlat16_2.xyz);
    u_xlat3.xyz = vec3(u_xlat16_9) * hlslcc_mtx4x4unity_MatrixV[1].xyz;
    u_xlat3.xyz = hlslcc_mtx4x4unity_MatrixV[0].xyz * u_xlat16_4.xxx + u_xlat3.xyz;
    u_xlat3.xyz = hlslcc_mtx4x4unity_MatrixV[2].xyz * u_xlat16_2.xxx + u_xlat3.xyz;
    u_xlat16_2.xyz = u_xlat10_0.xyz * _Color.xyz;
    u_xlat16_2.xyz = vec3(u_xlat16_17) * u_xlat16_2.xyz;
    u_xlat16_4.xyz = u_xlat10_1.xyz + u_xlat10_1.xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(_LightMapIntensity);
    u_xlat0.xyz = vs_TEXCOORD3.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat1.x = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat1.x = inversesqrt(u_xlat1.x);
    u_xlat0.xyz = u_xlat0.xyz * u_xlat1.xxx;
    ...
    u_xlat10 = u_xlat10 + u_xlat10;
    u_xlat0.xy = u_xlat3.xy * (-vec2(u_xlat10)) + u_xlat0.xy;
    u_xlat0.xy = (-u_xlat3.xy) + u_xlat0.xy;
    u_xlat0.xy = vec2(vec2(_MetalRef, _MetalRef)) * u_xlat0.xy + u_xlat3.xy;
    u_xlat0.xy = u_xlat0.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
#ifdef UNITY_ADRENO_ES3
    u_xlatb10.x = !!(0.0<_EnableMatcapSpecular);
#else
    ...
    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat10_0.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_0.xyz;
    u_xlat0.xyz = u_xlat16_0.xyz * u_xlat16_4.xyz + u_xlat1.xyz;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture(_ShadowTex, vs_TEXCOORD0.zw).xyz;
#ifdef UNITY_ADRENO_ES3
    ...
    if(u_xlatb15){
        ...
        u_xlat16_18 = u_xlat10_0.x;
    } else {
        u_xlat16_18 = 1.0;
    //ENDIF
    }
    u_xlat16_18 = (-u_xlat16_18) + 1.0;
    u_xlat16_18 = (-_ShadowIntegration) * u_xlat16_18 + 1.0;
    u_xlat16_4.x = dot(vs_TEXCOORD4.xyz, u_xlat16_3.xyz);
    u_xlat16_9 = dot(vs_TEXCOORD5.xyz, u_xlat16_3.xyz);
    u_xlat16_3.x = dot(vs_TEXCOORD6.xyz, u_xlat16_3.xyz);
    u_xlat0.xyw = vec3(u_xlat16_9) * hlslcc_mtx4x4unity_MatrixV[1].xyz;
    u_xlat0.xyw = hlslcc_mtx4x4unity_MatrixV[0].xyz * u_xlat16_4.xxx + u_xlat0.xyw;
    u_xlat0.xyw = hlslcc_mtx4x4unity_MatrixV[2].xyz * u_xlat16_3.xxx + u_xlat0.xyw;
    ...
    u_xlat15 = dot(u_xlat1.xyz, u_xlat0.xyw);
    u_xlat15 = u_xlat15 + u_xlat15;
    u_xlat1.xy = u_xlat0.xy * (-vec2(u_xlat15)) + u_xlat1.xy;
    u_xlat1.xy = (-u_xlat0.xy) + u_xlat1.xy;
    u_xlat0.xy = vec2(vec2(_MetalRef, _MetalRef)) * u_xlat1.xy + u_xlat0.xy;
    u_xlat0.xy = u_xlat0.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_0.xyw = u_xlat16_3.xyz * u_xlat10_0.xyw;
    u_xlat16_0.xyw = u_xlat16_0.xyw + u_xlat16_0.xyw;
    u_xlat0.xyw = u_xlat16_0.xyw * u_xlat16_4.xyz + u_xlat1.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz;
    u_xlat16_18 = (-u_xlat10_10) + 1.0;
    u_xlat16_3.xyz = vec3(u_xlat16_18) * u_xlat16_3.xyz;
    u_xlat0.xyz = u_xlat0.xyw * vec3(u_xlat10_10) + u_xlat16_3.xyz;
