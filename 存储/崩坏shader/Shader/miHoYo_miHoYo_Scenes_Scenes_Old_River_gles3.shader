...
void main()
{
    ...
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _BumpScale0.xy + u_xlat0.xy;
    u_xlat0.xy = vec2(_Time.y * float(_BumpVelocity1.x), _Time.y * float(_BumpVelocity1.y));
    vs_TEXCOORD1.xy = in_TEXCOORD0.xy * _BumpScale1.xy + u_xlat0.xy;
    u_xlat0.xy = vec2(_Time.y * float(_CausticVelocity.x), _Time.y * float(_CausticVelocity.y));
    vs_TEXCOORD2.xy = in_TEXCOORD0.xy * _CausticScale.xy + u_xlat0.xy;
    ...
    u_xlat16_2 = (-u_xlat0.y) * u_xlat0.x + 1.0;
    u_xlat16_2 = max(u_xlat16_2, 0.00100000005);
    u_xlat16_2 = min(u_xlat16_2, 1.0);
    u_xlat16_2 = log2(u_xlat16_2);
    u_xlat16_2 = u_xlat16_2 * _CausticFresnelFactors.x;
    u_xlat16_2 = exp2(u_xlat16_2);
    u_xlat16_2 = u_xlat16_2 * _CausticFresnelFactors.y;
    u_xlat16_2 = max(u_xlat16_2, 0.0);
    u_xlat16_2 = u_xlat16_2 + _CausticFresnelFactors.z;
    ...
    vs_TEXCOORD3.x = in_COLOR0.w;
    vs_TEXCOORD3.y = u_xlat16_2;
    return;
}
...
void main()
{
    ...
    u_xlat0.xy = (-u_xlat16_0.xy) * vec2(_Distortion) + vs_TEXCOORD2.xy;
    u_xlat10_0.xyz = texture(_CausticMap, u_xlat0.xy).xyz;
    u_xlat0.xyz = u_xlat10_0.xyz * vs_TEXCOORD3.xxx;
    u_xlat0.xyz = u_xlat0.xyz * vs_TEXCOORD3.yyy + _RefractionColor.xyz;
    u_xlat16_1.xyz = (-u_xlat0.xyz) + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_1.xyz + u_xlat0.xyz;
    SV_Target0.w = vs_TEXCOORD3.x * _RefractionColor.w;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _BumpScale0.xy + u_xlat1.xy;
    u_xlat1.xy = vec2(_Time.y * float(_BumpVelocity1.x), _Time.y * float(_BumpVelocity1.y));
    vs_TEXCOORD1.xy = in_TEXCOORD0.xy * _BumpScale1.xy + u_xlat1.xy;
    ...
    u_xlat16_3 = (-u_xlat1.y) * u_xlat12 + 1.0;
    ...
    vs_TEXCOORD3.y = u_xlat16_3;
    u_xlat1.xy = vec2(_Time.y * float(_CausticVelocity.x), _Time.y * float(_CausticVelocity.y));
    vs_TEXCOORD2.xy = in_TEXCOORD0.xy * _CausticScale.xy + u_xlat1.xy;
    vs_TEXCOORD3.x = in_COLOR0.w;
...
void main()
{
    ...
    u_xlat16_3 = (-u_xlat1.y) * u_xlat15 + 1.0;
    u_xlat16_3 = max(u_xlat16_3, 0.00100000005);
    u_xlat16_3 = min(u_xlat16_3, 1.0);
    u_xlat16_3 = log2(u_xlat16_3);
    u_xlat16_3 = u_xlat16_3 * _CausticFresnelFactors.x;
