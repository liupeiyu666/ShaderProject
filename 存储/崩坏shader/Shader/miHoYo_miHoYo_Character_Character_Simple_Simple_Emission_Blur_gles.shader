...
void main ()
{
  ...
  lowp vec4 tmpvar_21;
  tmpvar_21 = (texture2D (_SPTex, xlv_TEXCOORD3.xy) * 0.5);
  spColor_20 = tmpvar_21;
  spColor_20.xyz = ((spColor_20.xyz + outColor_7.xyz) - (spColor_20.xyz * outColor_7.xyz));
  lowp vec4 tmpvar_22;
  ...
  tmpvar_29 = mix (outColor_7, spColor_20, vec4(xlat_mutable_SPIntensity));
