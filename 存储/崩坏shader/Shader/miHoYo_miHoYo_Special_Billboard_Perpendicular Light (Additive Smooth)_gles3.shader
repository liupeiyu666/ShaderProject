...
uniform 	float _DistanceAttenuationOffset;
uniform 	float _DistanceAttenuationFactor;
...
void main()
{
    ...
    u_xlat1.x = u_xlat1.x + (-_DistanceAttenuationOffset);
    u_xlat1.x = max(u_xlat1.x, 0.0);
    u_xlat1.x = u_xlat1.x * u_xlat1.x;
    u_xlat1.x = u_xlat1.x * _DistanceAttenuationFactor + 1.0;
    u_xlat1.xyz = in_COLOR0.xyz / u_xlat1.xxx;
