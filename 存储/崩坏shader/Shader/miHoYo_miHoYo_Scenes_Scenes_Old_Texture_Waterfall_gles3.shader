...
void main()
{
    ...
    u_xlat0.x = u_xlat16_2.x * _BloomFactor;
    ...
    u_xlat16_2.xyz = (-u_xlat16_2.xyz) * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + vs_COLOR1.xyz;
...
void main()
{
    ...
    vs_TEXCOORD1.xy = u_xlat1.xy + _nextFrameOffset.xy;
