...
void main()
{
    ...
    u_xlat1.xy = in_POSITION0.xy * vec2(_SizeScaleX, _SizeScaleY);
    u_xlat0.yz = vec2(u_xlat2.y * u_xlat1.x, u_xlat2.z * u_xlat1.y);
    u_xlat0.xyz = (-u_xlat1.xyz) * u_xlat2.zxy + u_xlat0.xyz;
    u_xlat12 = dot(u_xlat1.xy, u_xlat1.xy);
    u_xlat12 = sqrt(u_xlat12);
    u_xlat1.xyz = u_xlat0.xyz * u_xlat2.zxy;
    u_xlat0.xyz = u_xlat2.yzx * u_xlat0.yzx + (-u_xlat1.xyz);
    ...
    u_xlat3 = (-u_xlat5) * u_xlat5 + 1.0;
    u_xlat3 = sqrt(u_xlat3);
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat3);
    u_xlat0.xyz = u_xlat1.xzw * vec3(u_xlat5) + u_xlat0.xyz;
