...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _mainTiling.xy;
    u_xlat0.xy = _Time.yy * vec2(_mainSpeed.x, _mainSpeed.y) + u_xlat0.xy;
    u_xlat10_0.xyz = texture(_MainTex, u_xlat0.xy).xyz;
    u_xlat1.xyz = u_xlat10_0.xyz * _mainColor.xyz;
...
#endif
    u_xlat0.xyz = u_xlat1.xyz * vec3(_mainColorIntensity);
