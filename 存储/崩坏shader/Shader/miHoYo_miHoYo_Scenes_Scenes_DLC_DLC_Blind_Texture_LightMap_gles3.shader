...
void main()
{
    ...
    u_xlat0.xy = in_TEXCOORD0.xy * _Texture_ST.xy + _Texture_ST.zw;
...
#endif
    if(u_xlatb0){
        u_xlat16_1.xy = vs_TEXCOORD2.xy * vec2(1.0, -1.0) + vec2(0.0, 1.0);
        u_xlat10_0.x = texture(_Texture, u_xlat16_1.xy).y;
        u_xlat16_1.x = u_xlat10_0.x;
    } else {
        u_xlat16_6.xy = vs_TEXCOORD2.xy * vec2(1.0, -1.0) + vec2(0.0, 1.0);
        u_xlat16_6.xy = vec2(u_xlat16_6.x * float(_TextureAspectX), u_xlat16_6.y * float(_TextureAspectY));
        u_xlat10_0.x = texture(_Texture, u_xlat16_6.xy).y;
        u_xlat16_1.x = u_xlat10_0.x;
    //ENDIF
    }
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    if(u_xlatb0){
        ...
        u_xlat16_5.xy = vs_TEXCOORD2.xy * vec2(1.0, -1.0) + vec2(0.0, 1.0);
        u_xlat16_5.xy = vec2(u_xlat16_5.x * float(_TextureAspectX), u_xlat16_5.y * float(_TextureAspectY));
        u_xlat10_0.x = texture(_Texture, u_xlat16_5.xy).y;
        u_xlat16_1.x = u_xlat10_0.x;
    //ENDIF
    }
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat0.xy = in_TEXCOORD0.xy * _Texture_ST.xy + _Texture_ST.zw;
    u_xlat6.xy = in_TEXCOORD1.xy * _PropertyLightmapTexTS.xy + _PropertyLightmapTexTS.zw;
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(0.5<_FogColorNear.w);
#else
    u_xlatb1 = 0.5<_FogColorNear.w;
...
void main()
{
    ...
    if((int(u_xlatb0) * int(0xffffffffu))!=0){discard;}
    u_xlat10_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat10_2.xyz = texture(_PropertyLightmapTex, vs_TEXCOORD1.xy).xyz;
    u_xlat16_1.xyz = u_xlat10_0.xyz * _Color.xyz;
    u_xlat16_3.xyz = u_xlat10_2.xyz * vec3(_LightMapIntensity) + _LightingColor.xyz;
    u_xlat16_4.xyz = u_xlat16_1.xyz * u_xlat16_3.xyz;
    u_xlat16_1.xyz = (-u_xlat16_1.xyz) * u_xlat16_3.xyz + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_1.xyz + u_xlat16_4.xyz;
    SV_Target0.w = _BloomFactor;
    return;
}
