...
uniform sampler2D _MainOpacityTex;
uniform highp vec4 _MainOpacityTex_ST;
uniform highp float _MainTexIntensity;
uniform highp float _MainTexIntensityAddColor;
uniform highp float _MainTexOpacity;
varying highp vec4 xlv_TEXCOORD0;
varying highp vec4 xlv_TEXCOORD1;
varying highp vec4 xlv_TEXCOORD2;
void main ()
{
  ...
  highp vec4 tex2DNode10_2;
  highp vec2 tmpvar_3;
  tmpvar_3 = ((xlv_TEXCOORD0.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
  highp vec2 tmpvar_4;
  tmpvar_4 = ((xlv_TEXCOORD2.xy * _MainOpacityTex_ST.xy) + _MainOpacityTex_ST.zw);
  highp vec2 tmpvar_5;
  ...
  tex2DNode10_2 = tmpvar_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture2D (_MainOpacityTex, tmpvar_4);
  mediump float tmpvar_8;
  highp float tmpvar_9;
  tmpvar_9 = clamp ((_MainTexOpacity * tmpvar_7.x), 0.0, 1.0);
  tmpvar_8 = tmpvar_9;
  lowp vec4 tmpvar_10;
  tmpvar_10 = texture2D (_MainTex, tmpvar_3);
  highp vec3 tmpvar_11;
  tmpvar_11 = (((_MainTexColor * tmpvar_10) * _MainTexIntensity) * (tex2DNode10_2.x + _MainTexIntensityAddColor)).xyz;
