...
uniform 	vec4 _RippleScaleOffset;
...
void main()
{
    ...
    u_xlat10.xy = _Time.yy * vec2(_Speed) + u_xlat0.xy;
    u_xlat10.xy = u_xlat10.xy * vec2(vec2(_Frequency, _Frequency)) + vec2(vec2(_PhaseOffset, _PhaseOffset));
    u_xlat10.xy = cos(u_xlat10.xy);
    u_xlat0.xy = u_xlat10.xy * vec2(vec2(_Delta, _Delta)) + u_xlat0.xy;
    u_xlat0.xy = u_xlat0.xy * _RippleScaleOffset.xy + _RippleScaleOffset.zw;
    u_xlat10.x = _Time.y * _RipplesSpeed + 1.5;
