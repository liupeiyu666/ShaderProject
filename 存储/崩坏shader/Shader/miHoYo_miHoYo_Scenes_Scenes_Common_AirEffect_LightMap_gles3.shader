...
#ifdef UNITY_ADRENO_ES3
    u_xlatb12 = !!(vs_TEXCOORD2.z<_WaterPlaneHeight);
#else
    u_xlatb12 = vs_TEXCOORD2.z<_WaterPlaneHeight;
#endif
...
void main()
{
    ...
    u_xlatb8 = 0.99000001<vs_TEXCOORD2.y;
#endif
    u_xlat16_1.x = (u_xlatb8) ? u_xlat4.x : vs_TEXCOORD2.y;
