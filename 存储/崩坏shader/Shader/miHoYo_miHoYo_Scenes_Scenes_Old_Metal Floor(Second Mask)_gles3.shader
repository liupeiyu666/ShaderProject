...
uniform lowp sampler2D _ShadowTex;
uniform lowp sampler2D _SecondReflectMask;
...
void main()
{
    ...
    u_xlat10_0.x = texture(_SecondReflectMask, vs_TEXCOORD6.xy).x;
    u_xlat16_6 = log2(u_xlat10_0.x);
    u_xlat16_6 = u_xlat16_6 * _SecondReflectPower;
    u_xlat16_6 = exp2(u_xlat16_6);
    u_xlat10_0.x = texture(_ReflectMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_6 = _SecondReflectIntensity * u_xlat16_6 + (-u_xlat10_0.x);
    u_xlat16_6 = _SecondReflectFactor * u_xlat16_6 + u_xlat10_0.x;
    u_xlat10_0 = texture(_ShadowTex, vs_TEXCOORD5.xy);
    ...
    u_xlat10_3.xy = texture(_BrushedNormalMap, vs_TEXCOORD1.xy).xy;
    u_xlat16_11.xy = u_xlat10_3.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat16_2.xy = vs_TEXCOORD2.xy / vs_TEXCOORD2.ww;
    u_xlat16_11.xy = u_xlat16_11.xy * vec2(_BrushScaleX, _BrushScaleY) + u_xlat16_2.xy;
    u_xlat10_2 = texture(_ReflectionTex, u_xlat16_11.xy);
    u_xlat16_4.xyz = u_xlat10_2.xyz * vec3(_ReflectionEmissionAdjust);
    u_xlat16_3.xyz = u_xlat16_4.xyz * vec3(u_xlat16_6) + (-u_xlat0.xyz);
    u_xlat0.w = _BloomFactor;
    u_xlat16_3.w = (-u_xlat0.w) + u_xlat10_2.w;
    u_xlat16_0 = u_xlat16_1.xxxx * u_xlat16_3 + u_xlat0;
...
void main()
{
    ...
    u_xlat0.w = _BloomFactor;
    u_xlat16_3.w = (-u_xlat0.w) + u_xlat10_2.w;
    u_xlat16_0 = vec4(u_xlat16_1) * u_xlat16_3 + u_xlat0;
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat16_1.x + _FresnelParams.z;
    u_xlat10_0.x = texture(_SecondReflectMask, vs_TEXCOORD6.xy).x;
    u_xlat16_7 = log2(u_xlat10_0.x);
    u_xlat16_7 = u_xlat16_7 * _SecondReflectPower;
    u_xlat16_7 = exp2(u_xlat16_7);
    u_xlat10_0.x = texture(_ReflectMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_7 = _SecondReflectIntensity * u_xlat16_7 + (-u_xlat10_0.x);
    u_xlat16_7 = _SecondReflectFactor * u_xlat16_7 + u_xlat10_0.x;
    u_xlat10_0 = texture(_ShadowTex, vs_TEXCOORD5.xy);
    u_xlat16_2.xyz = u_xlat10_0.xyz + u_xlat10_0.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_0.www + vec3(1.0, 1.0, 1.0);
    u_xlat16_2.xyz = (-u_xlat10_0.www) + u_xlat16_2.xyz;
    ...
    u_xlat0.xyz = u_xlat16_2.xyz * vec3(_LightMapIntensity);
    u_xlat10_3.xy = texture(_BrushedNormalMap, vs_TEXCOORD1.xy).xy;
    u_xlat16_13.xy = u_xlat10_3.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat16_2.xy = vs_TEXCOORD2.xy / vs_TEXCOORD2.ww;
    u_xlat16_13.xy = u_xlat16_13.xy * vec2(_BrushScaleX, _BrushScaleY) + u_xlat16_2.xy;
    u_xlat10_2 = texture(_ReflectionTex, u_xlat16_13.xy);
    u_xlat16_4.xyz = u_xlat10_2.xyz * vec3(_ReflectionEmissionAdjust);
    u_xlat16_3.xyz = u_xlat16_4.xyz * vec3(u_xlat16_7) + (-u_xlat0.xyz);
    u_xlat0.w = _BloomFactor;
    u_xlat16_3.w = (-u_xlat0.w) + u_xlat10_2.w;
    u_xlat16_0 = u_xlat16_1.xxxx * u_xlat16_3 + u_xlat0;
    u_xlat16_1.xyz = (-u_xlat16_0.xyz) + vs_COLOR1.xyz;
    ...
    SV_Target0.w = u_xlat16_0.w;
    u_xlat16_5.x = dot(u_xlat16_1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_5.xyz = (-u_xlat16_1.xyz) + u_xlat16_5.xxx;
    u_xlat16_5.xyz = vec3(_LumiFactor) * u_xlat16_5.xyz + u_xlat16_1.xyz;
