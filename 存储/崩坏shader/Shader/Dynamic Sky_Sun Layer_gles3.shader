...
void main()
{
    ...
    u_xlat16_2 = dot(_ES_SkyWorldUpDir.xyz, u_xlat0.xyz);
    vs_TEXCOORD1.xyz = u_xlat0.xyz;
    u_xlat0.x = abs(u_xlat16_2) * -0.0187292993 + 0.0742610022;
    u_xlat0.x = u_xlat0.x * abs(u_xlat16_2) + -0.212114394;
    u_xlat0.x = u_xlat0.x * abs(u_xlat16_2) + 1.57072878;
    u_xlat3 = -abs(u_xlat16_2) + 1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb6 = !!(u_xlat16_2<(-u_xlat16_2));
#else
    u_xlatb6 = u_xlat16_2<(-u_xlat16_2);
#endif
    ...
    vs_TEXCOORD1.w = u_xlat0.x * 0.636619806;
    return;
}
...
void main()
{
    ...
    u_xlat16_3 = (-_ES_SunSharpness) + 1.0;
    ...
    u_xlat16_1.xyz = u_xlat16_1.xxx * _ES_SunColor.xyz;
    SV_Target0.xyz = u_xlat16_1.xyz * vec3(vec3(_ES_SunBrightness, _ES_SunBrightness, _ES_SunBrightness));
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3 = dot(_ES_SkyWorldUpDir.xyz, u_xlat1.xyz);
    vs_TEXCOORD1.xyz = u_xlat1.xyz;
    u_xlat12 = abs(u_xlat16_3) * -0.0187292993 + 0.0742610022;
    u_xlat12 = u_xlat12 * abs(u_xlat16_3) + -0.212114394;
    u_xlat12 = u_xlat12 * abs(u_xlat16_3) + 1.57072878;
    u_xlat1.x = -abs(u_xlat16_3) + 1.0;
#ifdef UNITY_ADRENO_ES3
    ...
    vs_TEXCOORD1.w = u_xlat12 * 0.636619806;
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_3;
    u_xlat16_1.xyz = u_xlat16_1.xxx * _ES_SunColor.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(vec3(_ES_SunBrightness, _ES_SunBrightness, _ES_SunBrightness));
...
void main()
{
    ...
    u_xlat16_3 = dot(_ES_SkyWorldUpDir.xyz, u_xlat1.xyz);
    vs_TEXCOORD1.xyz = u_xlat1.xyz;
    u_xlat15 = abs(u_xlat16_3) * -0.0187292993 + 0.0742610022;
    u_xlat15 = u_xlat15 * abs(u_xlat16_3) + -0.212114394;
    u_xlat15 = u_xlat15 * abs(u_xlat16_3) + 1.57072878;
    u_xlat1.x = -abs(u_xlat16_3) + 1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb6 = !!(u_xlat16_3<(-u_xlat16_3));
#else
    u_xlatb6 = u_xlat16_3<(-u_xlat16_3);
#endif
    u_xlat1.x = sqrt(u_xlat1.x);
    ...
    vs_TEXCOORD1.w = u_xlat15 * 0.636619806;
