...
void main()
{
    ...
    u_xlat0.xy = in_TEXCOORD1.xy * _BackgroundTex_ST.xy + _BackgroundTex_ST.zw;
...
uniform lowp sampler2D _MaskedTex;
...
void main()
{
    u_xlat10_0 = texture(_MaskedTex, vs_TEXCOORD1.xy);
    u_xlat16_1.xyz = (-u_xlat10_0.xyz) + _MaskedTexMonoColor.xyz;
    u_xlat16_1.xyz = vec3(_MaskedTexMonoIntensity) * u_xlat16_1.xyz + u_xlat10_0.xyz;
    u_xlat10_0.xyz = texture(_BackgroundTex, vs_TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = (-u_xlat10_0.xyz) + u_xlat16_1.xyz;
    SV_Target0.xyz = u_xlat10_0.www * u_xlat16_1.xyz + u_xlat10_0.xyz;
...
void main()
{
    ...
    u_xlat1.xy = in_TEXCOORD1.xy * _BackgroundTex_ST.xy + _BackgroundTex_ST.zw;
...
void main()
{
    u_xlat16_0 = vs_TEXCOORD5.xyxy / vs_TEXCOORD5.wwww;
    ...
    SV_Target0.w = u_xlat16_0.x * u_xlat10_2.x;
    u_xlat10_0 = texture(_MaskedTex, vs_TEXCOORD1.xy);
    u_xlat16_1.xyz = (-u_xlat10_0.xyz) + _MaskedTexMonoColor.xyz;
    u_xlat16_1.xyz = vec3(_MaskedTexMonoIntensity) * u_xlat16_1.xyz + u_xlat10_0.xyz;
    u_xlat10_2.xyz = texture(_BackgroundTex, vs_TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz + (-u_xlat10_2.xyz);
    SV_Target0.xyz = u_xlat10_0.www * u_xlat16_1.xyz + u_xlat10_2.xyz;
    return;
}
