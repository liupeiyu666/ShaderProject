...
void main()
{
    ...
    u_xlat0.xyz = u_xlat0.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler));
    ...
    u_xlat16_7.x = (u_xlatb0.w) ? u_xlat3.w : 0.0;
    u_xlat16_7.x = (u_xlatb0.z) ? u_xlat3.z : u_xlat16_7.x;
    u_xlat16_7.x = (u_xlatb0.y) ? u_xlat3.y : u_xlat16_7.x;
    u_xlat16_7.x = (u_xlatb0.x) ? u_xlat3.x : u_xlat16_7.x;
    u_xlat16_2 = u_xlat16_7.x * u_xlat16_2;
    u_xlat16_7.x = (-vs_COLOR0.w) + 1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(u_xlat16_7.x>=u_xlat16_2);
#else
    u_xlatb0.x = u_xlat16_7.x>=u_xlat16_2;
#endif
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_7.xyz + (-u_xlat16_4.xyz);
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_5.xyz + u_xlat16_4.xyz;
    u_xlat1.xyz = u_xlat0.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler));
    u_xlat15 = dot(u_xlat1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat0.xyz = (-u_xlat0.xyz) * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + vec3(u_xlat15);
...
void main()
{
...
#endif
    u_xlat0.xy = (u_xlatb1.x) ? u_xlat10.xy : u_xlat0.xy;
    u_xlat0.xy = vec2(u_xlat16_3) * vec2(vec2(_NoiseBrightness, _NoiseBrightness)) + u_xlat0.xy;
    u_xlat0 = texture(_DissolveTex, u_xlat0.xy);
    u_xlatb1 = equal(vec4(_DissolveChannelMapping), vec4(0.0, 1.0, 2.0, 3.0));
    ...
    SV_TARGET0.xyz = u_xlat0.xyz;
    u_xlatb0 = equal(vec4(vec4(_AlphaChannelMapping, _AlphaChannelMapping, _AlphaChannelMapping, _AlphaChannelMapping)), vec4(0.0, 1.0, 2.0, 3.0));
    u_xlat16_8.x = (u_xlatb0.w) ? u_xlat2.w : 0.0;
    u_xlat16_8.x = (u_xlatb0.z) ? u_xlat2.z : u_xlat16_8.x;
    u_xlat16_8.x = (u_xlatb0.y) ? u_xlat2.y : u_xlat16_8.x;
    u_xlat16_8.x = (u_xlatb0.x) ? u_xlat2.x : u_xlat16_8.x;
    u_xlat16_3 = u_xlat16_8.x * u_xlat16_3;
    u_xlat16_8.x = (-vs_COLOR0.w) + 1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(u_xlat16_8.x>=u_xlat16_3);
#else
    u_xlatb0.x = u_xlat16_8.x>=u_xlat16_3;
#endif
    SV_TARGET0.w = (u_xlatb0.x) ? 0.0 : 1.0;
...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _NoiseTex_ST.xy + _NoiseTex_ST.zw;
    u_xlat10.xy = vec2(_Time.y * float(_NoiseUSpeed), _Time.y * float(_NoiseVSpeed));
    u_xlat1.x = vs_TEXCOORD1.w + -0.5;
    u_xlat6 = u_xlat1.x * abs(_NoiseRandomRange) + 1.0;
    u_xlat1.x = u_xlat1.x * abs(_DissolveRandomRange) + 1.0;
    u_xlat0.xy = u_xlat10.xy * vec2(u_xlat6) + u_xlat0.xy;
    u_xlat10.xy = vec2(u_xlat0.x + vs_TEXCOORD0.z, u_xlat0.y + vs_TEXCOORD0.w);
#ifdef UNITY_ADRENO_ES3
    u_xlatb6 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_NoiseUVRandom));
...
void main()
{
    ...
    u_xlatb1 = equal(vec4(_AlphaChannelMapping), vec4(0.0, 1.0, 2.0, 3.0));
    ...
    u_xlat16_5 = (-vs_COLOR0.w) + 1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(u_xlat16_5>=u_xlat16_2);
#else
    u_xlatb0 = u_xlat16_5>=u_xlat16_2;
#endif
    u_xlat0.x = (u_xlatb0) ? 0.0 : _BloomFactor;
...
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _NoiseTex_ST.xy + _NoiseTex_ST.zw;
    u_xlat8.xy = vec2(_Time.y * float(_NoiseUSpeed), _Time.y * float(_NoiseVSpeed));
    u_xlat1 = vs_TEXCOORD1.w + -0.5;
    u_xlat5 = u_xlat1 * abs(_NoiseRandomRange) + 1.0;
    u_xlat1 = u_xlat1 * abs(_DissolveRandomRange) + 1.0;
    u_xlat0.xy = u_xlat8.xy * vec2(u_xlat5) + u_xlat0.xy;
    u_xlat8.xy = vec2(u_xlat0.x + vs_TEXCOORD0.z, u_xlat0.y + vs_TEXCOORD0.w);
#ifdef UNITY_ADRENO_ES3
    u_xlatb5 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_NoiseUVRandom));
#else
    u_xlatb5 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_NoiseUVRandom);
#endif
    u_xlat0.xy = (bool(u_xlatb5)) ? u_xlat8.xy : u_xlat0.xy;
    u_xlat0 = texture(_NoiseTex, u_xlat0.xy);
    u_xlatb2 = equal(vec4(_NoiseChannelMapping), vec4(0.0, 1.0, 2.0, 3.0));
    u_xlat16_3 = (u_xlatb2.w) ? u_xlat0.w : 0.0;
    u_xlat16_3 = (u_xlatb2.z) ? u_xlat0.z : u_xlat16_3;
    ...
    u_xlat16_3 = u_xlat16_3 + u_xlat16_3;
    u_xlat0.xy = vs_TEXCOORD0.xy * _DissolveTex_ST.xy + _DissolveTex_ST.zw;
    u_xlat8.xy = vec2(_Time.y * float(_DissolveUSpeed), _Time.y * float(_DissolveVSpeed));
    u_xlat0.xy = u_xlat8.xy * vec2(u_xlat1) + u_xlat0.xy;
    u_xlat8.xy = vec2(u_xlat0.x + vs_TEXCOORD0.z, u_xlat0.y + vs_TEXCOORD0.w);
#ifdef UNITY_ADRENO_ES3
    u_xlatb1.x = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_DissolveUVRandom));
#else
    ...
    u_xlat0 = texture(_MainTex, u_xlat0.xy);
    u_xlatb1 = equal(vec4(_AlphaChannelMapping), vec4(0.0, 1.0, 2.0, 3.0));
    u_xlat16_7 = (u_xlatb1.w) ? u_xlat0.w : 0.0;
    u_xlat16_7 = (u_xlatb1.z) ? u_xlat0.z : u_xlat16_7;
    u_xlat16_7 = (u_xlatb1.y) ? u_xlat0.y : u_xlat16_7;
    u_xlat16_7 = (u_xlatb1.x) ? u_xlat0.x : u_xlat16_7;
    u_xlat16_3 = u_xlat16_7 * u_xlat16_3;
    u_xlat16_7 = (-vs_COLOR0.w) + 1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(u_xlat16_7>=u_xlat16_3);
#else
    u_xlatb0 = u_xlat16_7>=u_xlat16_3;
#endif
    u_xlat0.x = (u_xlatb0) ? 0.0 : _BloomFactor;
