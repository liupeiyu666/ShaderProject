...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Special/Shadow/Paste_Camera_Shadow" {
Properties {
...
void main()
{
    u_xlat10_0 = texture(_Cookie, vs_TEXCOORD0.xy).x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb4 = !!(0.5<_lightProbToggle);
#else
    u_xlatb4 = 0.5<_lightProbToggle;
#endif
    u_xlat16_1 = (bool(u_xlatb4)) ? _lightProbColor : vec4(1.0, 1.0, 1.0, 1.0);
    u_xlat16_2 = u_xlat16_1 * _MainColor;
    u_xlat16_13 = (-u_xlat10_0) + 1.0;
    u_xlat16_13 = u_xlat16_13 * _Opaqueness;
    u_xlat16_13 = u_xlat16_13 * _Falloff;
    u_xlat16_3 = u_xlat16_2.w * u_xlat16_13;
    u_xlat0 = u_xlat16_13 * u_xlat16_2.w + 0.99000001;
    u_xlat0 = floor(u_xlat0);
    u_xlat0 = max(u_xlat0, 0.0);
    u_xlati0 = int(u_xlat0);
    if((u_xlati0)==0){discard;}
    u_xlat16_1.xyz = (-_MainColor.xyz) * u_xlat16_1.xyz + vs_COLOR1.xyz;
...
void main()
{
    u_xlat10_0 = texture(_Cookie, vs_TEXCOORD0.xy).x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb3 = !!(0.5<_lightProbToggle);
#else
    u_xlatb3 = 0.5<_lightProbToggle;
#endif
    u_xlat16_1 = (bool(u_xlatb3)) ? _lightProbColor : vec4(1.0, 1.0, 1.0, 1.0);
    u_xlat16_1 = u_xlat16_1 * _MainColor;
    u_xlat16_2 = (-u_xlat10_0) + 1.0;
    u_xlat16_2 = u_xlat16_2 * _Opaqueness;
    u_xlat16_2 = u_xlat16_2 * _Falloff;
    u_xlat16_5 = u_xlat16_1.w * u_xlat16_2;
    u_xlat0 = u_xlat16_2 * u_xlat16_1.w + 0.99000001;
    u_xlat0 = floor(u_xlat0);
    u_xlat0 = max(u_xlat0, 0.0);
    u_xlati0 = int(u_xlat0);
    if((u_xlati0)==0){discard;}
