...
void main ()
{
  ...
  tmpvar_13 = (bias_16 + max (0.0, (
    pow (clamp ((1.0 - dot (I_4, xlv_TEXCOORD4)), 0.001, 1.0), power_14)
   * scale_15)));
  lowp vec2 tmpvar_17;
  tmpvar_17 = texture2D (_BrushedNormalMap, xlv_TEXCOORD1).xy;
  brushedValue_3 = tmpvar_17;
  brushedValue_3 = ((brushedValue_3 * 2.0) - 1.0);
  highp vec2 tmpvar_18;
  tmpvar_18.x = _BrushScaleX;
  tmpvar_18.y = _BrushScaleY;
  brushedValue_3 = (brushedValue_3 * tmpvar_18);
  mediump vec2 tmpvar_19;
  tmpvar_19 = ((xlv_TEXCOORD2.xy / xlv_TEXCOORD2.w) + brushedValue_3);
  uvSC_2 = tmpvar_19;
  lowp vec4 tmpvar_20;
  tmpvar_20 = texture2D (_ReflectionTex, uvSC_2);
  reflColor_1 = tmpvar_20;
  ...
  tmpvar_22 = mix (tmpvar_21, reflColor_1, vec4(tmpvar_13));
  outColor_8 = tmpvar_22;
