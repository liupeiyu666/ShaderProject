...
void main()
{
    ...
    u_xlat0.xy = in_TEXCOORD0.xy * _MaskTexture_ST.xy + _MaskTexture_ST.zw;
    u_xlat0.zw = vec2(u_xlat0.x + in_TEXCOORD1.z, u_xlat0.y + in_TEXCOORD1.w);
...
void main()
{
    ...
    u_xlat10_4 = texture(_MaskTexture, vs_TEXCOORD3.zw).z;
    ...
    u_xlat10_0.xyz = texture(_MainSmokeTexture, vs_TEXCOORD3.xy).xzw;
...
void main()
{
    ...
    u_xlat10_0 = texture(_MainSmokeTexture, vs_TEXCOORD3.xy);
