...
void main()
{
    ...
    u_xlat1.y = hlslcc_mtx4x4unity_MatrixV[0].z;
    u_xlat1.z = hlslcc_mtx4x4unity_MatrixV[1].z;
    u_xlat1.x = hlslcc_mtx4x4unity_MatrixV[2].z;
    u_xlat13 = dot(u_xlat1.xyz, u_xlat1.xyz);
    u_xlat13 = inversesqrt(u_xlat13);
    u_xlat1.xyz = vec3(u_xlat13) * u_xlat1.xyz;
    u_xlat2.xyz = in_NORMAL0.yyy * hlslcc_mtx4x4unity_ObjectToWorld[1].yzx;
    u_xlat2.xyz = hlslcc_mtx4x4unity_ObjectToWorld[0].yzx * in_NORMAL0.xxx + u_xlat2.xyz;
    u_xlat2.xyz = hlslcc_mtx4x4unity_ObjectToWorld[2].yzx * in_NORMAL0.zzz + u_xlat2.xyz;
    ...
    u_xlat13 = u_xlat16_0 * _Width;
    u_xlat13 = u_xlat13 * _MayaScale;
    u_xlat1.xyz = u_xlat1.xyz * vec3(u_xlat13);
    u_xlat1.xyz = u_xlat1.xyz * in_COLOR0.xxx;
    u_xlat1.xyz = u_xlat1.xyz * vec3(_Scale) + u_xlat2.xyz;
    ...
    if(u_xlatb1){
        ...
        u_xlat0.w = min(u_xlat5.x, _FogEffectLimit);
        u_xlat1.x = u_xlat1.x;
#ifdef UNITY_ADRENO_ES3
        ...
        u_xlat0.xyz = u_xlat1.xxx * u_xlat5.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat0;
    //ENDIF
    }
    vs_COLOR0 = in_COLOR0;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat10_0.xyz * vec3(_Ambient);
    u_xlat16_2.xyz = (-u_xlat10_0.xyz) * vec3(_Ambient) + vs_COLOR1.xyz;
...
void main()
{
    u_xlat0.y = hlslcc_mtx4x4unity_MatrixV[0].z;
    u_xlat0.z = hlslcc_mtx4x4unity_MatrixV[1].z;
    ...
    u_xlat12 = inversesqrt(u_xlat12);
    u_xlat0.xyz = vec3(u_xlat12) * u_xlat0.xyz;
    u_xlat16_3 = in_TEXCOORD0.x * 2.0 + -1.0;
    u_xlat12 = u_xlat16_3 * _Width;
    u_xlat12 = u_xlat12 * _MayaScale;
    ...
    u_xlat0.xyz = u_xlat0.xyz * vec3(_Scale) + u_xlat1.xyz;
    u_xlat2 = u_xlat0.yyyy * hlslcc_mtx4x4unity_MatrixVP[1];
    u_xlat2 = hlslcc_mtx4x4unity_MatrixVP[0] * u_xlat0.xxxx + u_xlat2;
    u_xlat0 = hlslcc_mtx4x4unity_MatrixVP[2] * u_xlat0.zzzz + u_xlat2;
    gl_Position = hlslcc_mtx4x4unity_MatrixVP[3] * u_xlat1.wwww + u_xlat0;
    vs_COLOR0 = in_COLOR0;
    u_xlat0.x = u_xlat1.y * _HeigtFogColParams.x + _HeigtFogColParams.y;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat4.x = u_xlat4.y * _HeigtFogParams.x;
...
void main()
{
    ...
    u_xlat0.xyz = vec3(u_xlat15) * u_xlat0.xyz;
    u_xlat16_3 = in_TEXCOORD0.x * 2.0 + -1.0;
    u_xlat15 = u_xlat16_3 * _Width;
    u_xlat15 = u_xlat15 * _MayaScale;
    ...
    gl_Position = hlslcc_mtx4x4unity_MatrixVP[3] * u_xlat1.wwww + u_xlat0;
    vs_COLOR0 = in_COLOR0;
    u_xlat0.x = u_xlat1.y * _HeigtFogColParams3.x + _HeigtFogColParams3.y;
#ifdef UNITY_ADRENO_ES3
    u_xlat0.x = min(max(u_xlat0.x, 0.0), 1.0);
#else
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    ...
    u_xlat16_3 = (-u_xlat0.x) + 2.0;
    u_xlat16_3 = u_xlat0.x * u_xlat16_3;
    u_xlat0.xyz = vec3(u_xlat16_3) * _HeigtFogColDelta3.xyz + _HeigtFogColBase3.xyz;
    u_xlat2.xyz = (-u_xlat0.xyz) + _HeigtFogRadialCol3.xyz;
    u_xlat1.xzw = u_xlat1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat15 = u_xlat1.y * _HeigtFogColParams2.x + _HeigtFogColParams2.y;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat1.x = sqrt(u_xlat1.x);
    u_xlat6 = u_xlat1.x + (-_HeigtFogRamp3.w);
    u_xlat6 = u_xlat6 * _HeigtFogColParams3.w;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat6 = u_xlat1.x * _HeigtFogParams3.z + _HeigtFogParams3.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat6 = min(max(u_xlat6, 0.0), 1.0);
#else
    u_xlat6 = clamp(u_xlat6, 0.0, 1.0);
#endif
    u_xlat16 = (-u_xlat6) + 2.0;
    u_xlat6 = u_xlat16 * u_xlat6;
    u_xlat16 = u_xlat6 * _HeigtFogColDelta3.w;
    ...
    u_xlatb2 = u_xlat1.x>=u_xlat2.x;
#endif
    u_xlat6 = (u_xlatb2) ? u_xlat16 : u_xlat6;
    u_xlat6 = log2(u_xlat6);
    u_xlat6 = u_xlat6 * _Mihoyo_FogColor3.w;
    u_xlat6 = exp2(u_xlat6);
    u_xlat6 = min(u_xlat6, _HeigtFogColBase3.w);
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat6);
    u_xlat6 = (-u_xlat6) + 1.0;
    u_xlat16 = u_xlat1.z * _HeigtFogParams3.x;
    u_xlat11 = u_xlat1.z * _HeigtFogParams2.x;
    ...
    u_xlat16 = u_xlat1.x * _HeigtFogParams3.y;
    u_xlat16_3 = u_xlat16 * u_xlat16_3;
    u_xlat16_3 = exp2((-u_xlat16_3));
    u_xlat16_3 = min(u_xlat16_3, 1.0);
    u_xlat16_3 = (-u_xlat16_3) + 1.0;
    u_xlat16 = u_xlat1.x * _HeigtFogRamp3.x + _HeigtFogRamp3.y;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat3.w = u_xlat6 * u_xlat7.x;
    u_xlat3.xyz = _Mihoyo_FogColor3.xyz * vec3(u_xlat16) + u_xlat0.xyz;
    u_xlat16_4 = (-u_xlat15) + 2.0;
    u_xlat16_4 = u_xlat15 * u_xlat16_4;
    u_xlat0.xyz = vec3(u_xlat16_4) * _HeigtFogColDelta2.xyz + _HeigtFogColBase2.xyz;
    u_xlat7.xyz = (-u_xlat0.xyz) + _HeigtFogRadialCol2.xyz;
    u_xlat15 = u_xlat1.x + (-_HeigtFogRamp2.w);
    u_xlat15 = u_xlat15 * _HeigtFogColParams2.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat15 = min(max(u_xlat15, 0.0), 1.0);
#else
    u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
#endif
    u_xlat0.xyz = vec3(u_xlat15) * u_xlat7.xyz + u_xlat0.xyz;
    u_xlat15 = u_xlat1.x * _HeigtFogParams2.z + _HeigtFogParams2.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat15 = min(max(u_xlat15, 0.0), 1.0);
#else
    u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
#endif
    u_xlat6 = (-u_xlat15) + 2.0;
    u_xlat15 = u_xlat15 * u_xlat6;
    u_xlat6 = u_xlat15 * _HeigtFogColDelta2.w;
    u_xlat15 = (u_xlatb2) ? u_xlat6 : u_xlat15;
    u_xlat15 = log2(u_xlat15);
    u_xlat15 = u_xlat15 * _Mihoyo_FogColor2.w;
    u_xlat15 = exp2(u_xlat15);
    u_xlat15 = min(u_xlat15, _HeigtFogColBase2.w);
    u_xlat0.xyz = vec3(u_xlat15) * u_xlat0.xyz;
    u_xlat15 = (-u_xlat15) + 1.0;
    u_xlat6 = u_xlat11 * -1.44269502;
    u_xlat6 = exp2(u_xlat6);
    u_xlat6 = (-u_xlat6) + 1.0;
    ...
    u_xlatb11 = 0.00999999978<abs(u_xlat11);
#endif
    u_xlat16_4 = (u_xlatb11) ? u_xlat6 : 1.0;
    u_xlat6 = u_xlat1.x * _HeigtFogParams2.y;
    ...
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
#endif
    u_xlat16_4 = u_xlat6 * u_xlat16_4;
    u_xlat16_4 = exp2((-u_xlat16_4));
    u_xlat16_4 = min(u_xlat16_4, 1.0);
    u_xlat16_4 = (-u_xlat16_4) + 1.0;
    u_xlat16_9 = (-u_xlat1.x) + 2.0;
    u_xlat16_9 = u_xlat1.x * u_xlat16_9;
    u_xlat1.x = u_xlat16_9 * _HeigtFogRamp2.z + (-_HeigtFogRamp2.z);
    u_xlat1.x = u_xlat1.x + 1.0;
    u_xlat16_4 = u_xlat1.x * u_xlat16_4;
    u_xlat1.x = min(u_xlat16_4, _HeigtFogColBase2.w);
    u_xlat6 = (-u_xlat1.x) + 1.0;
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat6);
    u_xlat2.w = u_xlat15 * u_xlat6;
