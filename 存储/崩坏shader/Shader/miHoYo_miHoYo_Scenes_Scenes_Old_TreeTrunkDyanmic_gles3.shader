...
void main()
{
    ...
    u_xlat3 = u_xlat0.y * _BendScale + 1.0;
    u_xlat3 = u_xlat3 * u_xlat3;
    u_xlat3 = u_xlat3 * u_xlat3 + (-u_xlat3);
    u_xlat0.xz = _miHoYo_Wind.xz * vec2(u_xlat3) + u_xlat0.xz;
...
void main()
{
    ...
    u_xlat13 = u_xlat1.y * _BendScale + 1.0;
    u_xlat13 = u_xlat13 * u_xlat13;
    u_xlat13 = u_xlat13 * u_xlat13 + (-u_xlat13);
    u_xlat2.xz = _miHoYo_Wind.xz * vec2(u_xlat13) + u_xlat1.xz;
    u_xlat2.y = u_xlat1.y;
    ...
    u_xlat1.xyz = u_xlat5.xyz * u_xlat1.xxx + hlslcc_mtx4x4unity_ObjectToWorld[3].xyz;
...
#endif
    SV_Target0.xyz = u_xlat0.xyz * vec3(u_xlat16_1) + vs_COLOR1.xyz;
    SV_Target0.w = _BloomFactor;
    return;
}
