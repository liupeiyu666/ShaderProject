...
void main()
{
    ...
    u_xlat4 = hlslcc_mtx4x4unity_ObjectToWorld[1].y * hlslcc_mtx4x4unity_MatrixV[1].z;
    u_xlat4 = hlslcc_mtx4x4unity_MatrixV[0].z * hlslcc_mtx4x4unity_ObjectToWorld[1].x + u_xlat4;
    u_xlat4 = hlslcc_mtx4x4unity_MatrixV[2].z * hlslcc_mtx4x4unity_ObjectToWorld[1].z + u_xlat4;
    u_xlat4 = hlslcc_mtx4x4unity_MatrixV[3].z * hlslcc_mtx4x4unity_ObjectToWorld[1].w + u_xlat4;
    ...
    if(u_xlatb13){
        ...
        u_xlat13 = u_xlat13 + (-_FogStartDistance);
        u_xlat13 = max(u_xlat13, 0.0);
        u_xlat2.xy = vec2(u_xlat13) * vec2(_FogIntensity, _FogColorIntensity);
        u_xlat2.xy = u_xlat2.xy * (-u_xlat2.xy);
        u_xlat13 = u_xlat2.x * _FogTune;
        u_xlat13 = u_xlat13 * 1.44269502;
        u_xlat13 = exp2(u_xlat13);
        u_xlat13 = (-u_xlat13) + 1.0;
        u_xlat13 = u_xlat13 * _FogEffectLimit;
        u_xlat2.x = _FogEffectStart * _FogTune;
        u_xlat13 = max(u_xlat13, u_xlat2.x);
        u_xlat3.w = min(u_xlat13, _FogEffectLimit);
        u_xlat13 = u_xlat2.y * 1.44269502;
        u_xlat13 = exp2(u_xlat13);
        u_xlat2.xyz = _FogColorNear.xyz + (-_FogColorFar.xyz);
        u_xlat3.xyz = vec3(u_xlat13) * u_xlat2.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat3;
    } else {
        u_xlat2.xyz = u_xlat1.xyz + (-_WorldSpaceCameraPos.xyz);
        u_xlat13 = dot(u_xlat2.xyz, u_xlat2.xyz);
        ...
        u_xlat2.xy = u_xlat2.yx / vec2(u_xlat13);
        u_xlat13 = u_xlat2.y * _FogEffectLimit;
        u_xlat6 = _FogEffectStart * _FogTune;
        u_xlat13 = max(u_xlat13, u_xlat6);
        u_xlat3.w = min(u_xlat13, _FogEffectLimit);
        u_xlat2.x = u_xlat2.x;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat4 = u_xlat4 * in_POSITION0.y;
    u_xlat0 = u_xlat0 * in_POSITION0.x + u_xlat4;
    u_xlat0 = u_xlat8 * in_POSITION0.z + u_xlat0;
    u_xlat0 = u_xlat12 * in_POSITION0.w + u_xlat0;
    u_xlat0 = (-u_xlat0) + (-_ProjectionParams.y);
    u_xlat0 = u_xlat0 + (-_FadeOffset);
    vs_TEXCOORD2.w = u_xlat0 / _FadeDistance;
#ifdef UNITY_ADRENO_ES3
    vs_TEXCOORD2.w = min(max(vs_TEXCOORD2.w, 0.0), 1.0);
#else
...
void main()
{
    ...
    u_xlat12 = inversesqrt(u_xlat12);
    u_xlat0.xyz = vec3(u_xlat12) * u_xlat0.xyz;
    u_xlat12 = dot(u_xlat0.xyz, vs_TEXCOORD3.xyz);
    u_xlat12 = u_xlat12 + u_xlat12;
    u_xlat0.xyz = vs_TEXCOORD3.xyz * (-vec3(u_xlat12)) + u_xlat0.xyz;
    ...
    u_xlat16_15 = u_xlat16_15 * _Transparent;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_15 = min(max(u_xlat16_15, 0.0), 1.0);
#else
    u_xlat16_15 = clamp(u_xlat16_15, 0.0, 1.0);
#endif
    u_xlat0.x = u_xlat16_15 * vs_TEXCOORD2.w;
...
void main()
{
    ...
    vs_TEXCOORD2.w = u_xlat12 / _FadeDistance;
#ifdef UNITY_ADRENO_ES3
    vs_TEXCOORD2.w = min(max(vs_TEXCOORD2.w, 0.0), 1.0);
#else
    vs_TEXCOORD2.w = clamp(vs_TEXCOORD2.w, 0.0, 1.0);
...
void main()
{
    ...
    vs_TEXCOORD2.w = u_xlat15 / _FadeDistance;
#ifdef UNITY_ADRENO_ES3
    vs_TEXCOORD2.w = min(max(vs_TEXCOORD2.w, 0.0), 1.0);
#else
    vs_TEXCOORD2.w = clamp(vs_TEXCOORD2.w, 0.0, 1.0);
