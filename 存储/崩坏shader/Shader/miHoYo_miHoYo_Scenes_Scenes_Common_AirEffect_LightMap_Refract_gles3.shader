...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_2.xyz * vec3(vec3(_LightMapIntensity, _LightMapIntensity, _LightMapIntensity)) + u_xlat0.xyz;
    u_xlat16_2.xyz = (-u_xlat0.xyz) + vs_COLOR0.xyz;
    SV_Target0.xyz = vs_COLOR0.www * u_xlat16_2.xyz + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat1.xyz;
    u_xlat0.xyz = u_xlat16_2.xyz * vec3(vec3(_LightMapIntensity, _LightMapIntensity, _LightMapIntensity)) + u_xlat0.xyz;
    u_xlat16_2.x = vs_COLOR0.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_2.x = min(max(u_xlat16_2.x, 0.0), 1.0);
#else
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
#endif
    SV_Target0.xyz = u_xlat0.xyz * u_xlat16_2.xxx + vs_COLOR0.xyz;
    SV_Target0.w = _BloomFactor;
    return;
}
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_2.xyz * vec3(vec3(_LightMapIntensity, _LightMapIntensity, _LightMapIntensity)) + u_xlat0.xyz;
    u_xlat16_2.xyz = (-u_xlat0.xyz) + vs_COLOR0.xyz;
    u_xlat16_2.xyz = vs_COLOR0.www * u_xlat16_2.xyz + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
#endif
    u_xlat16_2.xyz = u_xlat0.xyz * u_xlat16_2.xxx + vs_COLOR0.xyz;
    u_xlat16_0.x = dot(u_xlat16_2.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_0.xyz = (-u_xlat16_2.xyz) + u_xlat16_0.xxx;
    u_xlat16_0.xyz = vec3(_LumiFactor) * u_xlat16_0.xyz + u_xlat16_2.xyz;
    SV_Target0.xyz = u_xlat16_0.xyz;
