...
uniform highp vec4 _WSpaceCustomLightPos;
...
void main ()
{
  ...
  highp vec3 tmpvar_8;
  tmpvar_8 = normalize(_WSpaceCustomLightPos.xyz);
  highp mat3 tmpvar_9;
  ...
  tmpvar_11 = ((dot (tmpvar_10, tmpvar_8) * 0.4975) + 0.5);
  d_2 = tmpvar_11;
  ...
  tmpvar_13 = pow (max (dot (tmpvar_10, 
    normalize((tmpvar_8 + normalize((_WorldSpaceCameraPos - 
...
void main ()
{
  ...
  highp vec3 tmpvar_10;
  tmpvar_10 = normalize(_WSpaceCustomLightPos.xyz);
  ...
  highp float tmpvar_13;
  tmpvar_13 = ((dot (tmpvar_12, tmpvar_10) * 0.4975) + 0.5);
  d_3 = tmpvar_13;
  ...
  tmpvar_16 = pow (max (dot (tmpvar_12, 
    normalize((tmpvar_10 + normalize((_WorldSpaceCameraPos - tmpvar_15.xyz))))
  ), 0.0), _Shininess);
  s_2 = tmpvar_16;
