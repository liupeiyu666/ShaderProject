...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Character/Character_Simple/Simple_Star_Clamp" {
Properties {
...
void main ()
{
  ...
  tmpvar_13.xyz = (tmpvar_12.xyz / tmpvar_12.w);
  tmpvar_13.w = (tmpvar_12.y / tmpvar_12.w);
  tmpvar_1 = (unity_ObjectToWorld * vec4(0.0, 0.0, 0.0, 1.0));
  ...
  xlv_TEXCOORD0 = o_4;
  xlv_TEXCOORD1 = o_9;
  xlv_NORMAL = normalize(normalize((_glesNormal * tmpvar_14)));
  xlv_TEXCOORD2 = tmpvar_13;
  xlv_TEXCOORD3 = tmpvar_1;
  xlv_TEXCOORD4 = _glesMultiTexCoord0;
}
...
uniform mediump vec4 _MainTexColor;
uniform mediump float _MainTexIntensity;
varying highp vec4 xlv_TEXCOORD0;
varying highp vec4 xlv_TEXCOORD1;
varying highp vec3 xlv_NORMAL;
varying highp vec4 xlv_TEXCOORD2;
...
void main ()
{
  ...
  tmpvar_32 = ((xlv_TEXCOORD4.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
  lowp vec4 tmpvar_33;
  tmpvar_33 = texture2D (_MainTex, tmpvar_32);
  result_2.xyz = (result_2.xyz + ((tmpvar_33 * _MainTexColor) * _MainTexIntensity).xyz);
  result_2.w = clamp (result_2.w, 0.0, 1.0);
...
void main ()
{
  ...
  outColor_2.w = clamp (_Opaqueness, 0.0, 1.0);
  tmpvar_1 = outColor_2;
