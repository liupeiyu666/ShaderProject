...
void main()
{
    ...
    SV_TARGET0.xyz = u_xlat16_0.www * u_xlat16_1.xyz + vec3(1.0, 1.0, 1.0);
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_0.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + vec3(-1.0, -1.0, -1.0);
    SV_TARGET0.xyz = vec3(u_xlat16_2) * u_xlat16_5.xyz + vec3(1.0, 1.0, 1.0);
...
void main()
{
    ...
    u_xlat0.x = u_xlat16_2.x + _NoiseOffset;
    u_xlat3.xy = vs_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat3.xy = vec2(_USpeed, _VSpeed) * _Time.yy + u_xlat3.xy;
    u_xlat0.xy = u_xlat0.xx * vec2(_NoiseBrightness) + u_xlat3.xy;
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy);
    u_xlat16_0 = u_xlat10_0 * vs_COLOR0;
    u_xlat16_2.xyz = u_xlat16_0.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + vec3(-1.0, -1.0, -1.0);
    SV_TARGET0.xyz = u_xlat16_0.www * u_xlat16_2.xyz + vec3(1.0, 1.0, 1.0);
    SV_TARGET0.w = u_xlat16_0.w;
    return;
}
...
void main()
{
    ...
    u_xlatb3 = equal(vec4(_MaskChannelMapping), vec4(0.0, 1.0, 2.0, 3.0));
    u_xlat16_14 = (u_xlatb3.w) ? u_xlat1.w : 0.0;
    u_xlat16_14 = (u_xlatb3.z) ? u_xlat1.z : u_xlat16_14;
    u_xlat16_14 = (u_xlatb3.y) ? u_xlat1.y : u_xlat16_14;
    u_xlat16_14 = (u_xlatb3.x) ? u_xlat1.x : u_xlat16_14;
    u_xlat16_14 = u_xlat16_0.w * u_xlat16_14;
    SV_TARGET0.xyz = vec3(u_xlat16_14) * u_xlat16_2.xyz + vec3(1.0, 1.0, 1.0);
...
void main()
{
    ...
    u_xlat0.x = u_xlat16_2.x * u_xlat16_5 + _NoiseOffset;
    u_xlat3.xy = vs_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat3.xy = vec2(_USpeed, _VSpeed) * _Time.yy + u_xlat3.xy;
    u_xlat0.xy = u_xlat0.xx * vec2(_NoiseBrightness) + u_xlat3.xy;
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy);
...
void main()
{
    ...
    u_xlat0.x = u_xlat16_2.x * u_xlat16_6 + _NoiseOffset;
    u_xlat4.xy = vs_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat4.xy = vec2(_USpeed, _VSpeed) * _Time.yy + u_xlat4.xy;
    u_xlat0.xy = u_xlat0.xx * vec2(_NoiseBrightness) + u_xlat4.xy;
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy);
...
void main()
{
    ...
    u_xlat16_1 = u_xlat10_0 * vs_TEXCOORD2;
    u_xlat0.x = u_xlat16_1 * _BloomFactor;
...
void main()
{
    ...
    u_xlat0.xy = vec2(vec2(_NoiseOffset, _NoiseOffset)) * vec2(_NoiseBrightness) + u_xlat0.xy;
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy).w;
    u_xlat16_5 = u_xlat10_0 * vs_TEXCOORD2;
    u_xlat16_2 = u_xlat16_2 * u_xlat16_5;
    u_xlat0.x = u_xlat16_2 * _BloomFactor;
    SV_TARGET0.w = u_xlat0.x;
    SV_TARGET0.xyz = vec3(0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    ...
    u_xlat0.xy = u_xlat0.xx * vec2(_NoiseBrightness) + u_xlat3.xy;
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy).w;
    u_xlat16_2 = u_xlat10_0 * vs_TEXCOORD2;
    u_xlat0.x = u_xlat16_2 * _BloomFactor;
    SV_TARGET0.w = u_xlat0.x;
    SV_TARGET0.xyz = vec3(0.0, 0.0, 0.0);
    return;
