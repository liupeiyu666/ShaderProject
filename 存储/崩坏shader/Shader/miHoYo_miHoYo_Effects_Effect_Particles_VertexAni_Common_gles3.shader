...
void main()
{
    u_xlat0.xy = in_TEXCOORD0.xy * _Noise_ST.xy + _Noise_ST.zw;
    u_xlat0 = textureLod(_Noise, u_xlat0.xy, 0.0);
    u_xlat0 = u_xlat0 * _MoveandScaleXYZmovespeedWScaleSpeed;
    u_xlat16_1.xyz = u_xlat0.www * in_NORMAL0.xyz;
    u_xlat2.xy = _Time.yy * vec2(_MoveSpeed, _ScaleSpeed);
    u_xlat16_3.xy = sin(u_xlat2.xy);
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_3.yyy;
    u_xlat16_1.xyz = u_xlat0.xyz * u_xlat16_3.xxx + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat0.xy = _Time.yy * _UVSpeed.xy + u_xlat0.xy;
    ...
    SV_Target0.w = u_xlat10_0.w * u_xlat0.x;
...
void main()
{
    ...
    u_xlat0.xy = _Time.yy * _UVSpeed.xy + u_xlat0.xy;
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy);
    u_xlat1 = vs_COLOR0.w * _MainColor.w;
    SV_Target0.w = u_xlat10_0.w * u_xlat1;
#ifdef UNITY_ADRENO_ES3
    SV_Target0.w = min(max(SV_Target0.w, 0.0), 1.0);
#else
    SV_Target0.w = clamp(SV_Target0.w, 0.0, 1.0);
#endif
    u_xlat16_2.xyz = u_xlat10_0.xyz * _MainColor.xyz;
...
void main()
{
    ...
    u_xlat4.xy = in_TEXCOORD0.xy * _Noise_ST.xy + _Noise_ST.zw;
    u_xlat1 = textureLod(_Noise, u_xlat4.xy, 0.0);
    u_xlat1 = u_xlat1 * _MoveandScaleXYZmovespeedWScaleSpeed;
    u_xlat16_2.xyz = u_xlat1.www * in_NORMAL0.xyz;
    u_xlat4.xy = _Time.yy * vec2(_MoveSpeed, _ScaleSpeed);
    u_xlat16_3.xy = sin(u_xlat4.xy);
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_3.yyy;
    u_xlat16_2.xyz = u_xlat1.xyz * u_xlat16_3.xxx + u_xlat16_2.xyz;
    u_xlat4.xyz = u_xlat16_2.xyz + in_POSITION0.xyz;
...
void main()
{
    ...
    u_xlat16_1 = u_xlat2 * u_xlat10_0 + (-_MotionVectorsAlphaCutoff);
#ifdef UNITY_ADRENO_ES3
