...
void main ()
{
  ...
  mediump vec3 N_1;
  highp vec4 posInCam_2;
  highp vec4 tmpvar_3;
  highp vec4 tmpvar_4;
  highp vec4 tmpvar_5;
  tmpvar_5 = (unity_MatrixMV * _glesVertex);
  posInCam_2 = (tmpvar_5 / tmpvar_5.w);
  highp mat3 tmpvar_6;
  ...
  N_1 = tmpvar_8;
  posInCam_2.xy = (posInCam_2.xy + (tmpvar_8.xy * _EliteNormalDisplacement3));
  tmpvar_3 = (glstate_matrix_projection * posInCam_2);
  highp vec4 o_9;
...
void main ()
{
  ...
  tmpvar_2.xyz = vec3(_EliteEmissionScaler3);
  tmpvar_2.w = xlv_TEXCOORD0;
  color_1 = (_EliteColor3 * tmpvar_2);
  highp vec4 scrpos_3;
...
void main ()
{
  ...
  tmpvar_8 = normalize(N_1);
  N_1 = tmpvar_8;
  posInCam_2.xy = (posInCam_2.xy + (tmpvar_8.xy * _EliteNormalDisplacement2));
  tmpvar_3 = (glstate_matrix_projection * posInCam_2);
  highp vec4 o_9;
  highp vec4 tmpvar_10;
  tmpvar_10 = (tmpvar_3 * 0.5);
...
void main ()
{
  mediump vec4 color_1;
  mediump vec4 tmpvar_2;
  tmpvar_2.xyz = vec3(_EliteEmissionScaler2);
  tmpvar_2.w = xlv_TEXCOORD0;
  color_1 = (_EliteColor2 * tmpvar_2);
  highp vec4 scrpos_3;
  scrpos_3 = xlv_TEXCOORD1;
  mediump float a_4;
  a_4 = xlv_TEXCOORD1.z;
...
void main ()
{
  ...
  tmpvar_8 = normalize(N_1);
  N_1 = tmpvar_8;
  posInCam_2.xy = (posInCam_2.xy + (tmpvar_8.xy * _EliteNormalDisplacement1));
  tmpvar_3 = (glstate_matrix_projection * posInCam_2);
  highp vec4 o_9;
  highp vec4 tmpvar_10;
  tmpvar_10 = (tmpvar_3 * 0.5);
...
void main ()
{
  mediump vec4 color_1;
  mediump vec4 tmpvar_2;
  tmpvar_2.xyz = vec3(_EliteEmissionScaler1);
  tmpvar_2.w = xlv_TEXCOORD0;
  color_1 = (_EliteColor1 * tmpvar_2);
  highp vec4 scrpos_3;
  scrpos_3 = xlv_TEXCOORD1;
  mediump float a_4;
  a_4 = xlv_TEXCOORD1.z;
...
void main ()
{
  ...
  color_1.w = (_EliteBloomFactor * xlv_TEXCOORD0);
  gl_FragData[0] = color_1;
}
