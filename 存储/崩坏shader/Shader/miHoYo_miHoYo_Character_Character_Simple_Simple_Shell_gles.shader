...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Character/Character_Simple/Simple_Shell" {
Properties {
...
void main ()
{
  ...
  outColor_7.w = clamp (spColor_19.w, 0.0, 1.0);
  tmpvar_1 = outColor_7;
  gl_FragData[0] = tmpvar_1;
}
...
uniform highp mat4 unity_ObjectToWorld;
uniform highp mat4 unity_MatrixVP;
uniform highp float _ShellNormalDisplacment;
void main ()
{
  highp vec4 tmpvar_1;
  tmpvar_1.w = _glesVertex.w;
  tmpvar_1.xyz = (_glesVertex.xyz + (normalize(_glesNormal) * _ShellNormalDisplacment));
  highp vec4 tmpvar_2;
  tmpvar_2.w = 1.0;
...
uniform highp mat4 unity_WorldToObject;
uniform highp mat4 unity_MatrixVP;
uniform highp vec4 _ShellTex_ST;
uniform highp float _ShellNormalDisplacment;
...
void main ()
{
  ...
  tmpvar_1.xyz = (_glesVertex.xyz + (tmpvar_2 * _ShellNormalDisplacment));
  highp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = tmpvar_1.xyz;
  gl_Position = (unity_MatrixVP * (unity_ObjectToWorld * tmpvar_4));
  xlv_TEXCOORD0 = ((_glesMultiTexCoord0.xy * _ShellTex_ST.xy) + _ShellTex_ST.zw);
  xlv_TEXCOORD1 = normalize((tmpvar_2 * tmpvar_3));
...
uniform highp vec4 _ShellFresnel;
varying highp vec2 xlv_TEXCOORD0;
varying highp vec3 xlv_TEXCOORD1;
varying highp vec3 xlv_TEXCOORD2;
void main ()
{
  ...
  color_2.w = 0.0;
  lowp vec4 tmpvar_3;
  tmpvar_3 = texture2D (_ShellTex, xlv_TEXCOORD0);
  texColor_1 = tmpvar_3;
  highp vec3 tmpvar_4;
  tmpvar_4 = ((_ShellColor * _ShellEmission) * ((
    (pow (clamp ((1.0 - 
      dot (normalize(xlv_TEXCOORD1), normalize((_WorldSpaceCameraPos - xlv_TEXCOORD2)))
    ), 0.0, 1.0), _ShellFresnel.x) * _ShellFresnel.y)
   + _ShellFresnel.z) + (texColor_1 * _ShellFresnel.w))).xyz;
  color_2.xyz = tmpvar_4;
