...
void main()
{
    ...
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy).y;
    u_xlat0 = vec4(u_xlat10_0) * _CausticColor;
    u_xlat0 = u_xlat0 * vec4(vec4(_CausticIntensity, _CausticIntensity, _CausticIntensity, _CausticIntensity));
    u_xlat16_1.xyz = (-u_xlat0.xyz) * vs_COLOR1.www + vs_COLOR0.xyz;
    u_xlat0 = u_xlat0 * vs_COLOR1.wwww;
    SV_Target0.xyz = vs_COLOR0.www * u_xlat16_1.xyz + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = (-u_xlat0.xyz) * vs_COLOR1.www + vs_COLOR0.xyz;
    u_xlat0 = u_xlat0 * vs_COLOR1.wwww;
    u_xlat16_1.xyz = vs_COLOR0.www * u_xlat16_1.xyz + u_xlat0.xyz;
    u_xlat16_2.x = dot(u_xlat16_1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_2.xyz = (-u_xlat16_1.xyz) + u_xlat16_2.xxx;
    u_xlat0.xyz = vec3(_LumiFactor) * u_xlat16_2.xyz + u_xlat16_1.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
#endif
    SV_Target0.xyz = u_xlat0.xyz * vec3(u_xlat16_1) + vs_COLOR0.xyz;
    SV_Target0.w = u_xlat0.w;
    return;
}
...
#endif
    u_xlat16_1.xyz = u_xlat0.xyz * u_xlat16_1.xxx + vs_COLOR0.xyz;
    u_xlat16_2.x = dot(u_xlat16_1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_2.xyz = (-u_xlat16_1.xyz) + u_xlat16_2.xxx;
    u_xlat0.xyz = vec3(_LumiFactor) * u_xlat16_2.xyz + u_xlat16_1.xyz;
    SV_Target0 = u_xlat0;
