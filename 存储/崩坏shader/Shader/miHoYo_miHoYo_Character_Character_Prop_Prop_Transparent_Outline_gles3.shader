...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Character/Character_Prop/Prop_Transparent_Outline" {
Properties {
...
void main()
{
    ...
    u_xlat1.xyz = hlslcc_mtx4x4unity_WorldToObject[2].xyz * _ClipPlane.zzz + u_xlat1.xyz;
    u_xlat0.x = dot(u_xlat0.xyz, u_xlat1.xyz);
    u_xlat6.x = dot(in_POSITION0.xyz, u_xlat1.xyz);
    u_xlat0.x = (-u_xlat0.x) + u_xlat6.x;
    u_xlat6.xyz = (-u_xlat0.xxx) * u_xlat1.xyz + in_POSITION0.xyz;
    u_xlat0.x = u_xlat0.x + 1.0;
    u_xlat0.x = floor(u_xlat0.x);
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlati0 = int(u_xlat0.x);
    ...
    u_xlat16_5 = (u_xlatb12) ? u_xlat6.x : 1.0;
    u_xlat6.x = 0.0;
    u_xlat0.x = (u_xlati0 != 0) ? u_xlat16_5 : u_xlat6.x;
...
void main()
{
    ...
    u_xlat0.xyz = (bool(u_xlatb0)) ? vec3(0.0, 0.0, 0.0) : u_xlat7.xyz;
    u_xlat1 = u_xlat0.yyyy * hlslcc_mtx4x4unity_WorldToObject[1];
    u_xlat1 = hlslcc_mtx4x4unity_WorldToObject[0] * u_xlat0.xxxx + u_xlat1;
    u_xlat0 = hlslcc_mtx4x4unity_WorldToObject[2] * u_xlat0.zzzz + u_xlat1;
    u_xlat0 = u_xlat0 + hlslcc_mtx4x4unity_WorldToObject[3];
    ...
    u_xlat0.x = dot(u_xlat0.xyz, u_xlat1.xyz);
    u_xlat7.x = dot(in_POSITION0.xyz, u_xlat1.xyw);
