...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_UI/Image Grayscale" {
Properties {
...
void main()
{
    ...
    SV_Target0.xyz = vec3(dot(u_xlat16_0.xyz, vec3(0.219999999, 0.707000017, 0.0710000023)));
...
void main()
{
    ...
    u_xlat16_0.y = u_xlat16_0.x * u_xlat16_1.w;
    u_xlat16_0.x = dot(u_xlat16_1.xyz, vec3(0.219999999, 0.707000017, 0.0710000023));
