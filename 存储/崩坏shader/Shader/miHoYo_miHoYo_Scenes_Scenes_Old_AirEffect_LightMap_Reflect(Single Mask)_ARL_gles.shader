...
void main ()
{
  ...
  tmpvar_13 = (tex_C_Color_5.xyz * ((2.0 * tex_S_Color_2.xyz) + 1.0));
  colorBlendLightMap_1 = tmpvar_13;
  if ((_DebugLightmap > 0.0)) {
    colorBlendLightMap_1 = ((tmpvar_13 * _RGLightMap) + (tex_S_Color_2.xyz * (1.0 - _RGLightMap)));
  } else {
    colorBlendLightMap_1 = ((colorBlendLightMap_1 * tex_S_Color_2.w) + (tex_S_Color_2.xyz * (1.0 - tex_S_Color_2.w)));
  };
  if ((_LigthMapIntPingPong > 0.0)) {
    ...
    colorBlendLightMap_1 = (colorBlendLightMap_1 * ((tmpvar_14 * _Magnitude) + _MinValue));
  } else {
