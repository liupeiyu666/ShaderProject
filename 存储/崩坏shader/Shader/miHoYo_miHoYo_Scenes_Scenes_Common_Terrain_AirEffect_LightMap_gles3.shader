...
void main()
{
    ...
    if(u_xlatb9){
        ...
        u_xlat9 = _FogEndDistance * _FogTune + (-_FogStartDistance);
    ...
    vs_TEXCOORD4.xyz = vec3(u_xlat9) * u_xlat1.xyz;
...
void main()
{
    ...
    u_xlat16 = u_xlat4.y * _HeigtFogParams.x;
    u_xlat15 = sqrt(u_xlat15);
    u_xlat17 = u_xlat15 + (-_HeigtFogRamp.w);
    ...
    u_xlatb2 = u_xlat15>=u_xlat2.x;
#endif
    u_xlat7 = u_xlat15 * _HeigtFogParams.z + _HeigtFogParams.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat7 = min(max(u_xlat7, 0.0), 1.0);
#else
    u_xlat7 = clamp(u_xlat7, 0.0, 1.0);
#endif
    u_xlat12 = (-u_xlat7) + 2.0;
    u_xlat7 = u_xlat12 * u_xlat7;
    u_xlat12 = u_xlat7 * _HeigtFogColDelta.w;
    u_xlat2.x = (u_xlatb2) ? u_xlat12 : u_xlat7;
    u_xlat2.x = log2(u_xlat2.x);
    u_xlat2.x = u_xlat2.x * _Mihoyo_FogColor.w;
    u_xlat2.x = exp2(u_xlat2.x);
    u_xlat2.x = min(u_xlat2.x, _HeigtFogColBase.w);
    u_xlat1.xyz = u_xlat1.xyz * u_xlat2.xxx;
    u_xlat7 = u_xlat16 * -1.44269502;
    u_xlat2.y = exp2(u_xlat7);
    u_xlat2.xy = (-u_xlat2.xy) + vec2(1.0, 1.0);
    u_xlat7 = u_xlat2.y / u_xlat16;
#ifdef UNITY_ADRENO_ES3
    u_xlatb16 = !!(0.00999999978<abs(u_xlat16));
#else
    u_xlatb16 = 0.00999999978<abs(u_xlat16);
#endif
    u_xlat16_3 = (u_xlatb16) ? u_xlat7 : 1.0;
    u_xlat16 = u_xlat15 * _HeigtFogParams.y;
    u_xlat15 = u_xlat15 * _HeigtFogRamp.x + _HeigtFogRamp.y;
#ifdef UNITY_ADRENO_ES3
    u_xlat15 = min(max(u_xlat15, 0.0), 1.0);
#else
    u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
    ...
    u_xlat16_8 = (-u_xlat15) + 2.0;
    u_xlat16_8 = u_xlat15 * u_xlat16_8;
    u_xlat15 = u_xlat16_8 * _HeigtFogRamp.z + (-_HeigtFogRamp.z);
    u_xlat15 = u_xlat15 + 1.0;
    u_xlat16_3 = u_xlat15 * u_xlat16_3;
    u_xlat15 = min(u_xlat16_3, _HeigtFogColBase.w);
    u_xlat16 = (-u_xlat15) + 1.0;
    u_xlat1.xyz = vec3(u_xlat16) * u_xlat1.xyz;
    u_xlat2.w = u_xlat16 * u_xlat2.x;
    u_xlat2.xyz = _Mihoyo_FogColor.xyz * vec3(u_xlat15) + u_xlat1.xyz;
    vs_COLOR1 = u_xlat2;
    u_xlat1.x = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[0].xyz);
    u_xlat1.y = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[1].xyz);
    u_xlat1.z = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[2].xyz);
...
void main()
{
    ...
    u_xlat19 = u_xlat18 + (-_HeigtFogRamp3.w);
    u_xlat19 = u_xlat19 * _HeigtFogColParams3.w;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat19 = u_xlat18 * _HeigtFogParams3.z + _HeigtFogParams3.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat19 = min(max(u_xlat19, 0.0), 1.0);
#else
    u_xlat19 = clamp(u_xlat19, 0.0, 1.0);
    ...
    u_xlat14 = u_xlat4.y * _HeigtFogParams2.x;
    u_xlat20 = u_xlat2.x * -1.44269502;
    ...
    u_xlatb2 = 0.00999999978<abs(u_xlat2.x);
#endif
    u_xlat16_3 = (u_xlatb2) ? u_xlat20 : 1.0;
    u_xlat2.x = u_xlat18 * _HeigtFogParams3.y;
    u_xlat16_3 = u_xlat2.x * u_xlat16_3;
    u_xlat16_3 = exp2((-u_xlat16_3));
    u_xlat16_3 = min(u_xlat16_3, 1.0);
    u_xlat16_3 = (-u_xlat16_3) + 1.0;
    u_xlat2.x = u_xlat18 * _HeigtFogRamp3.x + _HeigtFogRamp3.y;
#ifdef UNITY_ADRENO_ES3
    u_xlat2.x = min(max(u_xlat2.x, 0.0), 1.0);
#else
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
#endif
    u_xlat16_9 = (-u_xlat2.x) + 2.0;
    u_xlat16_9 = u_xlat2.x * u_xlat16_9;
    u_xlat2.x = u_xlat16_9 * _HeigtFogRamp3.z + (-_HeigtFogRamp3.z);
    u_xlat2.x = u_xlat2.x + 1.0;
    u_xlat16_3 = u_xlat2.x * u_xlat16_3;
    u_xlat2.x = min(u_xlat16_3, _HeigtFogColBase3.w);
    u_xlat20 = (-u_xlat2.x) + 1.0;
    u_xlat1.xyz = u_xlat1.xyz * vec3(u_xlat20);
    u_xlat3.w = u_xlat19 * u_xlat20;
    ...
    u_xlat19 = u_xlat18 + (-_HeigtFogRamp2.w);
    u_xlat19 = u_xlat19 * _HeigtFogColParams2.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat19 = min(max(u_xlat19, 0.0), 1.0);
#else
    u_xlat19 = clamp(u_xlat19, 0.0, 1.0);
    ...
    u_xlat19 = u_xlat18 * _HeigtFogParams2.z + _HeigtFogParams2.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat19 = min(max(u_xlat19, 0.0), 1.0);
#else
    u_xlat19 = clamp(u_xlat19, 0.0, 1.0);
    ...
    u_xlat2.x = (-u_xlat19) + 2.0;
    u_xlat19 = u_xlat19 * u_xlat2.x;
    u_xlat2.x = u_xlat19 * _HeigtFogColDelta2.w;
    u_xlat19 = (u_xlatb8) ? u_xlat2.x : u_xlat19;
    u_xlat19 = log2(u_xlat19);
    u_xlat19 = u_xlat19 * _Mihoyo_FogColor2.w;
    u_xlat19 = exp2(u_xlat19);
    u_xlat19 = min(u_xlat19, _HeigtFogColBase2.w);
    u_xlat1.xyz = vec3(u_xlat19) * u_xlat1.xyz;
    u_xlat19 = (-u_xlat19) + 1.0;
    u_xlat2.x = u_xlat14 * -1.44269502;
    u_xlat2.x = exp2(u_xlat2.x);
    u_xlat2.x = (-u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat2.x / u_xlat14;
#ifdef UNITY_ADRENO_ES3
    u_xlatb8 = !!(0.00999999978<abs(u_xlat14));
#else
    u_xlatb8 = 0.00999999978<abs(u_xlat14);
#endif
    u_xlat16_5 = (u_xlatb8) ? u_xlat2.x : 1.0;
    u_xlat2.x = u_xlat18 * _HeigtFogParams2.y;
    u_xlat18 = u_xlat18 * _HeigtFogRamp2.x + _HeigtFogRamp2.y;
#ifdef UNITY_ADRENO_ES3
    u_xlat18 = min(max(u_xlat18, 0.0), 1.0);
#else
    u_xlat18 = clamp(u_xlat18, 0.0, 1.0);
    ...
    u_xlat16_11 = (-u_xlat18) + 2.0;
    u_xlat16_11 = u_xlat18 * u_xlat16_11;
    u_xlat18 = u_xlat16_11 * _HeigtFogRamp2.z + (-_HeigtFogRamp2.z);
    u_xlat18 = u_xlat18 + 1.0;
    u_xlat16_5 = u_xlat18 * u_xlat16_5;
    u_xlat18 = min(u_xlat16_5, _HeigtFogColBase2.w);
    u_xlat2.x = (-u_xlat18) + 1.0;
    u_xlat1.xyz = u_xlat1.xyz * u_xlat2.xxx;
    u_xlat2.w = u_xlat19 * u_xlat2.x;
    u_xlat2.xyz = _Mihoyo_FogColor2.xyz * vec3(u_xlat18) + u_xlat1.xyz;
...
void main()
{
    ...
    u_xlat0.xyz = vec3(vec3(_LumiFactor, _LumiFactor, _LumiFactor)) * u_xlat16_0.xyz + u_xlat16_2.xyz;
