...
void main()
{
    ...
    u_xlat7 = hlslcc_mtx4x4unity_ObjectToWorld[1].y * hlslcc_mtx4x4unity_MatrixV[1].z;
    u_xlat7 = hlslcc_mtx4x4unity_MatrixV[0].z * hlslcc_mtx4x4unity_ObjectToWorld[1].x + u_xlat7;
    u_xlat7 = hlslcc_mtx4x4unity_MatrixV[2].z * hlslcc_mtx4x4unity_ObjectToWorld[1].z + u_xlat7;
    u_xlat7 = hlslcc_mtx4x4unity_MatrixV[3].z * hlslcc_mtx4x4unity_ObjectToWorld[1].w + u_xlat7;
    ...
    u_xlat21 = hlslcc_mtx4x4unity_ObjectToWorld[3].y * hlslcc_mtx4x4unity_MatrixV[1].z;
    u_xlat21 = hlslcc_mtx4x4unity_MatrixV[0].z * hlslcc_mtx4x4unity_ObjectToWorld[3].x + u_xlat21;
    u_xlat21 = hlslcc_mtx4x4unity_MatrixV[2].z * hlslcc_mtx4x4unity_ObjectToWorld[3].z + u_xlat21;
    u_xlat21 = hlslcc_mtx4x4unity_MatrixV[3].z * hlslcc_mtx4x4unity_ObjectToWorld[3].w + u_xlat21;
    ...
    u_xlat7 = u_xlat7 * in_POSITION0.y;
    u_xlat0.x = u_xlat0.x * in_POSITION0.x + u_xlat7;
    u_xlat0.x = u_xlat14 * in_POSITION0.z + u_xlat0.x;
    u_xlat0.x = u_xlat21 * in_POSITION0.w + u_xlat0.x;
    u_xlat0.x = (-u_xlat0.x) + (-_ProjectionParams.y);
    u_xlat0.x = u_xlat0.x + (-_FadeOffset);
    vs_TEXCOORD3.w = u_xlat0.x / _FadeDistance;
    ...
    u_xlat16_4.xyz = u_xlat0.zxy * u_xlat3.xyz;
    u_xlat16_4.xyz = u_xlat0.yzx * u_xlat3.yzx + (-u_xlat16_4.xyz);
    ...
    if(u_xlatb21){
        ...
        u_xlat6.xy = vec2(u_xlat21) * vec2(_FogIntensity, _FogColorIntensity);
        u_xlat6.xy = u_xlat6.xy * (-u_xlat6.xy);
        u_xlat21 = u_xlat6.x * _FogTune;
        ...
        u_xlat4.w = min(u_xlat21, _FogEffectLimit);
        u_xlat21 = u_xlat6.y * 1.44269502;
        u_xlat21 = exp2(u_xlat21);
        u_xlat6.xyz = _FogColorNear.xyz + (-_FogColorFar.xyz);
        u_xlat4.xyz = vec3(u_xlat21) * u_xlat6.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat4;
    } else {
        u_xlat6.xyz = u_xlat1.xyz + (-_WorldSpaceCameraPos.xyz);
        u_xlat21 = dot(u_xlat6.xyz, u_xlat6.xyz);
        ...
        u_xlat6.xy = u_xlat6.yx / vec2(u_xlat21);
        u_xlat21 = u_xlat6.y * _FogEffectLimit;
        u_xlat22 = _FogEffectStart * _FogTune;
        u_xlat21 = max(u_xlat21, u_xlat22);
        u_xlat4.w = min(u_xlat21, _FogEffectLimit);
        u_xlat6.x = u_xlat6.x;
...
void main()
{
    ...
    u_xlat0 = u_xlat10_0.w * _Transparent;
    ...
    u_xlat5.xy = u_xlat4.xy * (-vec2(u_xlat15)) + u_xlat5.xy;
    u_xlat5.xy = (-u_xlat4.xy) + u_xlat5.xy;
    u_xlat5.xy = vec2(vec2(_MetalRef, _MetalRef)) * u_xlat5.xy + u_xlat4.xy;
    u_xlat5.xy = u_xlat5.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
#ifdef UNITY_ADRENO_ES3
    u_xlatb15 = !!(0.0<_EnableMatcapSpecular);
#else
    u_xlatb15 = 0.0<_EnableMatcapSpecular;
#endif
    if(u_xlatb15){
        u_xlat6.xy = u_xlat5.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
        u_xlat10_6.xyz = texture(_SpecularMap, u_xlat6.xy).xyz;
    ...
    u_xlat10_5.xyz = texture(_MatCap, u_xlat5.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_2.xyz * u_xlat10_5.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz + u_xlat16_5.xyz;
    u_xlat5.xyz = u_xlat16_5.xyz * u_xlat16_3.xyz + u_xlat6.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_3.xyz;
    u_xlat16_17 = (-u_xlat10_1.x) + 1.0;
    u_xlat16_2.xyz = vec3(u_xlat16_17) * u_xlat16_2.xyz;
    u_xlat5.xyz = u_xlat5.xyz * u_xlat10_1.xxx + u_xlat16_2.xyz;
    u_xlat16_2.xyz = (-u_xlat5.xyz) + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_2.xyz + u_xlat5.xyz;
    u_xlat0 = u_xlat0 * vs_TEXCOORD3.w;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    vs_TEXCOORD3.w = u_xlat18 / _FadeDistance;
#ifdef UNITY_ADRENO_ES3
    vs_TEXCOORD3.w = min(max(vs_TEXCOORD3.w, 0.0), 1.0);
#else
    vs_TEXCOORD3.w = clamp(vs_TEXCOORD3.w, 0.0, 1.0);
...
#endif
    SV_Target0.xyz = u_xlat5.xyz * u_xlat16_2.xxx + vs_COLOR1.xyz;
    u_xlat0 = u_xlat0 * vs_TEXCOORD3.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat0 = min(max(u_xlat0, 0.0), 1.0);
#else
...
void main()
{
    ...
    vs_TEXCOORD3.w = u_xlat21 / _FadeDistance;
#ifdef UNITY_ADRENO_ES3
    vs_TEXCOORD3.w = min(max(vs_TEXCOORD3.w, 0.0), 1.0);
#else
    vs_TEXCOORD3.w = clamp(vs_TEXCOORD3.w, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat4.xyz = hlslcc_mtx4x4unity_MatrixV[2].xyz * u_xlat16_2.xxx + u_xlat4.xyz;
    u_xlat16_2.xyz = u_xlat10_0.xyz * _Color.xyz;
    u_xlat0.x = u_xlat10_0.w * _Transparent;
    u_xlat16_3.xyz = u_xlat10_6.xyz + u_xlat10_6.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(_LightMapIntensity);
    u_xlat5.xyz = vs_TEXCOORD3.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat6.x = dot(u_xlat5.xyz, u_xlat5.xyz);
