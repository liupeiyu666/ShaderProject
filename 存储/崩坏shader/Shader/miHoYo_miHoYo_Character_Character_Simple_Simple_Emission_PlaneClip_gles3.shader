...
void main()
{
    ...
    u_xlat13 = _ClipPlane.w + -0.00999999978;
    u_xlat18 = u_xlat18 + (-u_xlat13);
    u_xlat18 = u_xlat18 + 1.0;
    u_xlat18 = floor(u_xlat18);
    u_xlat18 = max(u_xlat18, 0.0);
    u_xlati18 = int(u_xlat18);
    vs_COLOR0.w = (u_xlati18 != 0) ? 1.0 : 0.0;
...
void main()
{
    ...
    u_xlat2.xyz = (bool(u_xlatb18)) ? vec3(0.0, 0.0, 0.0) : u_xlat2.xyz;
    ...
    u_xlat18 = dot(u_xlat2.xyz, u_xlat3.xyz);
    u_xlat13 = dot(in_POSITION0.xyz, u_xlat3.xyz);
    u_xlat18 = (-u_xlat18) + u_xlat13;
    u_xlat18 = u_xlat18 + 1.0;
    u_xlat18 = floor(u_xlat18);
    u_xlat18 = max(u_xlat18, 0.0);
...
void main()
{
    ...
    u_xlat1 = hlslcc_mtx4x4unity_MatrixVP[3] * u_xlat1.wwww + u_xlat2;
    gl_Position = u_xlat1;
    u_xlat15 = dot(in_POSITION0.xyz, _ClipPlane.xyz);
    u_xlat11 = _ClipPlane.w + -0.00999999978;
    u_xlat15 = u_xlat15 + (-u_xlat11);
    u_xlat15 = u_xlat15 + 1.0;
    u_xlat15 = floor(u_xlat15);
    u_xlat15 = max(u_xlat15, 0.0);
    u_xlati15 = int(u_xlat15);
    vs_COLOR0.w = (u_xlati15 != 0) ? 1.0 : 0.0;
    vs_COLOR0.xyz = vec3(0.0, 0.0, 0.0);
    u_xlat2.x = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[0].xyz);
    u_xlat2.y = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[1].xyz);
    u_xlat2.z = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[2].xyz);
...
void main()
{
    ...
    gl_Position = u_xlat1;
#ifdef UNITY_ADRENO_ES3
    u_xlatb15 = !!(abs(_ClipPlane.w)<0.00100000005);
#else
    u_xlatb15 = abs(_ClipPlane.w)<0.00100000005;
#endif
    u_xlat2.xyz = _ClipPlane.www * _ClipPlane.xyz;
    u_xlat2.xyz = (bool(u_xlatb15)) ? vec3(0.0, 0.0, 0.0) : u_xlat2.xyz;
    u_xlat3 = u_xlat2.yyyy * hlslcc_mtx4x4unity_WorldToObject[1];
    u_xlat3 = hlslcc_mtx4x4unity_WorldToObject[0] * u_xlat2.xxxx + u_xlat3;
    u_xlat2 = hlslcc_mtx4x4unity_WorldToObject[2] * u_xlat2.zzzz + u_xlat3;
    u_xlat2 = u_xlat2 + hlslcc_mtx4x4unity_WorldToObject[3];
    ...
    u_xlat11 = dot(in_POSITION0.xyz, u_xlat3.xyz);
    u_xlat15 = (-u_xlat15) + u_xlat11;
    u_xlat15 = u_xlat15 + 1.0;
    u_xlat15 = floor(u_xlat15);
    u_xlat15 = max(u_xlat15, 0.0);
...
void main()
{
    ...
    u_xlat2.xyz = (-u_xlat2.xxx) * _ClipPlane.xyz + in_POSITION0.xyz;
    u_xlat15 = u_xlat15 + 1.0;
    u_xlat15 = floor(u_xlat15);
    u_xlat15 = max(u_xlat15, 0.0);
    u_xlati15 = int(u_xlat15);
    ...
    u_xlat5.xy = vec2(u_xlat15) * vec2(0.497500002, 0.497500002) + vec2(0.5, 0.5);
    vs_TEXCOORD1.xy = u_xlat5.xy;
    u_xlat16_6 = u_xlat5.y + 0.5;
    ...
    u_xlat0.x = u_xlat0.x * _Shininess;
    u_xlat0.x = exp2(u_xlat0.x);
    vs_TEXCOORD2.xy = (int(u_xlati15) != 0) ? u_xlat0.xx : vec2(0.0250000004, 0.0250000004);
    u_xlat0 = u_xlat2.xyzz * vec4(0.5, 0.5, 0.5, 0.25);
    u_xlat15 = u_xlat2.x * u_xlat0.x;
    u_xlat7 = u_xlat0.w + u_xlat0.y;
    u_xlat14.x = u_xlat0.z * u_xlat0.z + u_xlat0.x;
    u_xlat14.y = u_xlat15 * 0.25 + u_xlat7;
...
void main()
{
    ...
    u_xlat3.xyz = u_xlat5.xyz * vec3(u_xlat23) + u_xlat3.xyz;
    ...
    u_xlat23 = u_xlat23 * _Shininess;
    u_xlat23 = exp2(u_xlat23);
    vs_TEXCOORD2.xy = (int(u_xlati15) != 0) ? vec2(u_xlat23) : vec2(0.0250000004, 0.0250000004);
    u_xlat3 = u_xlat2.xyzz * vec4(0.5, 0.5, 0.5, 0.25);
    u_xlat15 = u_xlat2.x * u_xlat3.x;
    u_xlat2.x = u_xlat3.w + u_xlat3.y;
    u_xlat16.x = u_xlat3.z * u_xlat3.z + u_xlat3.x;
    u_xlat16.y = u_xlat15 * 0.25 + u_xlat2.x;
...
void main()
{
    ...
    u_xlat15 = (-u_xlat15) + u_xlat2.x;
    u_xlat2.xyz = (-vec3(u_xlat15)) * u_xlat3.xyz + in_POSITION0.xyz;
    u_xlat15 = u_xlat15 + 1.0;
    u_xlat15 = floor(u_xlat15);
    u_xlat15 = max(u_xlat15, 0.0);
    u_xlati15 = int(u_xlat15);
...
void main()
{
    ...
    u_xlat3.w = 1.0;
    u_xlat2.w = 0.0;
    u_xlat2 = (int(u_xlati13) != 0) ? u_xlat3 : u_xlat2;
    vs_COLOR0.w = u_xlat2.w;
    vs_COLOR0.xyz = vec3(0.0, 0.0, 0.0);
    u_xlat3.x = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[0].xyz);
    u_xlat3.y = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[1].xyz);
    ...
    u_xlat13 = inversesqrt(u_xlat13);
    u_xlat4.xyz = vec3(u_xlat13) * _WorldSpaceLightPos0.xyz;
    u_xlat20 = dot(u_xlat3.xyz, u_xlat4.xyz);
    u_xlat4.xy = vec2(u_xlat20) * vec2(0.497500002, 0.497500002) + vec2(0.5, 0.5);
    vs_TEXCOORD1.xy = u_xlat4.xy;
    u_xlat16_5 = u_xlat4.y + 0.5;
    u_xlat16_5 = floor(u_xlat16_5);
    u_xlat16_5 = max(u_xlat16_5, 0.0);
    u_xlati20 = int(u_xlat16_5);
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat4.xyz = (-u_xlat0.xyz) + _WorldSpaceCameraPos.xyz;
    vs_TEXCOORD4.xyz = u_xlat0.xyz / u_xlat0.www;
    ...
    u_xlat4.xyz = _WorldSpaceLightPos0.xyz * vec3(u_xlat13) + u_xlat0.xyz;
    vs_TEXCOORD5.xyz = u_xlat0.xyz;
    u_xlat0.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat0.xyz = u_xlat0.xxx * u_xlat4.xyz;
    ...
    u_xlat0.x = u_xlat0.x * _Shininess;
    u_xlat0.x = exp2(u_xlat0.x);
    vs_TEXCOORD2.xy = (int(u_xlati20) != 0) ? u_xlat0.xx : vec2(0.0250000004, 0.0250000004);
    u_xlat0 = u_xlat2.xyzz * vec4(0.5, 0.5, 0.5, 0.25);
    u_xlat13 = u_xlat2.x * u_xlat0.x;
    u_xlat6 = u_xlat0.w + u_xlat0.y;
    u_xlat12.x = u_xlat0.z * u_xlat0.z + u_xlat0.x;
    u_xlat12.y = u_xlat13 * 0.25 + u_xlat6;
...
void main()
{
    ...
    u_xlat23 = dot(u_xlat4.xyz, u_xlat3.xyz);
    u_xlat3.xy = vec2(u_xlat23) * vec2(0.497500002, 0.497500002) + vec2(0.5, 0.5);
    vs_TEXCOORD1.xy = u_xlat3.xy;
    u_xlat16_5 = u_xlat3.y + 0.5;
    u_xlat16_5 = floor(u_xlat16_5);
    u_xlat16_5 = max(u_xlat16_5, 0.0);
    u_xlati23 = int(u_xlat16_5);
    u_xlat3.xyz = (-u_xlat0.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat24 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat24 = inversesqrt(u_xlat24);
    u_xlat3.xyz = vec3(u_xlat24) * u_xlat3.xyz;
    u_xlat6.xyz = _WorldSpaceLightPos0.xyz * vec3(u_xlat15) + u_xlat3.xyz;
    vs_TEXCOORD5.xyz = u_xlat3.xyz;
    u_xlat15 = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat15 = inversesqrt(u_xlat15);
    u_xlat3.xyz = vec3(u_xlat15) * u_xlat6.xyz;
    u_xlat15 = dot(u_xlat4.xyz, u_xlat3.xyz);
    u_xlat15 = max(u_xlat15, 0.0);
    u_xlat15 = log2(u_xlat15);
    u_xlat15 = u_xlat15 * _Shininess;
    u_xlat15 = exp2(u_xlat15);
    vs_TEXCOORD2.xy = (int(u_xlati23) != 0) ? vec2(u_xlat15) : vec2(0.0250000004, 0.0250000004);
    u_xlat3 = u_xlat2.xyzz * vec4(0.5, 0.5, 0.5, 0.25);
    u_xlat15 = u_xlat2.x * u_xlat3.x;
    u_xlat2.x = u_xlat3.w + u_xlat3.y;
    u_xlat16.x = u_xlat3.z * u_xlat3.z + u_xlat3.x;
...
void main()
{
    ...
    u_xlat2.x = dot(in_POSITION0.xyz, u_xlat3.xyz);
    u_xlat13 = (-u_xlat13) + u_xlat2.x;
    u_xlat2.xyz = (-vec3(u_xlat13)) * u_xlat3.xyz + in_POSITION0.xyz;
    u_xlat13 = u_xlat13 + 1.0;
    u_xlat13 = floor(u_xlat13);
    u_xlat13 = max(u_xlat13, 0.0);
    u_xlati13 = int(u_xlat13);
...
void main()
{
    ...
    gl_Position = u_xlat1;
    u_xlat0.x = dot(in_POSITION0.xyz, _ClipPlane.xyz);
    ...
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlati0 = int(u_xlat0.x);
    vs_COLOR0.w = (u_xlati0 != 0) ? _OutlineColor.w : 0.0;
...
void main()
{
    ...
    u_xlat3.x = dot(in_POSITION0.xyz, u_xlat2.xyz);
...
void main()
{
    ...
    u_xlat4.x = u_xlat4.x + (-_ClipPlane.w);
    u_xlat2.xyz = (-u_xlat4.xxx) * _ClipPlane.xyz + in_POSITION0.xyz;
    u_xlat0.x = u_xlat0.x + 1.0;
    u_xlat0.x = floor(u_xlat0.x);
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlati0 = int(u_xlat0.x);
    ...
    u_xlat3.w = 1.0;
    u_xlat2.w = 0.0;
    u_xlat0 = (int(u_xlati0) != 0) ? u_xlat3 : u_xlat2;
    vs_COLOR0.w = u_xlat0.w * _OutlineColor.w;
    vs_COLOR0.xyz = _OutlineColor.xyz;
    u_xlat2.xz = u_xlat1.xw * vec2(0.5, 0.5);
...
void main()
{
    ...
    u_xlatb0 = abs(_ClipPlane.w)<0.00100000005;
#endif
    u_xlat4.xyz = _ClipPlane.www * _ClipPlane.xyz;
    u_xlat0.xyz = (bool(u_xlatb0)) ? vec3(0.0, 0.0, 0.0) : u_xlat4.xyz;
    u_xlat2 = u_xlat0.yyyy * hlslcc_mtx4x4unity_WorldToObject[1];
    u_xlat2 = hlslcc_mtx4x4unity_WorldToObject[0] * u_xlat0.xxxx + u_xlat2;
    u_xlat0 = hlslcc_mtx4x4unity_WorldToObject[2] * u_xlat0.zzzz + u_xlat2;
    u_xlat0 = u_xlat0 + hlslcc_mtx4x4unity_WorldToObject[3];
    ...
    u_xlat2.xyz = hlslcc_mtx4x4unity_WorldToObject[2].xyz * _ClipPlane.zzz + u_xlat2.xyz;
    u_xlat0.x = dot(u_xlat0.xyz, u_xlat2.xyz);
    u_xlat4.x = dot(in_POSITION0.xyz, u_xlat2.xyz);
    u_xlat0.x = (-u_xlat0.x) + u_xlat4.x;
    u_xlat2.xyz = (-u_xlat0.xxx) * u_xlat2.xyz + in_POSITION0.xyz;
    u_xlat0.x = u_xlat0.x + 1.0;
    u_xlat0.x = floor(u_xlat0.x);
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlati0 = int(u_xlat0.x);
