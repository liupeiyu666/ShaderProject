...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Character/Character_Simple/Simple_Emission_BOSS140" {
Properties {
...
uniform 	vec4 _WSpaceCustomLightPos;
...
void main()
{
    ...
    u_xlat18 = dot(_WSpaceCustomLightPos.xyz, _WSpaceCustomLightPos.xyz);
    u_xlat18 = inversesqrt(u_xlat18);
    u_xlat3.xyz = vec3(u_xlat18) * _WSpaceCustomLightPos.xyz;
...
void main()
{
    ...
    u_xlat15 = dot(_WSpaceCustomLightPos.xyz, _WSpaceCustomLightPos.xyz);
    u_xlat15 = inversesqrt(u_xlat15);
    u_xlat3.xyz = vec3(u_xlat15) * _WSpaceCustomLightPos.xyz;
    ...
    u_xlat3.xyz = _WSpaceCustomLightPos.xyz * vec3(u_xlat15) + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat13 = dot(_WSpaceCustomLightPos.xyz, _WSpaceCustomLightPos.xyz);
    u_xlat13 = inversesqrt(u_xlat13);
    u_xlat3.xyz = vec3(u_xlat13) * _WSpaceCustomLightPos.xyz;
...
void main()
{
    ...
    u_xlat11 = dot(_WSpaceCustomLightPos.xyz, _WSpaceCustomLightPos.xyz);
    u_xlat11 = inversesqrt(u_xlat11);
    u_xlat3.xyz = vec3(u_xlat11) * _WSpaceCustomLightPos.xyz;
    ...
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat0.xyz = u_xlat0.xxx * u_xlat3.xyz;
    u_xlat3.xyz = _WSpaceCustomLightPos.xyz * vec3(u_xlat11) + u_xlat0.xyz;
    vs_TEXCOORD5.xyz = u_xlat0.xyz;
    u_xlat0.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat0.xyz = u_xlat0.xxx * u_xlat3.xyz;
