...
void main()
{
    ...
    if(u_xlatb4){
        ...
        u_xlat4 = u_xlat4 + (-_FogStartDistance);
        u_xlat4 = max(u_xlat4, 0.0);
        u_xlat1.xy = vec2(u_xlat4) * vec2(_FogIntensity, _FogColorIntensity);
        u_xlat1.xy = u_xlat1.xy * (-u_xlat1.xy);
        u_xlat1.xy = u_xlat1.xy * vec2(1.44269502, 1.44269502);
        u_xlat1.xy = exp2(u_xlat1.xy);
        u_xlat4 = (-u_xlat1.x) + 1.0;
        u_xlat4 = u_xlat4 * _FogEffectLimit;
        u_xlat4 = max(u_xlat4, _FogEffectStart);
        u_xlat2.w = min(u_xlat4, _FogEffectLimit);
        ...
        u_xlat1.xy = u_xlat1.yx / vec2(u_xlat4);
        u_xlat4 = u_xlat1.y * _FogEffectLimit;
        u_xlat4 = max(u_xlat4, _FogEffectStart);
        u_xlat2.w = min(u_xlat4, _FogEffectLimit);
        u_xlat1.x = u_xlat1.x;
#ifdef UNITY_ADRENO_ES3
        ...
        u_xlat2.xyz = vec3(u_xlat4) * u_xlat1.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat2;
    //ENDIF
    }
    u_xlat0.xyz = hlslcc_mtx4x4unity_ObjectToWorld[3].xzw * in_POSITION0.www + u_xlat0.xzw;
    u_xlat16_3.xy = u_xlat0.xy / u_xlat0.zz;
    u_xlat16_0 = _VerticalFogColor * vec4(_VerticalFogEmissionScaler);
    vs_TEXCOORD3 = u_xlat16_0 + u_xlat16_0;
    vs_TEXCOORD4.xy = u_xlat16_3.xy * _VerticalFogNoise_ST.xy + _VerticalFogNoise_ST.zw;
    return;
}
...
uniform lowp sampler2D _VerticalFogNoise;
...
void main()
{
    ...
    u_xlat10_0.x = texture(_VerticalFogNoise, vs_TEXCOORD4.xy).x;
    u_xlat16_0 = u_xlat10_0.x + -0.5;
    u_xlat16_0 = u_xlat16_0 * _VerticalFogNoiseIntensity + 0.5;
    SV_Target0.xyz = vs_TEXCOORD3.xyz * vec3(u_xlat16_0) + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat16_3.xxx * _HeigtFogColDelta3.xyz + _HeigtFogColBase3.xyz;
    ...
    u_xlatb18 = 0.00999999978<abs(u_xlat18);
#endif
    u_xlat16_3.x = (u_xlatb18) ? u_xlat13 : 1.0;
    ...
    u_xlat16_3.x = u_xlat18 * u_xlat16_3.x;
    u_xlat18 = min(u_xlat16_3.x, _HeigtFogColBase3.w);
...
void main()
{
    ...
    u_xlat16_0.x = u_xlat16_0.x * _VerticalFogNoiseIntensity + 0.5;
    u_xlat16_1.xyz = vs_TEXCOORD3.xyz * u_xlat16_0.xxx + u_xlat16_1.xyz;
