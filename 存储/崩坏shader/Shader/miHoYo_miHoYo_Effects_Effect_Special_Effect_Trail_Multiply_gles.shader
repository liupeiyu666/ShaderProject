...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Effects/Effect_Special/Effect_Trail/Multiply" {
Properties {
...
void main ()
{
  ...
  prev_1.w = tmpvar_5.w;
  prev_1.xyz = (tmpvar_5.xyz * _EmissionScaler);
  gl_FragData[0] = mix (vec4(1.0, 1.0, 1.0, 1.0), prev_1, tmpvar_5.wwww);
}
