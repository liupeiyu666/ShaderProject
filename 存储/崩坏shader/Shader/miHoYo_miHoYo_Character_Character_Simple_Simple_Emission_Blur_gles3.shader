...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Character/Character_Simple/Simple_Emission_Blur" {
Properties {
...
SubShader {
 Tags { "Distortion" = "None" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "LightweightForward" "OutlineType" = "Simple" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
 Pass {
  Name "BASE"
  Tags { "Distortion" = "None" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "LightweightForward" "OutlineType" = "Simple" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
  GpuProgramID 3778
...
void main()
{
    ...
    u_xlat4 = u_xlat10_3 * vec4(0.5, 0.5, 0.5, 0.5);
    u_xlat16_5.xyz = u_xlat10_3.xyz * vec3(0.5, 0.5, 0.5) + u_xlat0.xyz;
    u_xlat16_5.xyz = (-u_xlat4.xyz) * u_xlat0.xyz + u_xlat16_5.xyz;
    u_xlat10_6.xyz = texture(_SPNoiseTex, vs_TEXCOORD3.zw).xyz;
    u_xlat16_29 = u_xlat10_6.x * 1.99000001;
    u_xlat26 = u_xlat16_29 * _SPNoiseScaler + -1.0;
    ...
    u_xlat16_5.xyz = u_xlat16_5.xyz * _SPOldColor.xyz;
    u_xlat16_7.xyz = u_xlat10_1.xyz * _SPCubeMapColor.xyz;
    u_xlat1.xyz = u_xlat16_7.xyz * vec3(vec3(_SPCubeMapBrightness, _SPCubeMapBrightness, _SPCubeMapBrightness)) + (-u_xlat16_5.xyz);
    u_xlat4.xyz = vec3(vec3(_SPCubeMapIntensity, _SPCubeMapIntensity, _SPCubeMapIntensity)) * u_xlat1.xyz + u_xlat16_5.xyz;
    u_xlat1.x = _SPNoiseScaler * _SPTransition;
    u_xlat1.x = u_xlat1.x * 1.70000005 + (-u_xlat26);
    u_xlat1.x = u_xlat1.x + 1.0;
    u_xlat1.x = floor(u_xlat1.x);
    u_xlat1.x = max(u_xlat1.x, 0.0);
    u_xlati1 = int(u_xlat1.x);
    u_xlat1.x = (u_xlati1 != 0) ? _SPIntensity : 0.0;
    u_xlat0.w = vs_COLOR0.w;
    u_xlat2 = (-u_xlat0) + u_xlat4;
    u_xlat0 = u_xlat1.xxxx * u_xlat2 + u_xlat0;
    u_xlat16_5.x = u_xlat0.w;
#ifdef UNITY_ADRENO_ES3
