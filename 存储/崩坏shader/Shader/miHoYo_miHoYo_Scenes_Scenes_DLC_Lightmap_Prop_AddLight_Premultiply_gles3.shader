...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_DLC/Lightmap_Prop_AddLight_Premultiply" {
Properties {
...
uniform 	mediump vec4 _SpecularMap_ST;
...
void main()
{
    ...
    if(u_xlatb15){
        ...
        u_xlat16_6.xyz = u_xlat10_6.xyz * vec3(_SpecularIntensity);
        u_xlat6.xyz = u_xlat10_1.xxx * u_xlat16_6.xyz;
    } else {
        u_xlat6.x = float(0.0);
        u_xlat6.y = float(0.0);
        u_xlat6.z = float(0.0);
    ...
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat10_1.xxx + u_xlat16_2.xyz;
    u_xlat5.xyz = u_xlat16_5.xyz * vec3(u_xlat0) + u_xlat6.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(u_xlat16_17) * u_xlat16_2.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat10_1.xxx + u_xlat16_2.xyz;
    u_xlat5.xyz = u_xlat16_5.xyz * u_xlat0.xxx + u_xlat6.xyz;
    u_xlat16_2.xyz = (-u_xlat5.xyz) + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_2.xyz + u_xlat5.xyz;
...
""
 ...
 UsePass "Hidden/miHoYo/DLC/Common/Bloom/SIMPLE"
