...
uniform 	vec3 _miHoYo_WindParams2;
uniform 	vec4 _MainTex_ST;
uniform 	mediump float _ExpandQuad;
uniform 	vec4 _miHoYo_CameraRight;
...
void main()
{
    ...
    if(u_xlatb0){
        ...
        u_xlat10 = (-_FogStartDistance) + _FogEndDistance;
        u_xlat10 = max(u_xlat10, 0.100000001);
        u_xlat0.xy = u_xlat0.yx / vec2(u_xlat10);
        u_xlat5.x = u_xlat0.y * _FogEffectLimit;
        u_xlat5.x = max(u_xlat5.x, _FogEffectStart);
        u_xlat1.w = min(u_xlat5.x, _FogEffectLimit);
        u_xlat0.x = u_xlat0.x;
#ifdef UNITY_ADRENO_ES3
        ...
        u_xlat1.xyz = u_xlat0.xxx * u_xlat5.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat1;
    //ENDIF
    }
...
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(0.0<_ExpandQuad);
#else
    u_xlatb1 = 0.0<_ExpandQuad;
#endif
    u_xlat2.xyz = (-_miHoYo_CameraRight.xyz) * in_TEXCOORD1.xxx + u_xlat0.xyz;
    u_xlat2.w = u_xlat2.y + in_TEXCOORD1.y;
    u_xlat6.x = dot(u_xlat0.xyz, vec3(1.0, 1.0, 1.0));
    u_xlat6.x = u_xlat6.x * 0.300000012 + _miHoYo_Wind.w;
    u_xlat6.x = u_xlat6.x * _miHoYo_WindParams2.y;
    u_xlat3 = u_xlat6.xxxx * vec4(1.97500002, 0.792999983, 0.375, 0.193000004);
    ...
    u_xlat6.x = dot(u_xlat3, vec4(1.0, 1.0, 1.0, 1.0));
    u_xlat11 = (-u_xlat0.y) + u_xlat2.w;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat6.x = u_xlat6.x * _miHoYo_WindParams2.x;
    u_xlat3.xyz = u_xlat6.xxx * _miHoYo_CameraRight.xyz;
    u_xlat6.xyz = u_xlat3.xyz * vec3(u_xlat11) + u_xlat2.xwz;
...
void main()
{
    ...
    u_xlat0 = hlslcc_mtx4x4unity_ObjectToWorld[3] * in_POSITION0.wwww + u_xlat0;
    u_xlat0 = u_xlat0 / u_xlat0.wwww;
    u_xlat1.x = dot(u_xlat0.xyz, vec3(1.0, 1.0, 1.0));
    u_xlat1.x = u_xlat1.x * 0.300000012 + _miHoYo_Wind.w;
    u_xlat1.x = u_xlat1.x * _miHoYo_WindParams2.y;
    ...
    u_xlat1.x = u_xlat1.x * _miHoYo_WindParams2.x;
    u_xlat1.xyz = u_xlat1.xxx * _miHoYo_CameraRight.xyz;
    u_xlat2.xyz = (-_miHoYo_CameraRight.xyz) * in_TEXCOORD1.xxx + u_xlat0.xyz;
    u_xlat2.w = u_xlat2.y + in_TEXCOORD1.y;
    u_xlat13 = (-u_xlat0.y) + u_xlat2.w;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat1.xyz = u_xlat1.xyz * vec3(u_xlat13) + u_xlat2.xwz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb13 = !!(0.0<_ExpandQuad);
#else
    u_xlatb13 = 0.0<_ExpandQuad;
#endif
...
void main()
{
    ...
    u_xlat1.xyz = u_xlat1.xyz * vec3(u_xlat16) + u_xlat2.xwz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb16 = !!(0.0<_ExpandQuad);
#else
    u_xlatb16 = 0.0<_ExpandQuad;
#endif
