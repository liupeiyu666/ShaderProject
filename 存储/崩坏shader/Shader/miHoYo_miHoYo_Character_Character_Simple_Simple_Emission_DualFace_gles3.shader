...
void main()
{
    ...
    u_xlat28 = dot(vs_TEXCOORD6.xyz, vs_TEXCOORD6.xyz);
    u_xlat28 = inversesqrt(u_xlat28);
    u_xlat2.xyz = vec3(u_xlat28) * vs_TEXCOORD6.xyz;
...
void main()
{
    ...
    u_xlat22 = _SPNoiseScaler * _SPTransition;
    u_xlat4.xy = vec2(u_xlat22) * vec2(1.70000005, 1.5) + (-vec2(u_xlat23));
    u_xlat4.xy = u_xlat4.xy + vec2(1.0, 1.0);
    u_xlat4.xy = floor(u_xlat4.xy);
    u_xlat4.xy = max(u_xlat4.xy, vec2(0.0, 0.0));
    u_xlati4.xy = ivec2(u_xlat4.xy);
...
#endif
    u_xlat5.xyz = _SPTransitionColor.xyz * vec3(_SPTransitionEmissionScaler) + (-u_xlat2.xyz);
    u_xlat23 = _SPTransitionBloomFactor + (-_BloomFactor);
    u_xlat5.xyz = vec3(u_xlat22) * u_xlat5.xyz + u_xlat2.xyz;
    u_xlat22 = u_xlat22 * u_xlat23 + _BloomFactor;
    u_xlat16_3.xyz = (u_xlati4.y != 0) ? u_xlat2.xyz : u_xlat5.xyz;
    u_xlat16_24 = (u_xlati4.y != 0) ? _BloomFactor : u_xlat22;
    u_xlat22 = (u_xlati4.x != 0) ? _SPIntensity : 0.0;
    u_xlat16_3.xyz = (u_xlati4.x != 0) ? u_xlat16_3.xyz : u_xlat2.xyz;
    u_xlat16_24 = (u_xlati4.x != 0) ? u_xlat16_24 : _BloomFactor;
    ...
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0, 1.0);
#endif
    u_xlat8 = u_xlat16_3.x * _RGRatio;
    u_xlat1.xzw = u_xlat1.xxx * _RGColor.xyz + (-u_xlat0.xyz);
    SV_Target0.xyz = vec3(u_xlat8) * u_xlat1.xzw + u_xlat0.xyz;
    u_xlat16_3.x = (-u_xlat16_24) + _EmissionBloomFactor;
    u_xlat16_3.x = u_xlat10_0.w * u_xlat16_3.x + u_xlat16_24;
    SV_Target0.w = u_xlat16_3.x;
    return;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * _BackFaceColor.xyz;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    vs_TEXCOORD1.zw = u_xlat5.xy * _SPNoiseTex_ST.xy + _SPNoiseTex_ST.zw;
    vs_TEXCOORD1.xy = in_TEXCOORD0.xy * _SPTex_ST.xy + _SPTex_ST.zw;
    return;
}
...
void main()
{
    ...
    u_xlat0.xyz = texture(_SPTex, vs_TEXCOORD1.xy).xyz;
    u_xlat10_15 = texture(_SPNoiseTex, vs_TEXCOORD1.zw).x;
    u_xlat15 = u_xlat10_15 * _SPNoiseScaler;
    u_xlat15 = u_xlat15 * 1.99000001 + -1.0;
    u_xlat1.x = _SPNoiseScaler * _SPTransition;
    u_xlat6.xy = u_xlat1.xx * vec2(1.70000005, 1.5) + (-vec2(u_xlat15));
    u_xlat6.xy = u_xlat6.xy + vec2(1.0, 1.0);
    u_xlat6.xy = floor(u_xlat6.xy);
    u_xlat6.xy = max(u_xlat6.xy, vec2(0.0, 0.0));
    u_xlati6.xy = ivec2(u_xlat6.xy);
    u_xlat15 = u_xlat1.x * 1.70000005 + (-u_xlat15);
    ...
    u_xlat1.x = _SPTransitionBloomFactor + (-_BloomFactor);
    u_xlat2.xyz = vec3(u_xlat15) * u_xlat2.xyz + u_xlat0.xyz;
    u_xlat15 = u_xlat15 * u_xlat1.x + _BloomFactor;
    u_xlat16_3.xyz = (u_xlati6.y != 0) ? u_xlat0.xyz : u_xlat2.xyz;
    u_xlat16_18 = (u_xlati6.y != 0) ? _BloomFactor : u_xlat15;
    u_xlat15 = (u_xlati6.x != 0) ? _SPIntensity : 0.0;
    u_xlat16_3.xyz = (u_xlati6.x != 0) ? u_xlat16_3.xyz : u_xlat0.xyz;
    SV_Target0.w = (u_xlati6.x != 0) ? u_xlat16_18 : _BloomFactor;
    u_xlat16_0.xyz = u_xlat16_3.xyz + (-_BackFaceColor.xyz);
    u_xlat0.xyz = vec3(u_xlat15) * u_xlat16_0.xyz + _BackFaceColor.xyz;
    ...
    u_xlatb0 = 0.5<_lightProbToggle;
#endif
    u_xlat16_4.xyz = (bool(u_xlatb0)) ? _lightProbColor.xyz : vec3(1.0, 1.0, 1.0);
