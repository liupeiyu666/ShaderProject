...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/FloorTransparent" {
Properties {
...
_Trans ("Transparent", Range(0, 1)) = 1
}
SubShader {
 LOD 200
...
void main ()
{
  ...
  tmpvar_20.xyz = diffColor_5;
  tmpvar_20.w = _BloomFactor;
  outColor_8 = (tmpvar_20 + (reflColor_1 * (bias_15 + 
    max (0.0, (pow (clamp (
  ...
  outColor_8.w = _Trans;
  outColor_8.w = clamp (outColor_8.w, 0.0, 1.0);
