...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Effects/Effect_Particles/Layer1/Alpha Blended (Single Pass)" {
Properties {
...
void main()
{
    ...
    u_xlat16_0.xyz = (-u_xlat16_0.xyz) * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + vec3(u_xlat16_1);
    SV_Target0.w = u_xlat16_0.w;
#ifdef UNITY_ADRENO_ES3
    SV_Target0.w = min(max(SV_Target0.w, 0.0), 1.0);
#else
...
void main()
{
    ...
    SV_Target0.w = clamp(SV_Target0.w, 0.0, 1.0);
#endif
    u_xlat16_9 = dot(u_xlat16_2.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_0.xyz = (-u_xlat16_0.xyz) * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + vec3(u_xlat16_9);
    u_xlat16_0.xyz = vec3(vec3(_LumiFactor, _LumiFactor, _LumiFactor)) * u_xlat16_0.xyz + u_xlat16_2.xyz;
    SV_Target0.xyz = u_xlat16_0.xyz;
    return;
}
