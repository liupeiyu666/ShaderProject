...
void main()
{
    ...
    u_xlat27 = inversesqrt(u_xlat27);
    u_xlat4.xyz = vec3(u_xlat27) * vs_TEXCOORD7.xyz;
    ...
    u_xlat16_5.xyz = vec3(u_xlat27) * _RGColor.xyz;
    u_xlat2 = (-vs_TEXCOORD8) + vec4(1.0, 1.0, 1.0, 1.0);
    u_xlat4.xyz = u_xlat2.xxx * u_xlat16_5.xyz;
    u_xlat6.xyz = u_xlat2.yyy * u_xlat16_5.xyz;
    u_xlat2.xyz = u_xlat2.zzz * u_xlat16_5.xyz;
    u_xlat7.xyz = u_xlat2.www * u_xlat16_5.xyz;
    u_xlat6.xyz = u_xlat6.xyz * vec3(vec3(_RGMaskG, _RGMaskG, _RGMaskG));
    u_xlat4.xyz = u_xlat4.xyz * vec3(vec3(_RGMaskR, _RGMaskR, _RGMaskR)) + u_xlat6.xyz;
    ...
    u_xlat16_30 = u_xlat2.y + u_xlat2.x;
...
#endif
    u_xlat16_8.xyz = (-u_xlat16_3.xyz) * u_xlat0.xyz + u_xlat2.xyz;
    u_xlat16_8.xyz = vec3(u_xlat16_30) * u_xlat16_8.xyz + u_xlat1.xyz;
    u_xlat2.xyz = (-vec3(u_xlat27)) * _RGColor.xyz + u_xlat16_8.xyz;
    u_xlat2.xyz = vec3(vec3(_RGMaskIntensity, _RGMaskIntensity, _RGMaskIntensity)) * u_xlat2.xyz + u_xlat16_5.xyz;
    u_xlat16_30 = u_xlat27;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_30 = min(max(u_xlat16_30, 0.0), 1.0);
#else
    u_xlat16_30 = clamp(u_xlat16_30, 0.0, 1.0);
#endif
    u_xlat27 = u_xlat16_30 * _RGRatio;
...
void main()
{
    ...
    u_xlat21 = inversesqrt(u_xlat21);
    u_xlat2.xyz = vec3(u_xlat21) * vs_TEXCOORD7.xyz;
    ...
    u_xlat16_3.xyz = vec3(u_xlat21) * _RGColor.xyz;
    u_xlat1 = (-vs_TEXCOORD8) + vec4(1.0, 1.0, 1.0, 1.0);
    u_xlat2.xyz = u_xlat1.xxx * u_xlat16_3.xyz;
    u_xlat4.xyz = u_xlat1.yyy * u_xlat16_3.xyz;
    u_xlat1.xyz = u_xlat1.zzz * u_xlat16_3.xyz;
    u_xlat5.xyz = u_xlat1.www * u_xlat16_3.xyz;
    u_xlat4.xyz = u_xlat4.xyz * vec3(vec3(_RGMaskG, _RGMaskG, _RGMaskG));
    u_xlat2.xyz = u_xlat2.xyz * vec3(vec3(_RGMaskR, _RGMaskR, _RGMaskR)) + u_xlat4.xyz;
    u_xlat1.xyz = u_xlat1.xyz * vec3(_RGMaskB) + u_xlat2.xyz;
    u_xlat1.xyz = u_xlat5.xyz * vec3(vec3(_RGMaskA, _RGMaskA, _RGMaskA)) + u_xlat1.xyz;
    u_xlat16_24 = u_xlat1.y + u_xlat1.x;
    ...
    u_xlat16_6.xyz = vec3(u_xlat16_24) * u_xlat16_6.xyz + u_xlat0.xyz;
    u_xlat1.xyz = (-vec3(u_xlat21)) * _RGColor.xyz + u_xlat16_6.xyz;
    u_xlat1.xyz = vec3(vec3(_RGMaskIntensity, _RGMaskIntensity, _RGMaskIntensity)) * u_xlat1.xyz + u_xlat16_3.xyz;
    ...
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0, 1.0);
#endif
    u_xlat21 = u_xlat16_3.x * _RGRatio;
...
void main()
{
    ...
    SV_Target0 = vec4(u_xlat25) * u_xlat2 + u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat28 = inversesqrt(u_xlat28);
    u_xlat2.xyz = vec3(u_xlat28) * vs_TEXCOORD7.xyz;
    ...
    u_xlat16_6.xyz = u_xlat1.xxx * _RGColor.xyz;
    u_xlat2 = (-vs_TEXCOORD8) + vec4(1.0, 1.0, 1.0, 1.0);
    u_xlat10.xyz = u_xlat2.xxx * u_xlat16_6.xyz;
    u_xlat5.xyz = u_xlat2.yyy * u_xlat16_6.xyz;
    u_xlat2.xyz = u_xlat2.zzz * u_xlat16_6.xyz;
    u_xlat8.xyz = u_xlat2.www * u_xlat16_6.xyz;
    u_xlat5.xyz = u_xlat5.xyz * vec3(vec3(_RGMaskG, _RGMaskG, _RGMaskG));
    u_xlat10.xyz = u_xlat10.xyz * vec3(vec3(_RGMaskR, _RGMaskR, _RGMaskR)) + u_xlat5.xyz;
    u_xlat10.xyz = u_xlat2.xyz * vec3(_RGMaskB) + u_xlat10.xyz;
    u_xlat10.xyz = u_xlat8.xyz * vec3(vec3(_RGMaskA, _RGMaskA, _RGMaskA)) + u_xlat10.xyz;
    u_xlat16_33 = u_xlat10.y + u_xlat10.x;
    u_xlat16_33 = u_xlat10.z + u_xlat16_33;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_7.xyz = vec3(u_xlat16_33) * u_xlat16_7.xyz + u_xlat0.xyz;
    u_xlat10.xyz = (-u_xlat1.xxx) * _RGColor.xyz + u_xlat16_7.xyz;
    u_xlat10.xyz = vec3(vec3(_RGMaskIntensity, _RGMaskIntensity, _RGMaskIntensity)) * u_xlat10.xyz + u_xlat16_6.xyz;
...
#endif
    u_xlat1.x = u_xlat16_6.x * _RGRatio;
...
void main()
{
    ...
    gl_Position = u_xlat1;
    vs_COLOR0.w = _Opaqueness * _OutlineColor.w;
