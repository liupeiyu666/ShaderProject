...
void main()
{
    ...
    u_xlatb0 = 0.0<u_xlat10_0.x;
#endif
    u_xlat3.xyz = u_xlat10_0.yyy * _EnvColor.xyz;
    u_xlat16_1.xyz = u_xlat3.xyz * vs_COLOR0.xyz;
...
void main()
{
    ...
    u_xlatb0 = 0.0<u_xlat10_0.x;
#endif
    u_xlat2.xyz = u_xlat10_0.yyy * _EnvColor.xyz;
    u_xlat16_1.xyz = u_xlat2.xyz * vs_COLOR0.xyz;
    u_xlat16_1.xyz = (bool(u_xlatb0)) ? u_xlat16_1.xyz : u_xlat2.xyz;
