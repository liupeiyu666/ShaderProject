...
void main()
{
    u_xlat16_0.xyz = vs_COLOR1.xyz + (-_HighLightColor.xyz);
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_0.xyz + _HighLightColor.xyz;
...
#endif
    SV_Target0.xyz = _HighLightColor.xyz * vec3(u_xlat16_0) + vs_COLOR1.xyz;
    SV_Target0.w = _BloomFactor;
    return;
}
...
{
    u_xlat16_0.xyz = vs_COLOR1.xyz + (-_HighLightColor.xyz);
    u_xlat16_0.xyz = vs_COLOR1.www * u_xlat16_0.xyz + _HighLightColor.xyz;
...
#endif
    u_xlat16_0.xyz = _HighLightColor.xyz * u_xlat16_0.xxx + vs_COLOR1.xyz;
    u_xlat16_1.x = dot(u_xlat16_0.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_1.xyz = (-u_xlat16_0.xyz) + u_xlat16_1.xxx;
    u_xlat16_1.xyz = vec3(_LumiFactor) * u_xlat16_1.xyz + u_xlat16_0.xyz;
    SV_Target0.xyz = u_xlat16_1.xyz;
