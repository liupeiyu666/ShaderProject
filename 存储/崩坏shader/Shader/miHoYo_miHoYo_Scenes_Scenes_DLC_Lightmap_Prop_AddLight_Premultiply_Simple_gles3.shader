...
void main()
{
...
#endif
    if(u_xlatb10){
        u_xlat6.xy = u_xlat0.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat10_1.xxx + u_xlat16_2.xyz;
    u_xlat0.xyz = u_xlat16_0.xyz * u_xlat10_0.www + u_xlat6.xyz;
    u_xlat16_2.xyz = (-u_xlat0.xyz) + vs_COLOR1.xyz;
    u_xlat16_2.xyz = vs_COLOR1.www * u_xlat16_2.xyz + u_xlat0.xyz;
    u_xlat0.xyz = u_xlat16_2.xyz * vec3(vec3(_Transparent, _Transparent, _Transparent));
