...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Effects/Effect_Special/Effect_Trail/Additive (Soft)" {
Properties {
...
void main ()
{
  ...
  color_1.xyz = (tmpvar_5.xyz * (tmpvar_5.w * _EmissionScaler));
  mediump vec4 tmpvar_6;
  tmpvar_6 = clamp (color_1, 0.0, 1.0);
  color_1 = tmpvar_6;
