...
//
///////////////////////////////////////////
Shader "hidden/Scene/Water Transparent (without reflection)" {
Properties {
...
void main()
{
    ...
    u_xlat0.xy = vec2(_Time.y * _BumpVelocity0.xxyx.y, _Time.y * float(_BumpVelocity0.y));
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * vec2(vec2(_BumpScale0, _BumpScale0)) + u_xlat0.xy;
    u_xlat0.xy = _Time.yy * _BumpVelocity1.xy;
    vs_TEXCOORD1.xy = in_TEXCOORD0.xy * vec2(vec2(_BumpScale1, _BumpScale1)) + u_xlat0.xy;
    u_xlat0.xy = _Time.yy * _CausticVelocity.xy;
    vs_TEXCOORD2.xy = in_TEXCOORD0.xy * vec2(vec2(_CausticScale, _CausticScale)) + u_xlat0.xy;
    ...
    u_xlat6 = inversesqrt(u_xlat0.x);
    u_xlat16_2.x = (-u_xlat0.y) * u_xlat6 + 1.0;
    u_xlat16_2.x = max(u_xlat16_2.x, 0.00100000005);
    u_xlat16_2.x = min(u_xlat16_2.x, 1.0);
    u_xlat16_2.x = log2(u_xlat16_2.x);
    u_xlat16_5 = u_xlat16_2.x * _ReflectionFresnelFactors.x;
    u_xlat16_5 = exp2(u_xlat16_5);
    u_xlat16_5 = u_xlat16_5 * _ReflectionFresnelFactors.y;
    u_xlat16_5 = max(u_xlat16_5, 0.0);
    u_xlat16_2.y = u_xlat16_5 + _ReflectionFresnelFactors.z;
    ...
    vs_TEXCOORD4.y = float(1.0) / u_xlat0.x;
    ...
    if(u_xlatb0){
        ...
        u_xlat6 = (-_FogStartDistance) + _FogEndDistance;
...
#endif
    u_xlat16_1 = _WaterColor + (-_RefractionColor);
    u_xlat1 = vec4(u_xlat9) * u_xlat16_1 + _RefractionColor;
    u_xlat0.xyz = u_xlat10_0.xyz * vs_TEXCOORD4.www + u_xlat1.xyz;
