...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_UI/Image Multiply(Double)" {
Properties {
...
void main ()
{
  ...
  tex_1 = tmpvar_3;
  color_2.xyz = ((tex_1.xyz * xlv_COLOR.xyz) * 2.0);
  color_2.w = (xlv_COLOR.w * tex_1.w);
  mediump vec4 tmpvar_4;
  tmpvar_4 = mix (vec4(0.5, 0.5, 0.5, 0.5), color_2, color_2.wwww);
  color_2 = tmpvar_4;
...
void main ()
{
  ...
  color_2.w = ((color_2.w * tmpvar_4.x) * ((tmpvar_4.y * tmpvar_4.z) * tmpvar_4.w));
  mediump vec4 tmpvar_6;
  tmpvar_6 = mix (vec4(0.5, 0.5, 0.5, 0.5), color_2, color_2.wwww);
  color_2 = tmpvar_6;
