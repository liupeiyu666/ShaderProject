...
void main()
{
    ...
    u_xlat16_10 = dot(u_xlat0.xyz, vs_TEXCOORD4.xyz);
    ...
    u_xlat16_10 = u_xlat16_10 * _FresnelParams.x;
    u_xlat16_10 = exp2(u_xlat16_10);
    u_xlat16_10 = u_xlat16_10 * _FresnelParams.y;
    u_xlat16_10 = max(u_xlat16_10, 0.0);
    u_xlat16_10 = u_xlat16_10 + _FresnelParams.z;
    u_xlat10_0.xy = texture(_BrushedNormalMap, vs_TEXCOORD1.xy).xy;
    u_xlat16_2.xy = u_xlat10_0.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat16_8.xy = vs_TEXCOORD2.xy / vs_TEXCOORD2.ww;
    u_xlat16_2.xy = u_xlat16_2.xy * vec2(_BrushScaleX, _BrushScaleY) + u_xlat16_8.xy;
    u_xlat10_0 = texture(_ReflectionTex, u_xlat16_2.xy);
    u_xlat16_2.xyz = u_xlat10_0.xyz * vec3(_ReflectionEmissionAdjust);
    SV_Target0.w = u_xlat10_0.w * u_xlat16_10 + _BloomFactor;
    u_xlat10_0.x = texture(_ReflectMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_2.xyz = u_xlat10_0.xxx * u_xlat16_2.xyz;
    u_xlat16_2.xyz = vec3(u_xlat16_10) * u_xlat16_2.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(_LightMapIntensity) + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16.xy = u_xlat0.xz + (-_WorldSpaceCameraPos.xz);
    u_xlat21 = dot(u_xlat16.xy, u_xlat16.xy);
    u_xlat21 = sqrt(u_xlat21);
    u_xlat21 = u_xlat21 + (-_UWFogDistStart);
    u_xlat21 = max(u_xlat21, 0.0);
    u_xlat16.xy = vec2(u_xlat21) * vec2(_UWFogDensity, _UWFogColorNFIntensity);
    u_xlat16.xy = u_xlat16.xy * (-u_xlat16.xy);
    u_xlat16.xy = u_xlat16.xy * vec2(1.44269502, 1.44269502);
    u_xlat5.xy = exp2(u_xlat16.xy);
    u_xlat21 = (-u_xlat5.x) + 1.0;
    u_xlat21 = u_xlat21 * _UWFogEffectLimit;
    u_xlat21 = max(u_xlat21, _UWFogEffectStart);
    u_xlat5.z = min(u_xlat21, _UWFogEffectLimit);
    gl_Position = u_xlat1;
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
    vs_TEXCOORD1.xy = u_xlat2.xy;
    u_xlat3.zw = u_xlat1.zw;
...
void main()
{
    u_xlat0.x = (-vs_TEXCOORD6.z) + _WaterPlaneHeight;
    u_xlat5.x = (-_UWFogHeightEnd) + _WaterPlaneHeight;
    u_xlat0.x = u_xlat0.x / u_xlat5.x;
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlat5.x = (-u_xlat0.x) * _UWHeightRatio + 1.0;
    u_xlat5.x = u_xlat5.x * vs_TEXCOORD6.y;
    u_xlat5.x = max(u_xlat5.x, _UWCriticalRange);
    u_xlat5.x = min(u_xlat5.x, 1.0);
#ifdef UNITY_ADRENO_ES3
    u_xlatb10 = !!(0.99000001<vs_TEXCOORD6.y);
#else
    u_xlatb10 = 0.99000001<vs_TEXCOORD6.y;
#endif
    u_xlat16_1 = (u_xlatb10) ? u_xlat5.x : vs_TEXCOORD6.y;
    ...
    u_xlat10_5.xyz = texture(_MainTex, u_xlat16_3.xy).xyz;
    u_xlat5.xyz = u_xlat10_5.xyz * _Color.xyz;
    u_xlat16_6.xyz = u_xlat16_6.xyz * u_xlat5.xyz;
    u_xlat5.xyz = _UWFogColorNear.xyz + (-_UWFogColorFar.xyz);
    u_xlat5.xyz = vs_TEXCOORD6.xxx * u_xlat5.xyz + _UWFogColorFar.xyz;
    u_xlat2.xyz = u_xlat16_6.xyz * vec3(_LightMapIntensity) + (-u_xlat5.xyz);
    u_xlat4.xyz = u_xlat16_6.xyz * vec3(_LightMapIntensity);
    u_xlat5.xyz = vec3(u_xlat16_1) * u_xlat2.xyz + u_xlat5.xyz;
...
#ifdef UNITY_ADRENO_ES3
    u_xlatb15 = !!(vs_TEXCOORD6.z<_WaterPlaneHeight);
#else
    u_xlatb15 = vs_TEXCOORD6.z<_WaterPlaneHeight;
#endif
...
void main()
{
    ...
    u_xlatb10 = 0.99000001<vs_TEXCOORD6.y;
#endif
    u_xlat16_1.x = (u_xlatb10) ? u_xlat5.x : vs_TEXCOORD6.y;
    ...
    u_xlat2.xyz = u_xlat16_6.xyz * vec3(_LightMapIntensity) + (-u_xlat5.xyz);
    u_xlat4.xyz = u_xlat16_6.xyz * vec3(_LightMapIntensity);
    u_xlat5.xyz = u_xlat16_1.xxx * u_xlat2.xyz + u_xlat5.xyz;
    u_xlat2.x = u_xlat0.x * _UWFogColorHLIntensity;
    u_xlat0.x = (-_UWHeightFogDensity) * u_xlat0.x + 1.0;
    u_xlat0.x = u_xlat0.x * _UWHeightFogEffectLimit;
    u_xlat0.x = max(u_xlat0.x, _UWHeightFogEffectStart);
    ...
    u_xlatb15 = vs_TEXCOORD6.z<_WaterPlaneHeight;
#endif
    u_xlat16_1.xyz = (bool(u_xlatb15)) ? u_xlat0.xyz : u_xlat4.xyz;
    u_xlat16_0.x = dot(u_xlat16_1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_0.xyz = (-u_xlat16_1.xyz) + u_xlat16_0.xxx;
    u_xlat0.xyz = vec3(_LumiFactor) * u_xlat16_0.xyz + u_xlat16_1.xyz;
    u_xlat0.w = _BloomFactor;
...
void main()
{
    ...
    u_xlat16_16 = dot(u_xlat0.xyz, vs_TEXCOORD4.xyz);
    u_xlat16_16 = (-u_xlat16_16) + 1.0;
    u_xlat16_16 = max(u_xlat16_16, 0.00100000005);
    u_xlat16_16 = min(u_xlat16_16, 1.0);
    u_xlat16_16 = log2(u_xlat16_16);
    u_xlat16_16 = u_xlat16_16 * _FresnelParams.x;
    u_xlat16_16 = exp2(u_xlat16_16);
    u_xlat16_16 = u_xlat16_16 * _FresnelParams.y;
    u_xlat16_16 = max(u_xlat16_16, 0.0);
    u_xlat16_16 = u_xlat16_16 + _FresnelParams.z;
    u_xlat10_0.xy = texture(_BrushedNormalMap, vs_TEXCOORD1.xy).xy;
    u_xlat16_2.xy = u_xlat10_0.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat16_12.xy = vs_TEXCOORD2.xy / vs_TEXCOORD2.ww;
    u_xlat16_2.xy = u_xlat16_2.xy * vec2(_BrushScaleX, _BrushScaleY) + u_xlat16_12.xy;
    u_xlat10_0 = texture(_ReflectionTex, u_xlat16_2.xy);
    u_xlat16_2.xyz = u_xlat10_0.xyz * vec3(_ReflectionEmissionAdjust);
    SV_Target0.w = u_xlat10_0.w * u_xlat16_16 + _BloomFactor;
    u_xlat10_0.x = texture(_ReflectMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_2.xyz = u_xlat10_0.xxx * u_xlat16_2.xyz;
    u_xlat16_2.xyz = vec3(u_xlat16_16) * u_xlat16_2.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(_LightMapIntensity) + u_xlat16_2.xyz;
    u_xlat0.xyz = _UWFogColorNear.xyz + (-_UWFogColorFar.xyz);
    u_xlat0.xyz = vs_TEXCOORD6.xxx * u_xlat0.xyz + _UWFogColorFar.xyz;
    u_xlat3.xyz = (-u_xlat0.xyz) + u_xlat16_1.xyz;
    u_xlat15 = (-vs_TEXCOORD6.z) + _WaterPlaneHeight;
...
#ifdef UNITY_ADRENO_ES3
    u_xlatb4 = !!(0.99000001<vs_TEXCOORD6.y);
#else
    u_xlatb4 = 0.99000001<vs_TEXCOORD6.y;
#endif
    u_xlat16_16 = (u_xlatb4) ? u_xlat18 : vs_TEXCOORD6.y;
    u_xlat16_16 = (-u_xlat16_16) + 1.0;
    u_xlat0.xyz = vec3(u_xlat16_16) * u_xlat3.xyz + u_xlat0.xyz;
