...
uniform lowp sampler2D _LightMaskTex;
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * _LightTime;
    u_xlat16_1.xy = vec2(vs_TEXCOORD1.x + float(-0.5), vs_TEXCOORD1.y + float(-0.5));
    u_xlat16_1.x = dot(u_xlat16_1.xy, u_xlat16_1.xy);
    u_xlat16_1.x = sqrt(u_xlat16_1.x);
    u_xlat16_1.x = (-u_xlat0.x) * _LightSpeed + u_xlat16_1.x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(abs(u_xlat16_1.x)<_LightWidth);
#else
    u_xlatb0.x = abs(u_xlat16_1.x)<_LightWidth;
#endif
    u_xlat16_1 = vs_COLOR0 * _MainColor;
    u_xlat16_1 = u_xlat16_1 * vec4(vec4(_EmissionScaler, _EmissionScaler, _EmissionScaler, _EmissionScaler));
    u_xlat10_6 = texture(_LightMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_6 = u_xlat10_6 * _EmissionScaler;
    u_xlat2.xyz = vec3(u_xlat16_6) * _LightColor.xyz;
    u_xlat10_3 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat4.xyz = u_xlat10_3.xyz * u_xlat16_1.xyz + u_xlat2.xyz;
    u_xlat16_1 = u_xlat16_1 * u_xlat10_3;
    u_xlat2.xyz = u_xlat2.xyz * vec3(2.0, 2.0, 2.0) + u_xlat16_1.xyz;
    u_xlat16_5.xyz = (u_xlatb0.x) ? u_xlat4.xyz : u_xlat16_1.xyz;
    u_xlat16_23 = (-_ModeTime) * _LightSpeed + vs_TEXCOORD2.y;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(0.0>=u_xlat16_23);
#else
    u_xlatb0.x = 0.0>=u_xlat16_23;
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb12 = !!(abs(u_xlat16_23)<_LightWidth);
#else
    u_xlatb12 = abs(u_xlat16_23)<_LightWidth;
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.w = !!(u_xlat16_23>=0.0);
#else
    u_xlatb0.w = u_xlat16_23>=0.0;
#endif
    u_xlatb0.x = u_xlatb0.x && bool(u_xlatb12);
    u_xlatb0.w = u_xlatb0.w && bool(u_xlatb12);
    u_xlat16_1.xyz = (u_xlatb0.x) ? u_xlat2.xyz : u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w;
    u_xlat0.xyz = _LightColor.xyz * vec3(u_xlat16_6) + u_xlat16_1.xyz;
    u_xlat16_1.xyz = (u_xlatb0.w) ? u_xlat0.xyz : u_xlat16_1.xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseScript));
#else
    u_xlatb0.x = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseScript);
#endif
    u_xlat16_1.xyz = (u_xlatb0.x) ? u_xlat16_1.xyz : u_xlat16_5.xyz;
    SV_Target0.xyz = vs_COLOR1.www * (-u_xlat16_1.xyz) + u_xlat16_1.xyz;
    return;
}
