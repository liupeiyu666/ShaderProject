...
void main()
{
    ...
    u_xlat5.xy = in_TEXCOORD1.xy * unity_LightmapST.xy + unity_LightmapST.zw;
...
void main()
{
    ...
    u_xlat10_18 = texture(_MaskTex, u_xlat1.zw).y;
    ...
    u_xlat16_1.xyz = vec3(u_xlat10_18) * u_xlat16_2.xyz + u_xlat16_1.xyz;
    u_xlat10_2.xyz = texture(_FrontTex, vs_TEXCOORD3.xy).xyz;
    u_xlat16_2.xyz = (-u_xlat16_1.xyz) + u_xlat10_2.xyz;
    u_xlat10_18 = texture(_MaskTex, vs_TEXCOORD3.xy).x;
    u_xlat16_1.xyz = vec3(u_xlat10_18) * u_xlat16_2.xyz + u_xlat16_1.xyz;
    ...
    u_xlat16_10.xyz = u_xlat2.xyz * (-u_xlat16_10.xxx) + u_xlat0.xyz;
    u_xlat10_0.xyz = texture(_EnvTex, u_xlat16_10.xyz).xyz;
    ...
    u_xlat16_4.xyz = (-u_xlat16_0.xyz) * u_xlat16_4.xyz + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_4.xyz + u_xlat16_5.xyz;
...
#endif
    SV_Target0.xyz = u_xlat16_4.xyz * vec3(u_xlat16_19) + vs_COLOR1.xyz;
    SV_Target0.w = _BloomFactor;
    return;
}
...
void main()
{
    ...
    u_xlat5.xy = in_TEXCOORD1.xy * _PropertyLightmapTexTS.xy + _PropertyLightmapTexTS.zw;
    vs_TEXCOORD0.x = u_xlat3.z;
    vs_TEXCOORD0.y = u_xlat16_4.x;
    vs_TEXCOORD0.z = u_xlat2.y;
    vs_TEXCOORD0.w = u_xlat1.x;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat10_0.xyz * u_xlat16_4.xxx;
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(vec3(_Reflectivity, _Reflectivity, _Reflectivity)) + u_xlat16_1.xyz;
    u_xlat10_1.xyz = texture(_PropertyLightmapTex, vs_TEXCOORD4.xy).xyz;
    u_xlat16_4.xyz = u_xlat10_1.xyz * vec3(_LightMapIntensity) + _LightingColor.xyz;
    u_xlat16_5.xyz = u_xlat16_0.xyz * u_xlat16_4.xyz;
    u_xlat16_4.xyz = (-u_xlat16_0.xyz) * u_xlat16_4.xyz + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_4.xyz + u_xlat16_5.xyz;
    SV_Target0.w = _BloomFactor;
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_0.xyz * u_xlat16_4.xyz;
    u_xlat16_4.xyz = (-u_xlat16_0.xyz) * u_xlat16_4.xyz + vs_COLOR1.xyz;
    u_xlat16_4.xyz = vs_COLOR1.www * u_xlat16_4.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_19 = clamp(u_xlat16_19, 0.0, 1.0);
#endif
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(u_xlat16_19) + vs_COLOR1.xyz;
    u_xlat16_0.x = dot(u_xlat16_4.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_0.xyz = (-u_xlat16_4.xyz) + u_xlat16_0.xxx;
    u_xlat16_0.xyz = vec3(_LumiFactor) * u_xlat16_0.xyz + u_xlat16_4.xyz;
    SV_Target0.xyz = u_xlat16_0.xyz;
