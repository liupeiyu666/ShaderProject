...
void main()
{
    ...
    u_xlat0.zw = in_TEXCOORD1.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
...
void main()
{
    ...
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_0.xyz + u_xlat16_1.xyz;
    u_xlat10_2 = texture(_MainTex, vs_TEXCOORD0.xy).x;
    u_xlat10_5 = texture(_MaskTex, vs_TEXCOORD1.xy).y;
    SV_Target0.w = u_xlat10_5 * u_xlat10_2;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat1.zw = in_TEXCOORD1.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_0.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler));
    u_xlat16_0.xyz = (-u_xlat16_0.xyz) * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + vs_COLOR1.xyz;
    u_xlat16_0.xyz = vs_COLOR1.www * u_xlat16_0.xyz + u_xlat16_1.xyz;
    u_xlat16_2.x = dot(u_xlat16_0.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_2.xyz = (-u_xlat16_0.xyz) + u_xlat16_2.xxx;
    u_xlat16_2.xyz = vec3(vec3(_LumiFactor, _LumiFactor, _LumiFactor)) * u_xlat16_2.xyz + u_xlat16_0.xyz;
