...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Effects/Effect_ParticleNew/Particle_Alpha_Blended_ZTestOff_New" {
Properties {
...
void main ()
{
  lowp vec4 color_1;
  lowp vec4 tmpvar_2;
  tmpvar_2 = ((2.0 * _TintColor) * (xlv_COLOR * texture2D (_MainTex, xlv_TEXCOORD0)));
  color_1.xyz = (tmpvar_2.xyz * _EmissionScaler);
  color_1.w = clamp (tmpvar_2.w, 0.0, 1.0);
...
void main ()
{
  ...
  lowp vec4 tmpvar_6;
  tmpvar_6 = ((2.0 * _TintColor) * (xlv_COLOR * texture2D (_MainTex, xlv_TEXCOORD0)));
  color_1.xyz = (tmpvar_6.xyz * _EmissionScaler);
  color_1.w = clamp (tmpvar_6.w, 0.0, 1.0);
  gl_FragData[0] = color_1;
}
