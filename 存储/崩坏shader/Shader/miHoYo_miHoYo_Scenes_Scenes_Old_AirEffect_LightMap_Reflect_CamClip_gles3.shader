...
void main()
{
    ...
    u_xlat8 = hlslcc_mtx4x4unity_ObjectToWorld[1].y * hlslcc_mtx4x4unity_MatrixV[1].z;
    u_xlat8 = hlslcc_mtx4x4unity_MatrixV[0].z * hlslcc_mtx4x4unity_ObjectToWorld[1].x + u_xlat8;
    u_xlat8 = hlslcc_mtx4x4unity_MatrixV[2].z * hlslcc_mtx4x4unity_ObjectToWorld[1].z + u_xlat8;
    u_xlat8 = hlslcc_mtx4x4unity_MatrixV[3].z * hlslcc_mtx4x4unity_ObjectToWorld[1].w + u_xlat8;
    ...
    u_xlat24 = hlslcc_mtx4x4unity_ObjectToWorld[3].y * hlslcc_mtx4x4unity_MatrixV[1].z;
    u_xlat24 = hlslcc_mtx4x4unity_MatrixV[0].z * hlslcc_mtx4x4unity_ObjectToWorld[3].x + u_xlat24;
    u_xlat24 = hlslcc_mtx4x4unity_MatrixV[2].z * hlslcc_mtx4x4unity_ObjectToWorld[3].z + u_xlat24;
    u_xlat24 = hlslcc_mtx4x4unity_MatrixV[3].z * hlslcc_mtx4x4unity_ObjectToWorld[3].w + u_xlat24;
    ...
    u_xlat2.xy = u_xlat1.xz + (-_WorldSpaceCameraPos.xz);
    u_xlat2.xz = (-u_xlat2.xy) * vec2(vec2(_CamDistRatio, _CamDistRatio)) + u_xlat1.xz;
    ...
    u_xlat6.x = dot(u_xlat16_5.xy, u_xlat2.xz);
    u_xlat3.y = u_xlat16_5.x;
    u_xlat6.z = dot(u_xlat3.xy, u_xlat2.xz);
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    vs_TEXCOORD1.xy = in_TEXCOORD1.xy * _ShadowTex_ST.xy + _ShadowTex_ST.zw;
#ifdef UNITY_ADRENO_ES3
    u_xlatb25 = !!(0.5<_FogColorNear.w);
#else
    u_xlatb25 = 0.5<_FogColorNear.w;
#endif
    if(u_xlatb25){
        u_xlat2.xzw = u_xlat1.xyz + (-_WorldSpaceCameraPos.xyz);
        u_xlat25 = dot(u_xlat2.xzw, u_xlat2.xzw);
        u_xlat25 = sqrt(u_xlat25);
        u_xlat25 = u_xlat25 + (-_FogStartDistance);
        u_xlat25 = max(u_xlat25, 0.0);
        u_xlat2.xz = vec2(u_xlat25) * vec2(_FogIntensity, _FogColorIntensity);
        u_xlat2.xz = u_xlat2.xz * (-u_xlat2.xz);
        u_xlat2.xz = u_xlat2.xz * vec2(1.44269502, 1.44269502);
        u_xlat2.xz = exp2(u_xlat2.xz);
        u_xlat25 = (-u_xlat2.x) + 1.0;
        u_xlat25 = u_xlat25 * _FogEffectLimit;
        u_xlat25 = max(u_xlat25, _FogEffectStart);
        u_xlat3.w = min(u_xlat25, _FogEffectLimit);
        u_xlat7.xyz = _FogColorNear.xyz + (-_FogColorFar.xyz);
        u_xlat3.xyz = u_xlat2.zzz * u_xlat7.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat3;
    } else {
        ...
        u_xlat17 = (-_FogStartDistance) + _FogEndDistance;
        u_xlat17 = max(u_xlat17, 0.100000001);
        u_xlat1.xy = u_xlat1.yx / vec2(u_xlat17);
        u_xlat9.x = u_xlat1.y * _FogEffectLimit;
        u_xlat9.x = max(u_xlat9.x, _FogEffectStart);
        u_xlat3.w = min(u_xlat9.x, _FogEffectLimit);
        u_xlat1.x = u_xlat1.x;
#ifdef UNITY_ADRENO_ES3
        ...
        u_xlat3.xyz = u_xlat1.xxx * u_xlat9.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat3;
    //ENDIF
    }
    u_xlat8 = u_xlat8 * in_POSITION0.y;
    u_xlat0.x = u_xlat0.x * in_POSITION0.x + u_xlat8;
    u_xlat0.x = u_xlat16 * in_POSITION0.z + u_xlat0.x;
    u_xlat0.x = u_xlat24 * in_POSITION0.w + u_xlat0.x;
    u_xlat0.x = (-u_xlat0.x) + (-_ProjectionParams.y);
    u_xlat0.x = u_xlat0.x + (-_FadeOffset);
    u_xlat0.w = u_xlat0.x / _FadeDistance;
#ifdef UNITY_ADRENO_ES3
...
vs_TEXCOORD2 = phase0_Output0_2.xyz;
vs_TEXCOORD4 = phase0_Output0_2.w;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_0.www + vec3(1.0, 1.0, 1.0);
    u_xlat16_2.xyz = (-u_xlat10_0.www) + u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz;
    u_xlat1.xyz = u_xlat16_2.xyz * vec3(_LightMapIntensity);
    u_xlat16_2.xyz = (-u_xlat16_2.xyz) * vec3(_LightMapIntensity) + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_2.xyz + u_xlat1.xyz;
...
#endif
    SV_Target0.xyz = u_xlat1.xyz * u_xlat16_2.xxx + vs_COLOR1.xyz;
    SV_Target0.w = vs_TEXCOORD4;
#ifdef UNITY_ADRENO_ES3
    SV_Target0.w = min(max(SV_Target0.w, 0.0), 1.0);
#else
...
void main()
{
    ...
    u_xlat1.xyz = u_xlat16_2.xyz * vec3(_LightMapIntensity);
    u_xlat16_2.xyz = (-u_xlat16_2.xyz) * vec3(_LightMapIntensity) + vs_COLOR1.xyz;
    u_xlat16_2.xyz = vs_COLOR1.www * u_xlat16_2.xyz + u_xlat1.xyz;
...
void main()
{
    ...
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
#endif
    u_xlat16_2.xyz = u_xlat1.xyz * u_xlat16_2.xxx + vs_COLOR1.xyz;
    u_xlat16_1.x = dot(u_xlat16_2.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_1.xyz = (-u_xlat16_2.xyz) + u_xlat16_1.xxx;
    u_xlat16_1.xyz = vec3(_LumiFactor) * u_xlat16_1.xyz + u_xlat16_2.xyz;
    SV_Target0.xyz = u_xlat16_1.xyz;
