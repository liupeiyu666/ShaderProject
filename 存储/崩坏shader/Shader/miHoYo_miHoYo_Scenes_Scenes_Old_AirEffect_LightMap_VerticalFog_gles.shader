...
void main ()
{
  ...
  tmpvar_5 = (posInWorld_1.y / posInWorld_1.w);
  tmpvar_6 = ((_VerticalFogColor * _VerticalFogEmissionScaler) * 2.0);
...
void main ()
{
  ...
  tmpvar_7 = (_VerticalFogIntensity * max ((
    (xlv_TEXCOORD2 - _VerticalFogPlane)
   * _VerticalFogDir), 0.0));
  outColor_4.xyz = mix (outColor_4.xyz, (outColor_4.xyz + xlv_TEXCOORD3.xyz), vec3((1.0 - exp(
    (-(tmpvar_7) * tmpvar_7)
  ))));
