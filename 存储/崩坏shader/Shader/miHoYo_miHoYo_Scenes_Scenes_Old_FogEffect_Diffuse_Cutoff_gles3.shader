...
void main()
{
    ...
    if(u_xlatb8){
        ...
        u_xlat1.w = min(u_xlat8.x, _FogEffectLimit);
        u_xlat2.xyz = _FogColorNear.xyz + (-_FogColorFar.xyz);
        u_xlat1.xyz = u_xlat8.yyy * u_xlat2.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat1;
    } else {
        u_xlat1.xyz = in_POSITION0.yyy * hlslcc_mtx4x4unity_ObjectToWorld[1].xyz;
        u_xlat1.xyz = hlslcc_mtx4x4unity_ObjectToWorld[0].xyz * in_POSITION0.xxx + u_xlat1.xyz;
        ...
        u_xlat8.x = (-u_xlat8.x) + 1.0;
        u_xlat2.xyz = _FogColorNear.xyz + (-_FogColorFar.xyz);
        u_xlat1.xyz = u_xlat8.xxx * u_xlat2.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat1;
    //ENDIF
    }
#ifdef UNITY_ADRENO_ES3
    u_xlatb8 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseMiHoYoLightDir));
#else
    u_xlatb8 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseMiHoYoLightDir);
#endif
    u_xlat16_3.x = dot((-_LightDir.xyz), (-_LightDir.xyz));
    u_xlat16_3.x = inversesqrt(u_xlat16_3.x);
    u_xlat16_3.xyz = u_xlat16_3.xxx * (-_LightDir.xyz);
    u_xlat16_3.xyz = (bool(u_xlatb8)) ? (-vec3(_miHoYo_LightDir.x, _miHoYo_LightDir.y, _miHoYo_LightDir.z)) : u_xlat16_3.xyz;
    u_xlat16_3.x = dot(in_NORMAL0.xyz, u_xlat16_3.xyz);
    u_xlat8.x = u_xlat16_3.x * 0.497500002 + 0.5;
    u_xlat16_3.xyz = _LightColor.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + (-_ShadowColor.xyz);
    u_xlat16_3.xyz = u_xlat8.xxx * u_xlat16_3.xyz + _ShadowColor.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_3.xxx * (-_LightDir.xyz);
#ifdef UNITY_ADRENO_ES3
    u_xlatb12 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseMiHoYoLightDir));
#else
    u_xlatb12 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseMiHoYoLightDir);
#endif
    u_xlat16_3.xyz = (bool(u_xlatb12)) ? (-vec3(_miHoYo_LightDir.x, _miHoYo_LightDir.y, _miHoYo_LightDir.z)) : u_xlat16_3.xyz;
    u_xlat16_3.x = dot(in_NORMAL0.xyz, u_xlat16_3.xyz);
    u_xlat12 = u_xlat16_3.x * 0.497500002 + 0.5;
    u_xlat16_3.xyz = _LightColor.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + (-_ShadowColor.xyz);
    u_xlat16_3.xyz = vec3(u_xlat12) * u_xlat16_3.xyz + _ShadowColor.xyz;
    vs_COLOR0.xyz = u_xlat16_3.xyz * in_COLOR0.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_3.xxx * (-_LightDir.xyz);
#ifdef UNITY_ADRENO_ES3
    u_xlatb15 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseMiHoYoLightDir));
#else
    u_xlatb15 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseMiHoYoLightDir);
#endif
    u_xlat16_3.xyz = (bool(u_xlatb15)) ? (-vec3(_miHoYo_LightDir.x, _miHoYo_LightDir.y, _miHoYo_LightDir.z)) : u_xlat16_3.xyz;
    u_xlat16_3.x = dot(in_NORMAL0.xyz, u_xlat16_3.xyz);
    u_xlat15 = u_xlat16_3.x * 0.497500002 + 0.5;
    u_xlat16_3.xyz = _LightColor.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + (-_ShadowColor.xyz);
    u_xlat16_3.xyz = vec3(u_xlat15) * u_xlat16_3.xyz + _ShadowColor.xyz;
    vs_COLOR0.xyz = u_xlat16_3.xyz * in_COLOR0.xyz;
...
void main()
{
    ...
    if(u_xlatb15){
        ...
        u_xlat15 = u_xlat15 + (-_FogStartDistance);
        u_xlat15 = max(u_xlat15, 0.0);
        u_xlat11.xy = vec2(u_xlat15) * vec2(_FogIntensity, _FogColorIntensity);
        ...
        u_xlat15 = u_xlat15 * _FogEffectLimit;
        ...
        u_xlat2.xyz = u_xlat11.yyy * u_xlat3.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat2;
    } else {
        u_xlat2.xyz = in_POSITION0.yyy * hlslcc_mtx4x4unity_ObjectToWorld[1].xyz;
        u_xlat2.xyz = hlslcc_mtx4x4unity_ObjectToWorld[0].xyz * in_POSITION0.xxx + u_xlat2.xyz;
        ...
        u_xlat15 = max(u_xlat15, 0.0);
        u_xlat11.xy = vec2(u_xlat15) * vec2(_FogIntensity, _FogColorIntensity);
        u_xlat11.xy = u_xlat11.xy * vec2(500.0, 1000.0);
        u_xlat15 = (-_FogStartDistance) + _FogEndDistance;
        u_xlat15 = max(u_xlat15, 0.100000001);
        u_xlat11.xy = u_xlat11.yx / vec2(u_xlat15);
        u_xlat15 = u_xlat11.y * _FogEffectLimit;
        u_xlat15 = max(u_xlat15, _FogEffectStart);
        u_xlat2.w = min(u_xlat15, _FogEffectLimit);
        ...
        u_xlat15 = (-u_xlat11.x) + 1.0;
        u_xlat3.xyz = _FogColorNear.xyz + (-_FogColorFar.xyz);
        u_xlat2.xyz = vec3(u_xlat15) * u_xlat3.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat2;
    //ENDIF
    }
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_4.xyz = (bool(u_xlatb15)) ? (-vec3(_miHoYo_LightDir.x, _miHoYo_LightDir.y, _miHoYo_LightDir.z)) : u_xlat16_4.xyz;
    u_xlat16_4.x = dot(in_NORMAL0.xyz, u_xlat16_4.xyz);
    u_xlat15 = u_xlat16_4.x * 0.497500002 + 0.5;
    u_xlat16_4.xyz = _LightColor.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + (-_ShadowColor.xyz);
    u_xlat16_4.xyz = vec3(u_xlat15) * u_xlat16_4.xyz + _ShadowColor.xyz;
    vs_COLOR0.xyz = u_xlat16_4.xyz * in_COLOR0.xyz;
    u_xlat0.xyw = hlslcc_mtx4x4unity_ObjectToWorld[3].xzy * in_POSITION0.www + u_xlat0.xzy;
    u_xlat11.xy = u_xlat0.xy + (-_WorldSpaceCameraPos.xz);
    u_xlat11.x = dot(u_xlat11.xy, u_xlat11.xy);
    u_xlat11.x = sqrt(u_xlat11.x);
    u_xlat11.x = u_xlat11.x + (-_UWFogDistStart);
    u_xlat11.x = max(u_xlat11.x, 0.0);
    u_xlat11.xy = u_xlat11.xx * vec2(_UWFogDensity, _UWFogColorNFIntensity);
    u_xlat11.xy = u_xlat11.xy * (-u_xlat11.xy);
    u_xlat11.xy = u_xlat11.xy * vec2(1.44269502, 1.44269502);
    u_xlat0.xy = exp2(u_xlat11.xy);
    u_xlat0.x = (-u_xlat0.x) + 1.0;
...
void main()
{
    ...
    u_xlat3 = u_xlat2.x * _UWFogColorHLIntensity;
    ...
    u_xlat2.xzw = vec3(u_xlat3) * u_xlat2.xzw + _UWFogColorLow.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_3.xxx * (-_LightDir.xyz);
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseMiHoYoLightDir));
#else
    u_xlatb1 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UseMiHoYoLightDir);
#endif
    u_xlat16_3.xyz = (bool(u_xlatb1)) ? (-vec3(_miHoYo_LightDir.x, _miHoYo_LightDir.y, _miHoYo_LightDir.z)) : u_xlat16_3.xyz;
    u_xlat16_3.x = dot(in_NORMAL0.xyz, u_xlat16_3.xyz);
    u_xlat1.x = u_xlat16_3.x * 0.497500002 + 0.5;
    u_xlat16_3.xyz = _LightColor.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + (-_ShadowColor.xyz);
    u_xlat16_3.xyz = u_xlat1.xxx * u_xlat16_3.xyz + _ShadowColor.xyz;
    vs_COLOR0.xyz = u_xlat16_3.xyz * in_COLOR0.xyz;
    ...
    u_xlatb7 = 0.00999999978<abs(u_xlat7);
#endif
    u_xlat16_3.x = (u_xlatb7) ? u_xlat12.x : 1.0;
    ...
    u_xlat16 = u_xlat16 + 1.0;
    u_xlat16_3.x = u_xlat16 * u_xlat16_3.x;
    u_xlat16 = min(u_xlat16_3.x, _HeigtFogColBase.w);
...
void main()
{
    ...
    u_xlatb8 = 0.00999999978<abs(u_xlat8);
#endif
    u_xlat16_3.x = (u_xlatb8) ? u_xlat20 : 1.0;
    ...
    u_xlat8 = u_xlat8 + 1.0;
    u_xlat16_3.x = u_xlat8 * u_xlat16_3.x;
    u_xlat8 = min(u_xlat16_3.x, _HeigtFogColBase3.w);
