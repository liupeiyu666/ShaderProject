...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/Floor (Reflecting Light)(Second Mask)" {
Properties {
...
void main()
{
    ...
    u_xlat16_4.x = log2(u_xlat10_0.x);
    u_xlat16_4.x = u_xlat16_4.x * _SecondReflectPower;
    u_xlat16_4.x = exp2(u_xlat16_4.x);
    u_xlat10_0.x = texture(_ReflectMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_4.x = _SecondReflectIntensity * u_xlat16_4.x + (-u_xlat10_0.x);
    u_xlat16_4.x = _SecondReflectFactor * u_xlat16_4.x + u_xlat10_0.x;
    ...
    u_xlat16_7.xy = u_xlat16_7.xy * vec2(_BrushScaleX, _BrushScaleY) + u_xlat16_2.xy;
    u_xlat10_0 = texture(_ReflectionTex, u_xlat16_7.xy);
    u_xlat16_2.xyz = u_xlat10_0.xyz * vec3(_ReflectionEmissionAdjust);
    SV_Target0.w = u_xlat10_0.w * u_xlat16_1.x + _BloomFactor;
    ...
    u_xlat16_1.xyz = u_xlat16_2.xyz * vec3(_LightMapIntensity) + u_xlat16_1.xyz;
