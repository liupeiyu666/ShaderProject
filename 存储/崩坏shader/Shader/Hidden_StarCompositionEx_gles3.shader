...
void main()
{
    u_xlat10_0 = texture(_MainTex0, vs_TEXCOORD0.xy);
    ...
    u_xlat10_2 = texture(_MainTex3, vs_TEXCOORD0.xy);
    u_xlat16_1 = max(u_xlat10_1, u_xlat10_2);
    SV_Target0 = max(u_xlat16_0, u_xlat16_1);
    return;
}
