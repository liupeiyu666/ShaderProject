...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/AirEffect_SkyBox_AlphaBlend" {
Properties {
...
SubShader {
 LOD 200
 Tags { "DrawDepth" = "None" "QUEUE" = "Geometry" "RenderType" = "Transparent" }
 Pass {
  LOD 200
  Tags { "DrawDepth" = "None" "QUEUE" = "Geometry" "RenderType" = "Transparent" }
  GpuProgramID 32286
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat10_1.xyz * u_xlat16_0.xxx + vs_COLOR1.xyz;
