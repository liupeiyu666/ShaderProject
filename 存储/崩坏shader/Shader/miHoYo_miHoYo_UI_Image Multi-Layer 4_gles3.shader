...
void main()
{
    ...
    u_xlat16_2 = in_NORMAL0.x + 0.100000001;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_2 = min(max(u_xlat16_2, 0.0), 1.0);
#else
    u_xlat16_2 = clamp(u_xlat16_2, 0.0, 1.0);
#endif
    vs_COLOR0.z = ceil(u_xlat16_2);
    u_xlat16_2 = in_TANGENT0.x + 0.100000001;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_2 = min(max(u_xlat16_2, 0.0), 1.0);
#else
    u_xlat16_2 = clamp(u_xlat16_2, 0.0, 1.0);
#endif
    vs_COLOR0.w = ceil(u_xlat16_2);
    u_xlat0.xy = in_TEXCOORD0.xy;
    u_xlat0.zw = in_TEXCOORD1.xy;
    phase0_Output0_2 = u_xlat0;
    u_xlat0.xy = in_NORMAL0.xz;
    u_xlat0.zw = in_TANGENT0.xz;
...
void main()
{
    ...
    u_xlat16_1.xyz = vec3(u_xlat16_14) * u_xlat16_2.xyz + u_xlat16_1.xyz;
    u_xlat10_0 = texture(_Tex2, vs_TEXCOORD2.xy);
    u_xlat16_2.xyz = u_xlat10_0.xyz * _Color2.xyz + (-u_xlat16_1.xyz);
    u_xlat16_0.x = u_xlat10_0.w * _Color2.w;
    u_xlat16_14 = u_xlat16_0.x * vs_COLOR0.z;
    u_xlat16_3 = (-u_xlat16_0.x) * vs_COLOR0.z + 1.0;
    u_xlat16_13 = u_xlat16_13 * u_xlat16_3;
    u_xlat16_1.xyz = vec3(u_xlat16_14) * u_xlat16_2.xyz + u_xlat16_1.xyz;
    u_xlat10_0 = texture(_Tex3, vs_TEXCOORD3.xy);
    u_xlat16_2.xyz = u_xlat10_0.xyz * _Color3.xyz + (-u_xlat16_1.xyz);
    u_xlat16_0.x = u_xlat10_0.w * _Color3.w;
    u_xlat16_14 = u_xlat16_0.x * vs_COLOR0.w;
    u_xlat16_3 = (-u_xlat16_0.x) * vs_COLOR0.w + 1.0;
...
void main()
{
    ...
    u_xlat1.xy = in_NORMAL0.xz;
    u_xlat1.zw = in_TANGENT0.xz;
    phase0_Output0_3 = u_xlat1;
...
void main()
{
    ...
    u_xlat16_5.xyz = vec3(u_xlat16_4) * u_xlat16_7.xyz + u_xlat16_5.xyz;
    u_xlat10_1 = texture(_Tex2, vs_TEXCOORD2.xy);
    u_xlat16_7.xyz = u_xlat10_1.xyz * _Color2.xyz + (-u_xlat16_5.xyz);
    u_xlat16_3 = u_xlat10_1.w * _Color2.w;
    u_xlat16_4 = u_xlat16_3 * vs_COLOR0.z;
    u_xlat16_9 = (-u_xlat16_3) * vs_COLOR0.z + 1.0;
    u_xlat16_2 = u_xlat16_2 * u_xlat16_9;
    u_xlat16_5.xyz = vec3(u_xlat16_4) * u_xlat16_7.xyz + u_xlat16_5.xyz;
    u_xlat10_1 = texture(_Tex3, vs_TEXCOORD3.xy);
    u_xlat16_7.xyz = u_xlat10_1.xyz * _Color3.xyz + (-u_xlat16_5.xyz);
    u_xlat16_3 = u_xlat10_1.w * _Color3.w;
    u_xlat16_4 = u_xlat16_3 * vs_COLOR0.w;
    u_xlat16_9 = (-u_xlat16_3) * vs_COLOR0.w + 1.0;
