...
//
///////////////////////////////////////////
Shader "hidden/Scene/Floor (Reflecting Light) (without reflection)" {
Properties {
...
void main ()
{
  ...
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture2D (_ShadowTex, xlv_TEXCOORD1);
  tex_S_Color_3 = tmpvar_7;
  highp vec3 tmpvar_8;
  tmpvar_8 = (tex_C_Color_4.xyz * _Color.xyz);
  bc_2 = tmpvar_8;
  colorBlendLightMap_1 = ((bc_2 * (
...
void main ()
{
  ...
  colorBlendLightMap_1 = ((bc_2 * (
    (((2.0 * tex_S_Color_3.xyz) * tex_S_Color_3.w) + 1.0)
   - tex_S_Color_3.w)) * _LightMapIntensity);
  outColor_5.xyz = (xlv_COLOR1.xyz + (colorBlendLightMap_1 * clamp (xlv_COLOR1.w, 0.0, 1.0)));
  outColor_5.w = _BloomFactor;
  gl_FragData[0] = outColor_5;
}
