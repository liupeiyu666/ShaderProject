...
void main()
{
    ...
    u_xlat6 = _TimeScale * _Noise1_VSpeed;
    u_xlat0.y = _Time.y * u_xlat6 + vs_TEXCOORD0.y;
    u_xlat10_0.x = texture(_NoiseTex01, u_xlat0.xy).x;
    u_xlat0.x = u_xlat10_0.x * _NoiseTex01Brightness + (-_NoiseTex01BrightnessAdd);
    u_xlat10_3 = texture(_ShapeTexture, vs_TEXCOORD0.xy).z;
    u_xlat3.x = u_xlat10_3 * _ShapeBlueBrightness;
    u_xlat0.x = u_xlat0.x * u_xlat3.x;
    u_xlat0.y = vs_TEXCOORD0.y * _VcoordMultiplier + (-u_xlat0.x);
    u_xlat6 = u_xlat0.y * _OpacityIntensity;
    u_xlat0.x = vs_TEXCOORD0.x;
    u_xlat10_0.xyw = texture(_ShapeTexture, u_xlat0.xy).xyw;
    u_xlat3.x = u_xlat6 * u_xlat10_0.y;
...
#endif
    u_xlat6 = (-vs_COLOR0.w) + _GrassFireBurnOut;
    u_xlat6 = u_xlat6 + 1.0;
...
void main()
{
    ...
    u_xlat6 = _TimeScale * _Noise1_VSpeed;
    u_xlat0.y = _Time.y * u_xlat6 + vs_TEXCOORD0.y;
    u_xlat10_0.x = texture(_NoiseTex01, u_xlat0.xy).y;
    u_xlat0.x = u_xlat10_0.x * _NoiseTex01Brightness + (-_NoiseTex01BrightnessAdd);
    u_xlat10_3 = texture(_ShapeTexture, vs_TEXCOORD0.xy).z;
    u_xlat3.x = u_xlat10_3 * _ShapeBlueBrightness;
    u_xlat0.x = u_xlat0.x * u_xlat3.x;
...
void main()
{
    ...
    u_xlat6 = _TimeScale * _Noise1_VSpeed;
    u_xlat0.y = _Time.y * u_xlat6 + vs_TEXCOORD0.y;
    u_xlat10_0.x = texture(_NoiseTex01, u_xlat0.xy).z;
    u_xlat0.x = u_xlat10_0.x * _NoiseTex01Brightness + (-_NoiseTex01BrightnessAdd);
    u_xlat10_3 = texture(_ShapeTexture, vs_TEXCOORD0.xy).z;
    u_xlat3.x = u_xlat10_3 * _ShapeBlueBrightness;
    u_xlat0.x = u_xlat0.x * u_xlat3.x;
...
void main()
{
    ...
    u_xlat6 = _TimeScale * _Noise1_VSpeed;
    u_xlat0.y = _Time.y * u_xlat6 + vs_TEXCOORD0.y;
    u_xlat10_0.x = texture(_NoiseTex01, u_xlat0.xy).w;
    u_xlat0.x = u_xlat10_0.x * _NoiseTex01Brightness + (-_NoiseTex01BrightnessAdd);
    u_xlat10_3 = texture(_ShapeTexture, vs_TEXCOORD0.xy).z;
    u_xlat3.x = u_xlat10_3 * _ShapeBlueBrightness;
    u_xlat0.x = u_xlat0.x * u_xlat3.x;
