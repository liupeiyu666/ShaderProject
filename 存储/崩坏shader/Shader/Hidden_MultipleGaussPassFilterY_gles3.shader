...
void main()
{
    u_xlat0 = _scalerY.xyxy * vec4(-0.0159309991, -0.0159309991, -0.00269700005, -0.00269700005) + vs_TEXCOORD0.xyxy;
    ...
    u_xlat1 = _scalerY.xyxy * vec4(0.0088109998, 0.0088109998, 0.0234379992, 0.0234379992) + vs_TEXCOORD0.xyxy;
...
void main()
{
    u_xlat0 = _scalerY.xyxy * vec4(-0.0796450004, -0.0796450004, -0.049922999, -0.049922999) + vs_TEXCOORD0.xyxy;
    u_xlat10_1 = texture(_MainTex, u_xlat0.zw);
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(-0.0211350005, -0.0211350005, 0.00702399993, 0.00702399993) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(0.0354139991, 0.0354139991, 0.0646739975, 0.0646739975) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1.xy = _scalerY.xy * vec2(0.09375, 0.09375) + vs_TEXCOORD0.xy;
...
void main()
{
    u_xlat0 = _scalerY.xyxy * vec4(-0.254662991, -0.254662991, -0.194030002, -0.194030002) + vs_TEXCOORD0.xyxy;
    u_xlat10_1 = texture(_MainTex, u_xlat0.zw);
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(-0.133894995, -0.133894995, -0.074210003, -0.074210003) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(-0.0148259997, -0.0148259997, 0.0444939993, 0.0444939993) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(0.104002997, 0.104002997, 0.163901001, 0.163901001) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(0.224285007, 0.224285007, 0.28125, 0.28125) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
...
void main()
{
    u_xlat0 = _scalerY.xyxy * vec4(-0.954254985, -0.954254985, -0.830891013, -0.830891013) + vs_TEXCOORD0.xyxy;
    u_xlat10_1 = texture(_MainTex, u_xlat0.zw);
    u_xlat10_0 = texture(_MainTex, u_xlat0.xy);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(-0.707616985, -0.707616985, -0.584424019, -0.584424019) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(-0.461302012, -0.461302012, -0.338239014, -0.338239014) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(-0.215221003, -0.215221003, -0.0922319964, -0.0922319964) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(0.0307439994, 0.0307439994, 0.153724, 0.153724) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(0.276726007, 0.276726007, 0.399764001, 0.399764001) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(0.522854984, 0.522854984, 0.646010995, 0.646010995) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1 = _scalerY.xyxy * vec4(0.769243002, 0.769243002, 0.892561018, 0.892561018) + vs_TEXCOORD0.xyxy;
    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
    u_xlat10_1 = texture(_MainTex, u_xlat1.zw);
    ...
    u_xlat1.xy = vs_TEXCOORD0.xy + _scalerY.xy;
    u_xlat10_1 = texture(_MainTex, u_xlat1.xy);
