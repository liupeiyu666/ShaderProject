...
void main()
{
    ...
    u_xlat16_1.xyz = (-u_xlat16_1.xyz) * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) + vs_COLOR1.xyz;
...
#endif
    u_xlat16_1.xyz = u_xlat16_1.xyz * vs_COLOR0.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler));
