...
uniform 	vec4 _FringeBumpTex_ST;
uniform 	mediump float _Opaqueness;
uniform 	mediump float _OpaquenessScalerWithoutHDR;
uniform 	float _FringeViewDistance;
...
void main()
{
    ...
    vs_TEXCOORD0.zw = in_TEXCOORD0.xy * _FringeBumpTex_ST.xy + _FringeBumpTex_ST.zw;
    ...
    u_xlat1.xyz = u_xlat2.xyz * vec3(_FringeViewDistance) + u_xlat1.xyz;
...
uniform 	float _FringeIntensity;
uniform 	float _FringeBumpScaler;
uniform 	float _FringeRangeScaler;
uniform 	float _FringeRangeOffset;
uniform 	mediump vec4 _FringeFresnel;
uniform 	float _UsingDitherAlpha;
uniform lowp sampler2D _MainTex;
uniform lowp sampler2D _FringeBumpTex;
uniform lowp sampler2D _FringeTex;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture(_FringeBumpTex, vs_TEXCOORD0.zw).xyz;
    u_xlat0.xyz = u_xlat10_0.xyz + vec3(-0.5, -0.5, -0.0);
    u_xlat0.xy = u_xlat0.xy * vec2(vec2(_FringeBumpScaler, _FringeBumpScaler));
    u_xlat15 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat15 = inversesqrt(u_xlat15);
    u_xlat1.xyz = vec3(u_xlat15) * u_xlat0.xyz;
    u_xlat4.xyz = u_xlat1.yyy * vs_TEXCOORD3.xyz;
    u_xlat1.xyw = vs_TEXCOORD2.xyz * u_xlat1.xxx + u_xlat4.xyz;
    ...
    u_xlat10 = u_xlat10 * _FringeRangeScaler + _FringeRangeOffset;
    u_xlat0.x = -abs(u_xlat0.x) + 1.0;
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlat0.x = log2(u_xlat0.x);
    u_xlat0.x = u_xlat0.x * _FringeFresnel.x;
    u_xlat0.x = exp2(u_xlat0.x);
    u_xlat0.x = u_xlat0.x * _FringeFresnel.y + _FringeFresnel.z;
    u_xlat10_1.xyz = texture(_FringeTex, vec2(u_xlat10)).xyz;
    u_xlat1.xyz = u_xlat10_1.xyz * vec3(_FringeIntensity);
    u_xlat1.xyz = u_xlat0.xxx * u_xlat1.xyz;
    u_xlat5 = u_xlat0.y * u_xlat15 + 0.5;
    u_xlat1.xyz = vec3(u_xlat5) * u_xlat1.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _EnvColor.xyz + u_xlat1.xyz;
    u_xlat16_2.xyz = (-u_xlat16_3.xyz) * u_xlat1.xyz + u_xlat16_2.xyz;
    ...
    u_xlat0.x = u_xlat5 * u_xlat16_2.x;
    u_xlat0.x = u_xlat0.x * 3.0;
    u_xlat0.x = min(u_xlat0.x, 1.0);
    SV_Target0.w = max(u_xlat0.x, _MinAlpha);
#ifdef UNITY_ADRENO_ES3
