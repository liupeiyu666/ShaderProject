...
void main()
{
    ...
    u_xlat16_1.xy = u_xlat0.xy * vec2(5.0, 5.0);
    u_xlat16_5 = max(vs_TEXCOORD4.z, 0.00999999978);
    u_xlat16_5 = u_xlat16_5 * u_xlat16_5;
    u_xlat16_1.xy = u_xlat16_1.xy / vec2(u_xlat16_5);
    u_xlat0.xy = (-u_xlat16_1.xy) + vs_TEXCOORD2.xy;
    u_xlat10_0.xyz = texture(_CausticMap, u_xlat0.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * vec3(vec3(_Caustic, _Caustic, _Caustic)) + _RefractionColor.xyz;
    u_xlat16_1.xyz = (-u_xlat16_0.xyz) + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_1.xyz + u_xlat16_0.xyz;
    SV_Target0.w = vs_TEXCOORD4.z;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat12 = inversesqrt(u_xlat12);
    u_xlat2.xyz = vec3(u_xlat12) * in_NORMAL0.xyz;
    u_xlat16_3 = dot(u_xlat1.xyz, u_xlat2.xyz);
    u_xlat16_3 = (-u_xlat16_3) + 1.0;
    u_xlat16_3 = max(u_xlat16_3, 0.00100000005);
    u_xlat16_3 = min(u_xlat16_3, 1.0);
...
void main()
{
    ...
    u_xlat15 = inversesqrt(u_xlat15);
    u_xlat2.xyz = vec3(u_xlat15) * in_NORMAL0.xyz;
    u_xlat16_3 = dot(u_xlat1.xyz, u_xlat2.xyz);
    u_xlat16_3 = (-u_xlat16_3) + 1.0;
    u_xlat16_3 = max(u_xlat16_3, 0.00100000005);
    u_xlat16_3 = min(u_xlat16_3, 1.0);
...
void main()
{
    ...
    u_xlat9 = vs_TEXCOORD4.z * vs_TEXCOORD4.z;
    u_xlat9 = u_xlat9 * u_xlat9;
    u_xlat9 = u_xlat9 * vs_TEXCOORD4.x;
    u_xlat0.xyz = vec3(u_xlat9) * u_xlat16_0.xyz + _RefractionColor.xyz;
    u_xlat16_7 = max(vs_TEXCOORD4.z, 0.00999999978);
    u_xlat16_7 = u_xlat16_7 * u_xlat16_7;
    u_xlat16_1.xy = u_xlat16_1.xy / vec2(u_xlat16_7);
    u_xlat2.xy = (-u_xlat16_1.xy) + vs_TEXCOORD2.xy;
    u_xlat10_2.xyz = texture(_CausticMap, u_xlat2.xy).xyz;
    u_xlat0.xyz = u_xlat10_2.xyz * vec3(vec3(_Caustic, _Caustic, _Caustic)) + u_xlat0.xyz;
