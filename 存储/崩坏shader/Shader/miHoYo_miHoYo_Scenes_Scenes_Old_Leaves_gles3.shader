...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/Leaves" {
Properties {
...
void main()
{
    ...
    u_xlat0.xyz = (-_miHoYo_CameraRight.xyz) * in_TEXCOORD1.xxx + u_xlat0.xyz;
    u_xlat2.x = u_xlat0.y + in_TEXCOORD1.y;
...
void main()
{
    ...
    u_xlat0 = u_xlat0 / u_xlat0.wwww;
    u_xlat0.xyz = (-_miHoYo_CameraRight.xyz) * in_TEXCOORD1.xxx + u_xlat0.xyz;
    u_xlat4 = u_xlat0.y + in_TEXCOORD1.y;
    u_xlat1 = vec4(u_xlat4) * hlslcc_mtx4x4unity_MatrixVP[1];
    u_xlat1 = hlslcc_mtx4x4unity_MatrixVP[0] * u_xlat0.xxxx + u_xlat1;
    u_xlat1 = hlslcc_mtx4x4unity_MatrixVP[2] * u_xlat0.zzzz + u_xlat1;
    gl_Position = hlslcc_mtx4x4unity_MatrixVP[3] * u_xlat0.wwww + u_xlat1;
    u_xlat0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
...
void main()
{
    ...
    u_xlat0 = u_xlat0 / u_xlat0.wwww;
    u_xlat0.xyz = (-_miHoYo_CameraRight.xyz) * in_TEXCOORD1.xxx + u_xlat0.xyz;
    u_xlat5.x = u_xlat0.y + in_TEXCOORD1.y;
    u_xlat1 = u_xlat5.xxxx * hlslcc_mtx4x4unity_MatrixVP[1];
    u_xlat1 = hlslcc_mtx4x4unity_MatrixVP[0] * u_xlat0.xxxx + u_xlat1;
    u_xlat1 = hlslcc_mtx4x4unity_MatrixVP[2] * u_xlat0.zzzz + u_xlat1;
    gl_Position = hlslcc_mtx4x4unity_MatrixVP[3] * u_xlat0.wwww + u_xlat1;
    u_xlat0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
