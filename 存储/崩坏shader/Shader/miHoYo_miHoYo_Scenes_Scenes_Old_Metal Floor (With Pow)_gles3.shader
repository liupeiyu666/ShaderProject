...
void main()
{
    ...
    if(u_xlatb24){
        ...
        u_xlat5.w = min(u_xlat24, _FogEffectLimit);
        u_xlat6.xyz = _FogColorNear.xyz + (-_FogColorFar.xyz);
        u_xlat5.xyz = u_xlat18.yyy * u_xlat6.xyz + _FogColorFar.xyz;
        u_xlat16_5 = u_xlat5;
    } else {
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat10_0.xyz * u_xlat10_0.www;
    ...
    u_xlat1.xyz = u_xlat0.xyz * vec3(_LightMapIntensity);
    u_xlat16_2.xyz = (-u_xlat0.xyz) * vec3(_LightMapIntensity) + vs_COLOR1.xyz;
...
void main()
{
    ...
    u_xlat1.xyz = u_xlat10_1.xyz * _Color.xyz;
    u_xlat0.xyz = u_xlat16_0.xyz * u_xlat1.xyz;
    u_xlat0.xyz = u_xlat0.xyz * vec3(_LightMapIntensity);
...
void main()
{
    ...
    u_xlat16_5.xy = vs_TEXCOORD2.xy / vs_TEXCOORD2.ww;
    u_xlat0.xy = u_xlat16_0.xy * vec2(_BrushScaleX, _BrushScaleY) + u_xlat16_5.xy;
    u_xlat10_0 = texture(_ReflectionTex, u_xlat0.xy);
    u_xlat0 = max(u_xlat10_0, vec4(0.0, 0.0, 0.0, 0.0));
    u_xlat2.xyz = u_xlat0.xyz * u_xlat0.xyz;
    u_xlat2.xyz = u_xlat2.xyz * vec3(_ReflectionEmissionAdjust);
    u_xlat10_3 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat0.xyz = u_xlat2.xyz * u_xlat10_3.www;
    u_xlat2.xyz = u_xlat10_3.xyz * _Color.xyz;
    u_xlat10_3 = texture(_ShadowTex, vs_TEXCOORD5.xy);
    u_xlat16_3.xyz = u_xlat10_3.xyz * u_xlat10_3.www;
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(2.0, 2.0, 2.0) + vec3(1.0, 1.0, 1.0);
    u_xlat16_3.xyz = (-u_xlat10_3.www) + u_xlat16_3.xyz;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat16_3.xyz;
    u_xlat2.xyz = u_xlat2.xyz * vec3(_LightMapIntensity);
    u_xlat2.w = _BloomFactor;
    u_xlat0 = u_xlat0 + (-u_xlat2);
    u_xlat0 = u_xlat16_1.xxxx * u_xlat0 + u_xlat2;
...
void main()
{
    ...
    SV_Target0.xyz = vec3(_LumiFactor) * u_xlat16_0.xyz + u_xlat16_2.xyz;
    SV_Target0.w = _BloomFactor;
    return;
}
...
void main()
{
    ...
    SV_Target0.xyz = vec3(_LumiFactor) * u_xlat16_0.xyz + u_xlat16_1.xyz;
    return;
}
