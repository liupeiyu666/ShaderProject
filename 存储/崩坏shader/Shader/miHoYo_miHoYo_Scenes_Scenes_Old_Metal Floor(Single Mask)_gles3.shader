...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/Metal Floor(Single Mask)" {
Properties {
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_5.xyz * vec3(_LightMapIntensity);
    u_xlat10_2.xy = texture(_BrushedNormalMap, vs_TEXCOORD1.xy).xy;
    u_xlat16_5.xy = u_xlat10_2.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat16_3.xy = vs_TEXCOORD2.xy / vs_TEXCOORD2.ww;
    u_xlat16_5.xy = u_xlat16_5.xy * vec2(_BrushScaleX, _BrushScaleY) + u_xlat16_3.xy;
    u_xlat10_2 = texture(_ReflectionTex, u_xlat16_5.xy);
    u_xlat16_5.xyz = u_xlat10_2.xyz * vec3(_ReflectionEmissionAdjust);
    u_xlat10_2.x = texture(_ReflectMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_3.xyz = u_xlat16_5.xyz * u_xlat10_2.xxx + (-u_xlat0.xyz);
...
void main()
{
    ...
    SV_Target0.w = u_xlat16_0.w;
    u_xlat16_2.x = dot(u_xlat16_1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
