...
void main()
{
    ...
    vs_COLOR1 = u_xlat1;
    vs_TEXCOORD1.xyz = in_Color0.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    vs_TEXCOORD2 = in_Color0.w * _Opaqueness;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat16_1.x + (-vs_TEXCOORD1.y);
    u_xlat16_5.x = (-u_xlat16_1.x) + 1.0;
    u_xlat16_5.x = floor(u_xlat16_5.x);
    u_xlat16_5.x = max(u_xlat16_5.x, 0.0);
    u_xlati0 = int(u_xlat16_5.x);
    u_xlat16_2.xyz = (int(u_xlati0) != 0) ? _ShadowColor.xyz : _LightColor.xyz;
    u_xlat16_5.x = (u_xlati0 != 0) ? (-_ShadowIntensity) : _LightIntensity;
    u_xlat16_2.w = u_xlat16_5.x * u_xlat16_1.x;
    u_xlat10_0.x = texture(_ColorMask, vs_TEXCOORD0.xy).x;
    u_xlat16_1 = (-u_xlat16_2) + _Color;
    u_xlat16_0 = u_xlat10_0.xxxx * u_xlat16_1 + u_xlat16_2;
    u_xlat16_1.x = u_xlat16_0.w * vs_TEXCOORD2;
    u_xlat16_5.x = u_xlat16_0.w * vs_TEXCOORD2 + 0.99000001;
    u_xlat16_5.x = floor(u_xlat16_5.x);
    u_xlat16_5.x = max(u_xlat16_5.x, 0.0);
    u_xlati3 = int(u_xlat16_5.x);
    if((u_xlati3)==0){discard;}
    u_xlat16_5.xyz = (-u_xlat16_0.xyz) + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_5.xyz + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = (int(u_xlati0) != 0) ? _ShadowColor.xyz : _LightColor.xyz;
    u_xlat16_5 = (u_xlati0 != 0) ? (-_ShadowIntensity) : _LightIntensity;
    u_xlat16_2.w = u_xlat16_5 * u_xlat16_1.x;
    u_xlat10_0.x = texture(_ColorMask, vs_TEXCOORD0.xy).x;
    u_xlat16_1 = (-u_xlat16_2) + _Color;
    u_xlat16_0 = u_xlat10_0.xxxx * u_xlat16_1 + u_xlat16_2;
    u_xlat16_1.x = u_xlat16_0.w * vs_TEXCOORD2;
    u_xlat16_5 = u_xlat16_0.w * vs_TEXCOORD2 + 0.99000001;
    u_xlat16_5 = floor(u_xlat16_5);
    u_xlat16_5 = max(u_xlat16_5, 0.0);
    u_xlati3 = int(u_xlat16_5);
    if((u_xlati3)==0){discard;}
    u_xlat16_5 = vs_COLOR1.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_5 = min(max(u_xlat16_5, 0.0), 1.0);
#else
    u_xlat16_5 = clamp(u_xlat16_5, 0.0, 1.0);
#endif
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(u_xlat16_5) + vs_COLOR1.xyz;
    SV_Target0.w = u_xlat16_1.x;
#ifdef UNITY_ADRENO_ES3
    SV_Target0.w = min(max(SV_Target0.w, 0.0), 1.0);
#else
