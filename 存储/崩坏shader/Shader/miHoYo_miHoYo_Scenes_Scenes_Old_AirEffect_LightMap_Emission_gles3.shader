...
void main()
{
    ...
    u_xlat16_1.xyz = vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler)) * u_xlat0.xyz + (-u_xlat0.xyz);
    u_xlat16_1.xyz = u_xlat10_0.www * u_xlat16_1.xyz + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlatb6 = 0.99000001<vs_TEXCOORD2.y;
#endif
    u_xlat16_1.x = (u_xlatb6) ? u_xlat3.x : vs_TEXCOORD2.y;
