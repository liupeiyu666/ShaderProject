...
void main ()
{
  ...
  lowp vec3 tmpvar_21;
  tmpvar_21 = (texture2D (_MaskTex, tmpvar_20).xyz + 0.1);
  aseOutColor_4 = tmpvar_21;
  if (_CutOffFlip) {
    mediump float tmpvar_22;
    tmpvar_22 = (aseOutColor_4 - _Cutoff).x;
    if ((tmpvar_22 < 0.0)) {
      discard;
    };
  } else {
    mediump float tmpvar_23;
    tmpvar_23 = (_Cutoff - aseOutColor_4).x;
    if ((tmpvar_23 < 0.0)) {
      discard;
    };
  };
  ...
  tmpvar_24.w = 1.0;
  tmpvar_24.xyz = ((aseOutColor_4 * _Intensity) * _Color0.xyz);
