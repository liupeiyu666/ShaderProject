...
void main ()
{
  ...
  lowp vec4 tmpvar_9;
  tmpvar_9 = texture2D (_ShadowTex, xlv_TEXCOORD5);
  ...
  tmpvar_12 = (bias_15 + max (0.0, (
    pow (clamp ((1.0 - dot (I_3, xlv_TEXCOORD4)), 0.001, 1.0), power_13)
   * scale_14)));
  lowp vec2 tmpvar_16;
  tmpvar_16 = texture2D (_BrushedNormalMap, xlv_TEXCOORD1).xy;
  brushedValue_2 = tmpvar_16;
  brushedValue_2 = ((brushedValue_2 * 2.0) - 1.0);
  highp vec2 tmpvar_17;
  tmpvar_17.x = _BrushScaleX;
  tmpvar_17.y = _BrushScaleY;
  brushedValue_2 = (brushedValue_2 * tmpvar_17);
  mediump vec3 tmpvar_18;
  tmpvar_18 = normalize(xlv_TEXCOORD4);
  mediump vec3 I_19;
  I_19 = -(I_3);
  mediump vec3 tmpvar_20;
  tmpvar_20.xy = brushedValue_2;
  tmpvar_20.z = ((brushedValue_2.x + brushedValue_2.y) / 2.0);
  ...
  reflColor_1.xyz = ((reflColor_1.xyz * reflColor_1.xyz) * _ReflectionEmissionAdjust);
  reflColor_1.xyz = (reflColor_1.xyz * baseTexColor_6.w);
  highp vec4 tmpvar_23;
  tmpvar_23.xyz = diffColor_4;
  tmpvar_23.w = _BloomFactor;
  highp vec4 tmpvar_24;
  tmpvar_24 = mix (tmpvar_23, reflColor_1, vec4(tmpvar_12));
  outColor_7 = tmpvar_24;
