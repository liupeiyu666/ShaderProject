...
void main()
{
    u_xlat16_0.x = texture(unity_Lightmap, vs_TEXCOORD0.zw).x;
    u_xlat16_1.x = u_xlat16_0.x + _RampStep;
    u_xlat16_1.x = u_xlat16_1.x * _RampScale;
    u_xlat16_1.y = 0.5;
    u_xlat10_0.xyz = texture(_RampTex, u_xlat16_1.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * _ShadowColor.xyz;
...
void main()
{
...
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(0.5<_ReceiveDynamicShadow);
#else
    u_xlatb1 = 0.5<_ReceiveDynamicShadow;
#endif
    if(u_xlatb1){
        u_xlat1.xy = vs_TEXCOORD3.xy / vs_TEXCOORD3.ww;
        u_xlat10_1.x = texture(_DynamicSceneShadowVolumeBuffer, u_xlat1.xy).x;
        u_xlat16_2.x = u_xlat10_1.x;
    } else {
        u_xlat16_2.x = 1.0;
    //ENDIF
    }
    u_xlat16_6.x = u_xlat16_0.x + _RampStep;
    u_xlat16_3.x = u_xlat16_6.x * _RampScale;
    u_xlat16_3.y = 0.5;
    u_xlat10_1.xyz = texture(_RampTex, u_xlat16_3.xy).xyz;
    u_xlat16_1.xyz = u_xlat10_1.xyz * _ShadowColor.xyz;
    u_xlat16_6.x = u_xlat16_0.x + (-_ShadowIntegration);
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_2.xyz = u_xlat16_6.xyz * u_xlat16_2.xxx + vec3(1.0, 1.0, 1.0);
    u_xlat16_2.xyz = u_xlat10_4.xyz * u_xlat16_2.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz * vec3(vec3(_LightMapIntensity, _LightMapIntensity, _LightMapIntensity));
