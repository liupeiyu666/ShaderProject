...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Character/Character_Simple/Simple_Emission_Elite" {
Properties {
...
SubShader {
 Tags { "Distortion" = "None" "DrawDepth" = "FrontFace" "IGNOREPROJECTOR" = "true" "OutlineType" = "Simple" "QUEUE" = "Transparent" "RenderType" = "Opaque" }
 Pass {
  Tags { "Distortion" = "None" "DrawDepth" = "FrontFace" "IGNOREPROJECTOR" = "true" "OutlineType" = "Simple" "QUEUE" = "Transparent" "RenderType" = "Opaque" }
  Offset 2, 2
  GpuProgramID 54100
...
uniform 	mediump float _EliteNormalDisplacement3;
...
void main()
{
    ...
    u_xlat0.xy = u_xlat16_3.xy * vec2(vec2(_EliteNormalDisplacement3, _EliteNormalDisplacement3)) + u_xlat0.xy;
...
uniform 	mediump vec4 _EliteColor3;
uniform 	mediump float _EliteEmissionScaler3;
...
void main()
{
    ...
    u_xlatb0 = !!(vs_TEXCOORD1.z<0.949999988);
#else
    u_xlatb0 = vs_TEXCOORD1.z<0.949999988;
#endif
    if(u_xlatb0){
        ...
        u_xlat0.x = vs_TEXCOORD1.z * 17.0 + (-u_xlat0.x);
    ...
    u_xlat16_2.x = _EliteEmissionScaler3;
    u_xlat16_2.w = vs_TEXCOORD0;
    u_xlat16_0 = u_xlat16_2.xxxw * _EliteColor3;
...
uniform 	vec4 hlslcc_mtx4x4glstate_matrix_projection[4];
uniform 	vec4 hlslcc_mtx4x4unity_MatrixV[4];
uniform 	mediump float _EliteNormalDisplacement2;
uniform 	float _DitherAlpha;
in highp vec4 in_POSITION0;
in highp vec3 in_NORMAL0;
out mediump float vs_TEXCOORD0;
...
void main()
{
    ...
    u_xlat0 = u_xlat1 * in_POSITION0.wwww + u_xlat0;
    u_xlat0 = u_xlat0 / u_xlat0.wwww;
    u_xlat0.xy = u_xlat16_3.xy * vec2(_EliteNormalDisplacement2) + u_xlat0.xy;
    u_xlat1 = u_xlat0.yyyy * hlslcc_mtx4x4glstate_matrix_projection[1];
    u_xlat1 = hlslcc_mtx4x4glstate_matrix_projection[0] * u_xlat0.xxxx + u_xlat1;
    u_xlat1 = hlslcc_mtx4x4glstate_matrix_projection[2] * u_xlat0.zzzz + u_xlat1;
    u_xlat0 = hlslcc_mtx4x4glstate_matrix_projection[3] * u_xlat0.wwww + u_xlat1;
...
uniform 	vec4 _ScreenParams;
uniform 	vec4 hlslcc_mtx4x4_DITHERMATRIX[4];
uniform 	mediump vec4 _EliteColor2;
uniform 	mediump float _EliteEmissionScaler2;
in mediump float vs_TEXCOORD0;
in highp vec4 vs_TEXCOORD1;
layout(location = 0) out mediump vec4 SV_Target0;
vec2 u_xlat0;
...
void main()
{
    ...
    u_xlat16_2.x = _EliteEmissionScaler2;
    u_xlat16_2.w = vs_TEXCOORD0;
    u_xlat16_0 = u_xlat16_2.xxxw * _EliteColor2;
    SV_Target0.w = u_xlat16_0.w;
#ifdef UNITY_ADRENO_ES3
    SV_Target0.w = min(max(SV_Target0.w, 0.0), 1.0);
#else
...
uniform 	vec4 hlslcc_mtx4x4glstate_matrix_projection[4];
uniform 	vec4 hlslcc_mtx4x4unity_MatrixV[4];
uniform 	mediump float _EliteNormalDisplacement1;
uniform 	float _DitherAlpha;
in highp vec4 in_POSITION0;
in highp vec3 in_NORMAL0;
out mediump float vs_TEXCOORD0;
...
void main()
{
    ...
    u_xlat0 = u_xlat1 * in_POSITION0.wwww + u_xlat0;
    u_xlat0 = u_xlat0 / u_xlat0.wwww;
    u_xlat0.xy = u_xlat16_3.xy * vec2(vec2(_EliteNormalDisplacement1, _EliteNormalDisplacement1)) + u_xlat0.xy;
    u_xlat1 = u_xlat0.yyyy * hlslcc_mtx4x4glstate_matrix_projection[1];
    u_xlat1 = hlslcc_mtx4x4glstate_matrix_projection[0] * u_xlat0.xxxx + u_xlat1;
    u_xlat1 = hlslcc_mtx4x4glstate_matrix_projection[2] * u_xlat0.zzzz + u_xlat1;
    u_xlat0 = hlslcc_mtx4x4glstate_matrix_projection[3] * u_xlat0.wwww + u_xlat1;
...
uniform 	vec4 _ScreenParams;
uniform 	vec4 hlslcc_mtx4x4_DITHERMATRIX[4];
uniform 	mediump vec4 _EliteColor1;
uniform 	mediump float _EliteEmissionScaler1;
in mediump float vs_TEXCOORD0;
in highp vec4 vs_TEXCOORD1;
layout(location = 0) out mediump vec4 SV_Target0;
vec2 u_xlat0;
...
void main()
{
    ...
    u_xlat16_2.x = _EliteEmissionScaler1;
    u_xlat16_2.w = vs_TEXCOORD0;
    u_xlat16_0 = u_xlat16_2.xxxw * _EliteColor1;
    SV_Target0.w = u_xlat16_0.w;
#ifdef UNITY_ADRENO_ES3
    SV_Target0.w = min(max(SV_Target0.w, 0.0), 1.0);
#else
...
""
 ...
 Pass {
  Name "BASE"
  Tags { "Distortion" = "None" "DrawDepth" = "FrontFace" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "OutlineType" = "Simple" "QUEUE" = "Transparent" "RenderType" = "Opaque" }
  GpuProgramID 293954
Program "vp" {
SubProgram "gles3 hw_tier00 " {
"#ifdef VERTEX
...
precision highp int;
uniform 	mediump float _EliteBloomFactor;
in mediump float vs_TEXCOORD0;
layout(location = 0) out mediump vec4 SV_Target0;
void main()
{
    SV_Target0.w = vs_TEXCOORD0 * _EliteBloomFactor;
