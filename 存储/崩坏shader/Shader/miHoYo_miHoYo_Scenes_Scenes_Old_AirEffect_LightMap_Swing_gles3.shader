...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x + _miHoYo_WindParams3.x;
    u_xlat0.x = sin(u_xlat0.x);
    u_xlat0.x = u_xlat0.x * _ObjectMoveScale;
    u_xlat3.x = (-u_xlat0.x) * u_xlat0.x + 1.0;
    u_xlat3.x = sqrt(u_xlat3.x);
    u_xlat1.xyz = in_POSITION0.xyz + (-_ObjPivot.xyz);
    u_xlat3.xy = u_xlat3.xx * u_xlat1.xy;
    u_xlat2.x = u_xlat0.x * u_xlat1.y + u_xlat3.x;
    u_xlat2.y = (-u_xlat0.x) * u_xlat1.x + u_xlat3.y;
    u_xlat2.z = u_xlat1.z;
    u_xlat0.xyz = u_xlat2.xyz + _ObjPivot.xyz;
...
void main()
{
    ...
    u_xlat0.x = sin(u_xlat0.x);
    u_xlat0.x = u_xlat0.x * _ObjectMoveScale;
    u_xlat4.x = (-u_xlat0.x) * u_xlat0.x + 1.0;
    u_xlat4.x = sqrt(u_xlat4.x);
    u_xlat1.xyz = in_POSITION0.xyz + (-_ObjPivot.xyz);
    u_xlat4.xy = u_xlat4.xx * u_xlat1.xy;
    u_xlat2.x = u_xlat0.x * u_xlat1.y + u_xlat4.x;
    u_xlat2.y = (-u_xlat0.x) * u_xlat1.x + u_xlat4.y;
    u_xlat2.z = u_xlat1.z;
    u_xlat0.xyz = u_xlat2.xyz + _ObjPivot.xyz;
    u_xlat1 = u_xlat0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
    u_xlat1 = hlslcc_mtx4x4unity_ObjectToWorld[0] * u_xlat0.xxxx + u_xlat1;
...
void main()
{
    ...
    u_xlat2.x = u_xlat0.x * u_xlat1.y + u_xlat5.x;
    u_xlat2.y = (-u_xlat0.x) * u_xlat1.x + u_xlat5.y;
    u_xlat2.z = u_xlat1.z;
    u_xlat0.xyz = u_xlat2.xyz + _ObjPivot.xyz;
    u_xlat1 = u_xlat0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
    u_xlat1 = hlslcc_mtx4x4unity_ObjectToWorld[0] * u_xlat0.xxxx + u_xlat1;
