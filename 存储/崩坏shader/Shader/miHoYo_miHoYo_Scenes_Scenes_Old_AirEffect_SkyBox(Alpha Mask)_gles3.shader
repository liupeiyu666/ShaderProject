...
void main()
{
...
#endif
        if(u_xlatb15){
            u_xlat16_2.x = 0.99000001;
            u_xlat16_2.y = (-vs_TEXCOORD0.y) + 1.0;
            u_xlat10_3.xyz = texture(_MainTex, u_xlat16_2.xy).xyz;
            u_xlat16_2.xyz = u_xlat10_3.xyz;
        } else {
    ...
    u_xlat16_2.xyz = vs_COLOR1.www * u_xlat16_4.xyz + u_xlat16_2.xyz;
    u_xlat16_4.xyz = _SkyBoxColor.xyz * vec3(_SkyBoxColorScaler);
...
void main()
{
    u_xlat10_0 = texture(_MainTex, vs_TEXCOORD0.xy);
#ifdef UNITY_ADRENO_ES3
    u_xlatb18 = !!(u_xlat10_0.w<0.899999976);
#else
    u_xlatb18 = u_xlat10_0.w<0.899999976;
#endif
    if(u_xlatb18){
        ...
        u_xlat10_1 = texture(_MainTex, u_xlat16_1.xy);
#ifdef UNITY_ADRENO_ES3
        u_xlatb18 = !!(u_xlat10_1.w<0.899999976);
#else
        u_xlatb18 = u_xlat10_1.w<0.899999976;
#endif
        if(u_xlatb18){
    ...
    u_xlat16_0.x = dot(u_xlat16_5.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_0.xyz = (-u_xlat16_2.xyz) * u_xlat16_4.xyz + u_xlat16_0.xxx;
    u_xlat16_0.xyz = vec3(vec3(_LumiFactor, _LumiFactor, _LumiFactor)) * u_xlat16_0.xyz + u_xlat16_5.xyz;
...
#endif
    u_xlat16_2.xyz = u_xlat16_2.xyz * vec3(u_xlat16_20) + vs_COLOR1.xyz;
    u_xlat16_4.xyz = _SkyBoxColor.xyz * vec3(_SkyBoxColorScaler);
    u_xlat16_5.xyz = u_xlat16_2.xyz * u_xlat16_4.xyz;
    u_xlat16_0.x = dot(u_xlat16_5.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_0.xyz = (-u_xlat16_2.xyz) * u_xlat16_4.xyz + u_xlat16_0.xxx;
