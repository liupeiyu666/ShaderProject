...
void main ()
{
  ...
  power_17 = _FresnelParams.x;
  mediump float scale_18;
  scale_18 = _FresnelParams.y;
  mediump float bias_19;
  bias_19 = _FresnelParams.z;
  lowp vec2 tmpvar_20;
  tmpvar_20 = texture2D (_BrushedNormalMap, xlv_TEXCOORD1).xy;
  brushedValue_3 = tmpvar_20;
  brushedValue_3 = ((brushedValue_3 * 2.0) - 1.0);
  highp vec2 tmpvar_21;
  tmpvar_21.x = _BrushScaleX;
  tmpvar_21.y = _BrushScaleY;
  brushedValue_3 = (brushedValue_3 * tmpvar_21);
  mediump vec2 tmpvar_22;
  tmpvar_22 = ((xlv_TEXCOORD2.xy / xlv_TEXCOORD2.w) + brushedValue_3);
  uvSC_2 = tmpvar_22;
  lowp vec4 tmpvar_23;
  tmpvar_23 = texture2D (_ReflectionTex, uvSC_2);
  reflColor_1 = tmpvar_23;
  ...
  tmpvar_24.xyz = diffColor_5;
  tmpvar_24.w = _BloomFactor;
  outColor_10 = (tmpvar_24 + (reflColor_1 * (bias_19 + 
    max (0.0, (pow (clamp (
      (1.0 - dot (I_4, xlv_TEXCOORD4))
    , 0.001, 1.0), power_17) * scale_18))
  )));
