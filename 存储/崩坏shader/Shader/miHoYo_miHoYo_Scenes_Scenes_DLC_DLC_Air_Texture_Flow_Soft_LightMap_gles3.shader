...
void main()
{
    ...
    u_xlat1.x = sin(_RotateCt);
    u_xlat2 = cos(_RotateCt);
    u_xlat3.z = u_xlat1.x;
    u_xlat3.y = u_xlat2;
    u_xlat3.x = (-u_xlat1.x);
    u_xlat1.y = dot(u_xlat16_0.xy, u_xlat3.xy);
    u_xlat1.x = dot(u_xlat16_0.xy, u_xlat3.yz);
    u_xlat0.xy = u_xlat1.xy + vec2(0.5, 0.5);
    u_xlat10_0.x = texture(_FlowMask, u_xlat0.xy).x;
    u_xlat16_4.x = _EmissionScaler * 4.0;
    ...
    u_xlat16_0 = u_xlat16_4.xxxx * u_xlat16_1 + u_xlat10_0;
    u_xlat1.xy = vec2(_ScrollXSpeed2, _ScrollYSpeed2) * _Time.xx + vs_TEXCOORD2.xy;
    u_xlat10_1.xyz = texture(_MainTex2, u_xlat1.xy).xyz;
    u_xlat1.xyz = u_xlat10_1.xyz * _MainColor2.xyz;
    u_xlat16_4.xyz = u_xlat1.xyz * vec3(_Opacity2);
    u_xlat16_4.xyz = u_xlat16_0.www * u_xlat16_0.xyz + u_xlat16_4.xyz;
    ...
    u_xlat16_5.xyz = u_xlat16_5.xyz * vec3(vec3(_LightMapIntensity, _LightMapIntensity, _LightMapIntensity)) + _LightingColor.xyz;
...
void main()
{
    ...
    u_xlat16 = (-vs_TEXCOORD3.z) + _WaterPlaneHeight;
    u_xlat17 = (-_UWFogHeightEnd) + _WaterPlaneHeight;
    u_xlat16 = u_xlat16 / u_xlat17;
    u_xlat16 = max(u_xlat16, 0.0);
    u_xlat17 = (-u_xlat16) * _UWHeightRatio + 1.0;
    u_xlat17 = u_xlat17 * vs_TEXCOORD3.y;
    u_xlat17 = max(u_xlat17, _UWCriticalRange);
    u_xlat17 = min(u_xlat17, 1.0);
#ifdef UNITY_ADRENO_ES3
    u_xlatb3 = !!(0.99000001<vs_TEXCOORD3.y);
#else
    u_xlatb3 = 0.99000001<vs_TEXCOORD3.y;
#endif
    u_xlat16_19 = (u_xlatb3) ? u_xlat17 : vs_TEXCOORD3.y;
    u_xlat16_19 = (-u_xlat16_19) + 1.0;
    u_xlat1.xyz = vec3(u_xlat16_19) * u_xlat2.xyz + u_xlat1.xyz;
...
#ifdef UNITY_ADRENO_ES3
    u_xlatb16 = !!(vs_TEXCOORD3.z<_WaterPlaneHeight);
#else
    u_xlatb16 = vs_TEXCOORD3.z<_WaterPlaneHeight;
#endif
    SV_Target0.xyz = (bool(u_xlatb16)) ? u_xlat1.xyz : u_xlat16_4.xyz;
    SV_Target0.w = _BloomFactor;
    return;
}
