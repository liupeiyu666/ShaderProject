...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_DLC/Lightmap_Prop_AddLight_Premultiply_Simple" {
Properties {
...
SubShader {
 Tags { "DrawDepth" = "FrontFace" "PerformanceChecks" = "False" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
 Pass {
  Name "FORWARDONLY"
  Tags { "DrawDepth" = "FrontFace" "LIGHTMODE" = "FORWARDBASE" "PerformanceChecks" = "False" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
  ZWrite Off
  Cull Off
  GpuProgramID 21296
Program "vp" {
...
void main ()
{
  ...
  alpha_5 = texColor_10.w;
  mediump vec3 tmpvar_21;
  tmpvar_21 = ((texShadowColor_7 * 2.0) * _LightMapIntensity).xyz;
  ...
  tmpvar_24 = ((mix (tmpvar_19, R_4, vec3(_MetalRef)).xy * 0.5) + 0.5);
  ...
  if ((_EnableMatcapSpecular > 0.0)) {
    ...
    tmpvar_27 = ((tmpvar_25 * _SpecularIntensity) * matcapMaskColor_8.x).xyz;
    matcapSpecular_3 = tmpvar_27;
  };
  lowp vec4 tmpvar_28;
  tmpvar_28 = texture2D (_MatCap, tmpvar_24);
  mc_2 = tmpvar_28;
  mc_2.xyz = ((mc_2.xyz * tmpvar_20) * (vec3(2.0, 2.0, 2.0) * tmpvar_21));
  highp vec3 tmpvar_29;
  tmpvar_29 = ((mc_2.xyz * matcapMaskColor_8.x) + ((tmpvar_20 * tmpvar_21) * (1.0 - matcapMaskColor_8.x)));
  finalColor_1 = tmpvar_29;
  finalColor_1 = ((finalColor_1 * texColor_10.w) + matcapSpecular_3);
  finalColor_1 = (mix (finalColor_1, xlv_COLOR1.xyz, xlv_COLOR1.www) * _Transparent);
  alpha_5 = (texColor_10.w * _Transparent);
  mediump float tmpvar_30;
  tmpvar_30 = clamp (alpha_5, 0.0, 1.0);
  alpha_5 = tmpvar_30;
  mediump vec4 tmpvar_31;
  tmpvar_31.xyz = finalColor_1;
