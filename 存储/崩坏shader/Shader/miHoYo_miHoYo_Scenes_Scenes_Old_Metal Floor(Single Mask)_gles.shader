...
void main ()
{
  ...
  tmpvar_11 = texture2D (_ReflectMaskTex, xlv_TEXCOORD0).x;
  reflectMask_7 = tmpvar_11;
  lowp vec4 tmpvar_12;
  tmpvar_12 = texture2D (_ShadowTex, xlv_TEXCOORD5);
  ShadowColor_6 = tmpvar_12;
  highp vec3 tmpvar_13;
  tmpvar_13 = (baseTexColor_8.xyz * _Color.xyz);
  diffColor_5 = tmpvar_13;
  ...
  tmpvar_15 = (bias_18 + max (0.0, (
    pow (clamp ((1.0 - dot (I_4, xlv_TEXCOORD4)), 0.001, 1.0), power_16)
   * scale_17)));
  lowp vec2 tmpvar_19;
  ...
  tmpvar_24 = mix (tmpvar_23, reflColor_1, vec4(tmpvar_15));
  outColor_9 = tmpvar_24;
...
void main ()
{
  ...
  tmpvar_24 = mix (tmpvar_23, reflColor_1, vec4(tmpvar_15));
  outColor_9 = tmpvar_24;
  outColor_9.xyz = (xlv_COLOR1.xyz + (outColor_9.xyz * clamp (xlv_COLOR1.w, 0.0, 1.0)));
  gl_FragData[0] = outColor_9;
}
