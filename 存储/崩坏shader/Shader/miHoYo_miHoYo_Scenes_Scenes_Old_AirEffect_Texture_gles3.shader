...
#endif
    SV_Target0.xyz = u_xlat10_0.xyz * vec3(u_xlat16_1) + vs_COLOR1.xyz;
    SV_Target0.w = _BloomFactor;
    return;
}
...
void main()
{
    ...
    u_xlat4.xyz = vec3(u_xlat16_1) * u_xlat3.xyz + u_xlat4.xyz;
...
void main()
{
    ...
    u_xlatb12 = vs_TEXCOORD2.z<_WaterPlaneHeight;
#endif
    u_xlat16_1.xyz = (bool(u_xlatb12)) ? u_xlat0.xyz : u_xlat2.xyz;
    u_xlat16_0.x = dot(u_xlat16_1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_0.xyz = (-u_xlat16_1.xyz) + u_xlat16_0.xxx;
    u_xlat16_0.xyz = vec3(vec3(_LumiFactor, _LumiFactor, _LumiFactor)) * u_xlat16_0.xyz + u_xlat16_1.xyz;
    SV_Target0.xyz = u_xlat16_0.xyz;
