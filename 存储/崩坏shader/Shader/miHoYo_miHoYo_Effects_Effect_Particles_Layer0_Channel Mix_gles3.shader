...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Effects/Effect_Particles/Layer0/Channel Mix" {
Properties {
...
void main()
{
    u_xlat16_0.xyz = (-_TintColor0.xyz) + _TintColor1.xyz;
    u_xlat10_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_1.xxx * u_xlat16_0.xyz + _TintColor0.xyz;
    u_xlat16_2.xyz = (-u_xlat16_0.xyz) + _TintColor2.xyz;
    u_xlat16_0.xyz = u_xlat10_1.yyy * u_xlat16_2.xyz + u_xlat16_0.xyz;
    SV_Target0.w = u_xlat10_1.z * vs_COLOR0.w;
#ifdef UNITY_ADRENO_ES3
    SV_Target0.w = min(max(SV_Target0.w, 0.0), 1.0);
#else
    SV_Target0.w = clamp(SV_Target0.w, 0.0, 1.0);
#endif
    u_xlat16_9 = _EmissionScaler + _EmissionScaler;
    u_xlat16_2.xyz = vec3(u_xlat16_9) * vs_COLOR0.xyz;
...
void main()
{
    ...
    SV_Target0.w = clamp(SV_Target0.w, 0.0, 1.0);
#endif
    u_xlat16_12 = _EmissionScaler + _EmissionScaler;
    u_xlat16_2.xyz = vec3(u_xlat16_12) * vs_COLOR0.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = (-u_xlat16_1.xyz) + _TintColor2.xyz;
    u_xlat16_1.xyz = u_xlat10_0.yyy * u_xlat16_2.xyz + u_xlat16_1.xyz;
    u_xlat16_13 = _EmissionScaler + _EmissionScaler;
    u_xlat16_2.xyz = vec3(u_xlat16_13) * vs_COLOR0.xyz;
...
void main()
{
    u_xlat10_0 = texture(_MainTex, vs_TEXCOORD0.xy).z;
