...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/Metal Wall" {
Properties {
...
void main()
{
    ...
    u_xlat16_15 = dot((-u_xlat1.xyz), u_xlat16_0.xyz);
    u_xlat16_15 = u_xlat16_15 + u_xlat16_15;
    u_xlat16_0.xyz = u_xlat16_0.xyz * (-vec3(u_xlat16_15)) + (-u_xlat1.xyz);
    u_xlat16_15 = dot(u_xlat1.xyz, vs_TEXCOORD4.xyz);
    u_xlat16_15 = (-u_xlat16_15) + 1.0;
    u_xlat16_15 = max(u_xlat16_15, 0.00100000005);
    u_xlat16_15 = min(u_xlat16_15, 1.0);
    u_xlat16_15 = log2(u_xlat16_15);
    u_xlat16_15 = u_xlat16_15 * _FresnelParams.x;
    u_xlat16_15 = exp2(u_xlat16_15);
    u_xlat16_15 = u_xlat16_15 * _FresnelParams.y;
    u_xlat16_15 = max(u_xlat16_15, 0.0);
    u_xlat16_15 = u_xlat16_15 + _FresnelParams.z;
    u_xlat10_1.xy = texture(_BrushedNormalMap, vs_TEXCOORD1.xy).xy;
    u_xlat16_2.xy = u_xlat10_1.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat16_2.xy = u_xlat16_2.xy * vec2(_BrushScaleX, _BrushScaleY);
    u_xlat16_17 = u_xlat16_2.y + u_xlat16_2.x;
    u_xlat16_2.z = u_xlat16_17 * 0.5;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_2.xyz;
    u_xlat10_1 = texture(_Cube, u_xlat16_0.xyz);
    u_xlat16_0.xyz = u_xlat10_1.xyz * u_xlat10_1.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(_ReflectionEmissionAdjust);
    ...
    u_xlat16_2.xyz = u_xlat16_0.xyz * u_xlat10_2.www + (-u_xlat3.xyz);
    u_xlat3.w = _BloomFactor;
    u_xlat16_2.w = u_xlat10_1.w + (-u_xlat3.w);
    u_xlat16_0 = vec4(u_xlat16_15) * u_xlat16_2 + u_xlat3;
    u_xlat16_4.xyz = (-u_xlat16_0.xyz) + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_4.xyz + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_2.w = u_xlat10_1.w + (-u_xlat3.w);
    u_xlat16_0 = vec4(u_xlat16_15) * u_xlat16_2 + u_xlat3;
    u_xlat16_4 = vs_COLOR1.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_4 = min(max(u_xlat16_4, 0.0), 1.0);
#else
    u_xlat16_4 = clamp(u_xlat16_4, 0.0, 1.0);
#endif
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(u_xlat16_4) + vs_COLOR1.xyz;
    SV_Target0.w = u_xlat16_0.w;
    return;
}
...
void main()
{
    ...
    u_xlat16_0 = vec4(u_xlat16_15) * u_xlat16_2 + u_xlat3;
    u_xlat16_4.xyz = (-u_xlat16_0.xyz) + vs_COLOR1.xyz;
    u_xlat16_0.xyz = vs_COLOR1.www * u_xlat16_4.xyz + u_xlat16_0.xyz;
    SV_Target0.w = u_xlat16_0.w;
...
void main()
{
    ...
    u_xlat16_4 = clamp(u_xlat16_4, 0.0, 1.0);
#endif
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(u_xlat16_4) + vs_COLOR1.xyz;
    SV_Target0.w = u_xlat16_0.w;
    u_xlat16_1.x = dot(u_xlat16_0.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_1.xyz = (-u_xlat16_0.xyz) + u_xlat16_1.xxx;
    u_xlat16_1.xyz = vec3(_LumiFactor) * u_xlat16_1.xyz + u_xlat16_0.xyz;
