...
void main()
{
    ...
    u_xlat1.x = max(u_xlat1.x, 0.0);
    u_xlat3.x = u_xlat1.x * _UWFogColorHLIntensity;
    ...
    u_xlat16_14 = (u_xlatb9) ? u_xlat1.x : vs_TEXCOORD3.y;
    u_xlat16_14 = (-u_xlat16_14) + 1.0;
    u_xlat1.xzw = _UWFogColorNear.xyz + (-_UWFogColorFar.xyz);
    u_xlat1.xzw = vs_TEXCOORD3.xxx * u_xlat1.xzw + _UWFogColorFar.xyz;
    u_xlat7.xyz = u_xlat16_2.xyz * vec3(vec3(_LightMapIntensity, _LightMapIntensity, _LightMapIntensity)) + (-u_xlat1.xzw);
    u_xlat1.xzw = vec3(u_xlat16_14) * u_xlat7.xyz + u_xlat1.xzw;
