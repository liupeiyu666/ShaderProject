...
void main()
{
    ...
    u_xlat1.xyz = (_UseLightDir != 0) ? u_xlat16_2.xyz : _WorldSpaceLightPos0.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat2.xxx * u_xlat16_1.xyz + _TintColor0.xyz;
    u_xlat16_3.xyz = (-u_xlat16_1.xyz) + _TintColor2.xyz;
    u_xlat16_1.xyz = u_xlat2.yyy * u_xlat16_3.xyz + u_xlat16_1.xyz;
    u_xlat16_1.xyz = (_ChannelMix != 0) ? u_xlat16_1.xyz : u_xlat2.xyz;
    u_xlat16_3.xyz = u_xlat16_1.xyz * _FirstShadowMultColor.xyz;
    u_xlat16_4.xyz = (int(u_xlati15) != 0) ? u_xlat16_1.xyz : u_xlat16_3.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * _SecondShadowMultColor.xyz;
    ...
    u_xlat16_1.xyz = (int(u_xlati15) != 0) ? u_xlat16_3.xyz : u_xlat16_1.xyz;
    u_xlat5 = vs_COLOR0.x * u_xlat10_0.y + 0.909999967;
    u_xlat5 = floor(u_xlat5);
    u_xlat5 = max(u_xlat5, 0.0);
    u_xlati5 = int(u_xlat5);
    u_xlat16_1.xyz = (int(u_xlati5) != 0) ? u_xlat16_4.xyz : u_xlat16_1.xyz;
    ...
    u_xlat16_16 = inversesqrt(u_xlat16_16);
    u_xlat16_4.xyz = vec3(u_xlat16_16) * vs_TEXCOORD1.xyz;
...
void main()
{
    u_xlat0.xyz = texture(_LightMapTex, vs_TEXCOORD0.xy).xyz;
    u_xlat18 = (-vs_COLOR0.x) * u_xlat0.y + 1.5;
    u_xlat18 = floor(u_xlat18);
    u_xlat18 = max(u_xlat18, 0.0);
    u_xlati18 = int(u_xlat18);
    u_xlat16_1.x = u_xlat0.y * vs_COLOR0.x;
    u_xlat2.xy = u_xlat16_1.xx * vec2(1.20000005, 1.25) + vec2(-0.100000001, -0.125);
    ...
    u_xlat16_1.xyz = (_ChannelMix != 0) ? u_xlat16_1.xyz : u_xlat2.xyz;
    u_xlat16_3.xyz = u_xlat16_1.xyz * _FirstShadowMultColor.xyz;
    u_xlat16_4.xyz = (int(u_xlati18) != 0) ? u_xlat16_1.xyz : u_xlat16_3.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * _SecondShadowMultColor.xyz;
    u_xlat16_19 = vs_COLOR0.x * u_xlat0.y + vs_COLOR1;
    u_xlat16_19 = u_xlat16_19 * 0.5 + (-_SecondShadow);
    u_xlat16_19 = u_xlat16_19 + 1.0;
    u_xlat16_19 = floor(u_xlat16_19);
    u_xlat16_19 = max(u_xlat16_19, 0.0);
    u_xlati18 = int(u_xlat16_19);
    u_xlat16_1.xyz = (int(u_xlati18) != 0) ? u_xlat16_3.xyz : u_xlat16_1.xyz;
    u_xlat6.x = vs_COLOR0.x * u_xlat0.y + 0.909999967;
    u_xlat6.x = floor(u_xlat6.x);
    u_xlat6.x = max(u_xlat6.x, 0.0);
    u_xlati6 = int(u_xlat6.x);
    u_xlat16_1.xyz = (int(u_xlati6) != 0) ? u_xlat16_4.xyz : u_xlat16_1.xyz;
    u_xlat2.xyz = (-vs_TEXCOORD3.xyz) + _WorldSpaceCameraPos.xyz;
    ...
    u_xlat0.y = dot(u_xlat2.xyz, u_xlat16_4.xyz);
    u_xlat6.xy = vec2((-u_xlat0.y) + float(1.00100005), (-u_xlat0.z) + float(1.0));
    u_xlat6.x = max(u_xlat6.x, 0.00100000005);
    u_xlat6.x = min(u_xlat6.x, 1.0);
    u_xlat6.x = log2(u_xlat6.x);
    u_xlat6.x = u_xlat6.x * _RGShininess;
    u_xlat6.x = exp2(u_xlat6.x);
    u_xlat6.x = u_xlat6.x * _RGScale + _RGBias;
    u_xlat16_19 = max(u_xlat16_19, 0.0);
    u_xlat16_19 = log2(u_xlat16_19);
    u_xlat16_19 = u_xlat16_19 * _Shininess;
    u_xlat16_19 = exp2(u_xlat16_19);
    u_xlat12 = u_xlat6.y + (-u_xlat16_19);
    ...
    u_xlat16_3.xyz = (int(u_xlati12) != 0) ? vec3(0.0, 0.0, 0.0) : u_xlat16_3.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz + u_xlat16_3.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * _Color.xyz;
    u_xlat0.xzw = u_xlat6.xxx * _RGColor.xyz + (-u_xlat16_1.xyz);
    u_xlat16_19 = u_xlat6.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_19 = min(max(u_xlat16_19, 0.0), 1.0);
#else
    u_xlat16_19 = clamp(u_xlat16_19, 0.0, 1.0);
#endif
    u_xlat6.x = u_xlat16_19 * _RGRatio;
    u_xlat0.xyz = u_xlat6.xxx * u_xlat0.xzw + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat2.x = dot(u_xlat0.xzw, u_xlat16_4.xyz);
    u_xlat2.x = u_xlat2.x + u_xlat2.x;
    u_xlat0.xzw = u_xlat16_4.xyz * (-u_xlat2.xxx) + u_xlat0.xzw;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat2.xyz * vec3(u_xlat18) + vs_TEXCOORD4.xyz;
    u_xlat16_19 = dot(u_xlat16_3.xyz, u_xlat16_3.xyz);
    u_xlat16_19 = inversesqrt(u_xlat16_19);
    u_xlat5.xyz = u_xlat16_3.xyz * vec3(u_xlat16_19) + (-_WorldSpaceLightPos0.xyz);
    u_xlat16_3.xyz = vec3(u_xlat16_19) * u_xlat16_3.xyz;
    ...
    u_xlat16_4.xyz = u_xlat5.xyz * vec3(u_xlat20) + _CustomLightDir.xyz;
    u_xlat16_19 = dot(u_xlat16_4.xyz, u_xlat16_4.xyz);
    u_xlat16_19 = inversesqrt(u_xlat16_19);
    u_xlat16_4.xyz = vec3(u_xlat16_19) * u_xlat16_4.xyz;
    u_xlat16_3.xyz = (bool(u_xlatb6)) ? u_xlat16_4.xyz : u_xlat16_3.xyz;
    ...
    u_xlat16_3.xyz = (int(u_xlati6) != 0) ? vec3(0.0, 0.0, 0.0) : u_xlat16_3.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz + u_xlat16_3.xyz;
    u_xlat0.xyz = u_xlat2.xyz * vec3(u_xlat18) + (-_WorldSpaceCameraPos.xyz);
    ...
    u_xlat18 = u_xlat18 * _RGShininess;
    u_xlat18 = exp2(u_xlat18);
    u_xlat18 = u_xlat18 * _RGScale + _RGBias;
    u_xlat2.x = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat2.x = inversesqrt(u_xlat2.x);
    u_xlat10_8.xyz = texture(_SPNoiseTex, vs_TEXCOORD5.zw).xyz;
    u_xlat5.xyz = u_xlat10_8.xyz * vec3(_SPCubeMapNoiseIntensity);
    u_xlat16_19 = u_xlat10_8.x * 1.99000001;
    u_xlat8 = u_xlat16_19 * _SPNoiseScaler + -1.0;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat2.xxx + u_xlat5.xyz;
    u_xlat0.xyz = u_xlat0.xyz + _SPCubeMapOffset.xyz;
    u_xlat2.x = dot(u_xlat0.xyz, u_xlat16_4.xyz);
    u_xlat2.x = u_xlat2.x + u_xlat2.x;
    u_xlat0.xyz = u_xlat16_4.xyz * (-u_xlat2.xxx) + u_xlat0.xyz;
    ...
    u_xlat2.xzw = _SPTransitionColor.xyz * vec3(_SPTransitionEmissionScaler) + (-u_xlat0.xyz);
    u_xlat5.x = _SPNoiseScaler * _SPTransition;
    u_xlat11 = u_xlat5.x * 1.70000005 + (-u_xlat8);
    u_xlat5.xz = u_xlat5.xx * vec2(1.70000005, 1.5) + (-vec2(u_xlat8));
    ...
    u_xlat8 = u_xlat11 * 10.0;
#ifdef UNITY_ADRENO_ES3
    u_xlat8 = min(max(u_xlat8, 0.0), 1.0);
#else
    u_xlat8 = clamp(u_xlat8, 0.0, 1.0);
#endif
    u_xlat2.xzw = vec3(u_xlat8) * u_xlat2.xzw + u_xlat0.xyz;
    u_xlat16_3.xyz = (u_xlati5.z != 0) ? u_xlat0.xyz : u_xlat2.xzw;
    ...
    u_xlat0.xyz = vec3(u_xlat18) * _RGColor.xyz + (-u_xlat16_1.xyz);
    ...
    u_xlat16_19 = clamp(u_xlat16_19, 0.0, 1.0);
#endif
    u_xlat18 = u_xlat16_19 * _RGRatio;
    u_xlat0.xyz = vec3(u_xlat18) * u_xlat0.xyz + u_xlat16_1.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    u_xlat0.x = _SPTransitionBloomFactor + (-_BloomFactor);
    u_xlat0.x = u_xlat8 * u_xlat0.x + _BloomFactor;
