...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/Floor (Reflecting Light)" {
Properties {
...
void main ()
{
  ...
  mediump vec4 baseTexColor_7;
  mediump vec4 outColor_8;
  lowp vec4 tmpvar_9;
  tmpvar_9 = texture2D (_MainTex, xlv_TEXCOORD0);
  baseTexColor_7 = tmpvar_9;
  lowp vec4 tmpvar_10;
  tmpvar_10 = texture2D (_ShadowTex, xlv_TEXCOORD5);
  ShadowColor_6 = tmpvar_10;
  highp vec3 tmpvar_11;
  tmpvar_11 = (baseTexColor_7.xyz * _Color.xyz);
  diffColor_5 = tmpvar_11;
  ...
  I_4 = tmpvar_12;
  mediump float power_13;
  power_13 = _FresnelParams.x;
  mediump float scale_14;
  scale_14 = _FresnelParams.y;
  mediump float bias_15;
  bias_15 = _FresnelParams.z;
  lowp vec2 tmpvar_16;
  tmpvar_16 = texture2D (_BrushedNormalMap, xlv_TEXCOORD1).xy;
  brushedValue_3 = tmpvar_16;
  brushedValue_3 = ((brushedValue_3 * 2.0) - 1.0);
  highp vec2 tmpvar_17;
  tmpvar_17.x = _BrushScaleX;
  tmpvar_17.y = _BrushScaleY;
  brushedValue_3 = (brushedValue_3 * tmpvar_17);
  mediump vec2 tmpvar_18;
  tmpvar_18 = ((xlv_TEXCOORD2.xy / xlv_TEXCOORD2.w) + brushedValue_3);
  uvSC_2 = tmpvar_18;
  lowp vec4 tmpvar_19;
  tmpvar_19 = texture2D (_ReflectionTex, uvSC_2);
  reflColor_1 = tmpvar_19;
  mediump vec4 tmpvar_20;
  tmpvar_20 = max (vec4(0.0, 0.0, 0.0, 0.0), reflColor_1);
  reflColor_1.w = tmpvar_20.w;
  reflColor_1.xyz = (tmpvar_20.xyz * _ReflectionEmissionAdjust);
  reflColor_1.xyz = (reflColor_1.xyz * baseTexColor_7.w);
  highp vec4 tmpvar_21;
  tmpvar_21.xyz = diffColor_5;
  tmpvar_21.w = _BloomFactor;
  outColor_8 = (tmpvar_21 + (reflColor_1 * (bias_15 + 
    max (0.0, (pow (clamp (
      (1.0 - dot (I_4, xlv_TEXCOORD4))
    , 0.001, 1.0), power_13) * scale_14))
  )));
  outColor_8.xyz = mix (outColor_8.xyz, xlv_COLOR1.xyz, xlv_COLOR1.www);
...
void main ()
{
  ...
  outColor_8.xyz = (xlv_COLOR1.xyz + (outColor_8.xyz * clamp (xlv_COLOR1.w, 0.0, 1.0)));
  gl_FragData[0] = outColor_8;
}
