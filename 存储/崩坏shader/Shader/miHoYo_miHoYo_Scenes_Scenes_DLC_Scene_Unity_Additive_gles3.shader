...
void main()
{
    ...
    u_xlat16_1.xyz = (-u_xlat16_0.xyz) * vec3(2.0, 2.0, 2.0) + vs_TEXCOORD2.xyz;
    u_xlat16_0 = u_xlat16_0 + u_xlat16_0;
    SV_Target0.xyz = vs_TEXCOORD2.www * u_xlat16_1.xyz + u_xlat16_0.xyz;
...
#endif
    SV_Target0.w = u_xlat16_1.x * _Transparent;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = (-u_xlat16_0.xyz) * vec3(2.0, 2.0, 2.0) + vs_TEXCOORD2.xyz;
    u_xlat16_0 = u_xlat16_0 + u_xlat16_0;
    u_xlat16_1.xyz = vs_TEXCOORD2.www * u_xlat16_1.xyz + u_xlat16_0.xyz;
...
#endif
    SV_Target0.w = u_xlat16_10 * _Transparent;
    u_xlat16_2.x = dot(u_xlat16_1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_2.xyz = (-u_xlat16_1.xyz) + u_xlat16_2.xxx;
    u_xlat16_2.xyz = vec3(vec3(_LumiFactor, _LumiFactor, _LumiFactor)) * u_xlat16_2.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_0 = u_xlat16_0 * _TintColor;
    u_xlat16_0 = u_xlat16_0 + u_xlat16_0;
    u_xlat16_1 = vs_TEXCOORD2.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_1 = min(max(u_xlat16_1, 0.0), 1.0);
#else
    u_xlat16_1 = clamp(u_xlat16_1, 0.0, 1.0);
#endif
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(u_xlat16_1) + vs_TEXCOORD2.xyz;
    ...
    u_xlat16_1 = clamp(u_xlat16_1, 0.0, 1.0);
#endif
    SV_Target0.w = u_xlat16_1 * _Transparent;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.x = clamp(u_xlat16_1.x, 0.0, 1.0);
#endif
    u_xlat16_1.xyz = u_xlat16_0.xyz * u_xlat16_1.xxx + vs_TEXCOORD2.xyz;
    u_xlat16_10 = u_xlat16_0.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_10 = min(max(u_xlat16_10, 0.0), 1.0);
#else
