...
void main()
{
    ...
    u_xlat1.x = _Time.y * _OceanGlitterSpeed;
    u_xlat1.x = u_xlat1.x * _OceanScintillationSpeedLayer2;
    vs_TEXCOORD5.z = u_xlat1.x * 0.200000003 + u_xlat2.z;
    vs_TEXCOORD5.xyw = u_xlat16_3.xyz * vec3(0.400000006, 0.200000003, 0.400000006) + u_xlat2.xyw;
    phase0_Output0_6 = in_TEXCOORD0.xyxy * _GlitterTex_ST.xyxy + u_xlat1.zwzw;
    ...
    u_xlat16_3.x = (-u_xlat1.z) * u_xlat5.x + 1.0;
    ...
    if(u_xlatb1){
        ...
        u_xlat2.xyz = u_xlat1.xxx * u_xlat5.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat2;
    //ENDIF
    }
    gl_Position = u_xlat0;
...
void main()
{
    ...
    if(u_xlatb2){
        ...
        u_xlat16_12 = (-u_xlat16_1.x) * _OutsideGlitterDensity + 1.0;
        u_xlat16_7 = (-u_xlat16_1.x) * _OutsideGlitterDensity + u_xlat10_7;
...
#endif
        u_xlat16_12 = u_xlat16_7 * -2.0 + 3.0;
        u_xlat16_7 = u_xlat16_7 * u_xlat16_7;
        u_xlat16_7 = u_xlat16_7 * u_xlat16_12;
        u_xlat16_7 = u_xlat16_7 * _OutsideGlitterBrightness;
        u_xlat16_7 = u_xlat16_7;
        u_xlat16_1.x = u_xlat10_2;
    } else {
        u_xlat10_3.x = texture(_GlitterTex, vs_TEXCOORD7.xy).x;
        u_xlat16_6 = (-u_xlat15) * 3.0 + 1.0;
        u_xlat8.xy = vs_TEXCOORD5.xy * vec2(10.0, 10.0);
        u_xlat10_8 = texture(_NoiseTex, u_xlat8.xy).w;
        u_xlat16_13 = (-u_xlat16_6) * _InnerGlitterDensity + 1.0;
        u_xlat16_8 = (-u_xlat16_6) * _InnerGlitterDensity + u_xlat10_8;
        ...
        u_xlat16_7 = u_xlat16_8 * _InnerGlitterBrightness;
        u_xlat16_7 = u_xlat16_7;
        u_xlat16_1.x = u_xlat10_3.x;
    //ENDIF
    }
    u_xlat3.xy = (-u_xlat0.xy) * vec2(5.0, 5.0) + vs_TEXCOORD2.xy;
    u_xlat10_3.xyz = texture(_CausticMap, u_xlat3.xy).xyz;
    u_xlat16_3.xyz = u_xlat10_3.xyz * vec3(vec3(_Caustic, _Caustic, _Caustic)) + _WaterColor.xyz;
    u_xlat16_1.xyz = vec3(u_xlat16_1.x * _OceanGlitterColor.xxyz.y, u_xlat16_1.x * _OceanGlitterColor.xxyz.z, u_xlat16_1.x * float(_OceanGlitterColor.z));
    u_xlat16_1.xyz = vec3(u_xlat16_7) * u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(u_xlat16_10) + u_xlat16_3.xyz;
...
void main()
{
    ...
    phase0_Output0_6 = in_TEXCOORD0.xyxy * _GlitterTex_ST.xyxy + u_xlat2.zwzw;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(u_xlat16_8) + u_xlat16_3.xyz;
...
{
    u_xlat10_0.xy = texture(_NormalMap, vs_TEXCOORD0.xy).xy;
    u_xlat10_12.xy = texture(_NormalMap, vs_TEXCOORD1.xy).xy;
    u_xlat16_0.xy = u_xlat10_12.xy + u_xlat10_0.xy;
    u_xlat16_0.xy = u_xlat16_0.xy + vec2(-0.600000024, -0.600000024);
    u_xlat16_1.xy = u_xlat16_0.xy * vec2(_Distortion);
    u_xlat0.xy = u_xlat16_1.xy / vs_TEXCOORD4.yy;
    u_xlat12.xy = vs_TEXCOORD3.xy / vs_TEXCOORD3.ww;
    u_xlat12.xy = (-u_xlat0.xy) + u_xlat12.xy;
    u_xlat10_2.xyz = texture(_ReflectionTex, u_xlat12.xy).xyz;
    u_xlat12.x = vs_TEXCOORD4.z * vs_TEXCOORD4.x;
    u_xlat16_2.xyz = u_xlat10_2.xyz * _RefColor.xyz + (-_RefractionColor.xyz);
    u_xlat2.xyz = u_xlat12.xxx * u_xlat16_2.xyz + _RefractionColor.xyz;
    u_xlat10_12.x = texture(_NoiseTex, vs_TEXCOORD5.xy).w;
    u_xlat10_18 = texture(_NoiseTex, vs_TEXCOORD5.zw).w;
    u_xlat16_12 = u_xlat10_18 * u_xlat10_12.x;
    ...
    u_xlat20 = sqrt(u_xlat18);
#ifdef UNITY_ADRENO_ES3
    u_xlatb20 = !!(_InnerDensityRange<u_xlat20);
#else
    u_xlatb20 = _InnerDensityRange<u_xlat20;
#endif
    if(u_xlatb20){
        u_xlat10_20 = texture(_GlitterTex, vs_TEXCOORD8.xy).x;
        u_xlat16_1.x = (-u_xlat18) * 3.0 + 1.0;
        u_xlat3.xy = vs_TEXCOORD5.xy * vec2(10.0, 10.0);
        u_xlat10_3 = texture(_NoiseTex, u_xlat3.xy).w;
        u_xlat16_9 = (-u_xlat16_1.x) * _OutsideGlitterDensity + 1.0;
        ...
        u_xlat10_20 = texture(_GlitterTex, vs_TEXCOORD7.xy).x;
        u_xlat16_7 = (-u_xlat18) * 3.0 + 1.0;
        u_xlat4.xy = vs_TEXCOORD5.xy * vec2(10.0, 10.0);
        u_xlat10_18 = texture(_NoiseTex, u_xlat4.xy).w;
        u_xlat16_4 = (-u_xlat16_7) * _InnerGlitterDensity + 1.0;
        u_xlat16_18 = (-u_xlat16_7) * _InnerGlitterDensity + u_xlat10_18;
        ...
        u_xlat16_18 = u_xlat16_18 * u_xlat16_4;
        u_xlat16_3 = u_xlat16_18 * _InnerGlitterBrightness;
        u_xlat16_3 = u_xlat16_3;
        u_xlat16_1.x = u_xlat10_20;
    //ENDIF
    }
    u_xlat0.xy = (-u_xlat0.xy) * vec2(5.0, 5.0) + vs_TEXCOORD2.xy;
    u_xlat10_0.xyw = texture(_CausticMap, u_xlat0.xy).xyz;
    u_xlat0.xyw = u_xlat10_0.xyw * vec3(vec3(_Caustic, _Caustic, _Caustic)) + u_xlat2.xyz;
    u_xlat16_1.xyz = vec3(u_xlat16_1.x * _OceanGlitterColor.xxyz.y, u_xlat16_1.x * _OceanGlitterColor.xxyz.z, u_xlat16_1.x * float(_OceanGlitterColor.z));
    u_xlat16_1.xyz = vec3(u_xlat16_3) * u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(u_xlat16_12) + u_xlat0.xyw;
...
void main()
{
    ...
    u_xlat16_1.xyz = vec3(u_xlat16_1.x * _OceanGlitterColor.xxyz.y, u_xlat16_1.x * _OceanGlitterColor.xxyz.z, u_xlat16_1.x * float(_OceanGlitterColor.z));
    u_xlat16_1.xyz = vec3(u_xlat16_3) * u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(u_xlat16_10) + u_xlat0.xyw;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(u_xlat16_12) + u_xlat0.xyw;
    u_xlat16_5.xyz = (-u_xlat16_1.xyz) + vs_COLOR1.xyz;
    u_xlat16_1.xyz = vs_COLOR1.www * u_xlat16_5.xyz + u_xlat16_1.xyz;
