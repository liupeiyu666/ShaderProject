...
void main ()
{
  ...
  UV_4 = xlv_TEXCOORD0;
  highp vec2 tmpvar_5;
  tmpvar_5 = (UV_4 - vec2(0.5, 0.5));
  highp vec2 tmpvar_6;
  tmpvar_6.x = tmpvar_5.y;
  tmpvar_6.y = -(tmpvar_5.x);
  tmpvar_3 = (UV_4 + (tmpvar_6 * vec2(dot (tmpvar_5, tmpvar_5))));
  highp float AngleOffset_7;
  AngleOffset_7 = ((_Time.y * _RipplesSpeed) + 1.5);
  highp vec3 res_9;
  highp vec2 f_10;
  highp vec2 g_11;
  g_11 = floor((tmpvar_3 * _RippleScale));
  f_10 = fract((tmpvar_3 * _RippleScale));
  res_9 = vec3(8.0, 0.0, 0.0);
  for (highp int y_8 = -1; y_8 <= 1; y_8++) {
    highp vec2 tmpvar_12;
    tmpvar_12.x = -1.0;
    tmpvar_12.y = float(y_8);
    highp vec2 UV_13;
    UV_13 = (tmpvar_12 + g_11);
    highp vec2 tmpvar_14;
    tmpvar_14 = fract((sin(
      (UV_13 * mat2(15.27, 99.41, 47.63, 89.98))
    ) * 46839.32));
    UV_13 = tmpvar_14;
    highp vec2 tmpvar_15;
    tmpvar_15.x = ((sin(
      (tmpvar_14.y * AngleOffset_7)
    ) * 0.5) + 0.5);
    tmpvar_15.y = ((cos(
      (tmpvar_14.x * AngleOffset_7)
    ) * 0.5) + 0.5);
    highp float tmpvar_16;
    highp vec2 tmpvar_17;
    tmpvar_17 = ((tmpvar_12 + tmpvar_15) - f_10);
    tmpvar_16 = sqrt(dot (tmpvar_17, tmpvar_17));
    if ((tmpvar_16 < res_9.x)) {
      highp vec3 tmpvar_18;
      tmpvar_18.x = tmpvar_16;
      tmpvar_18.y = tmpvar_15.x;
      tmpvar_18.z = tmpvar_15.y;
      res_9 = tmpvar_18;
    };
    highp vec2 tmpvar_19;
    tmpvar_19.x = 0.0;
    tmpvar_19.y = float(y_8);
    highp vec2 UV_20;
    UV_20 = (tmpvar_19 + g_11);
    ...
    tmpvar_22.x = ((sin(
      (tmpvar_21.y * AngleOffset_7)
    ) * 0.5) + 0.5);
    tmpvar_22.y = ((cos(
      (tmpvar_21.x * AngleOffset_7)
    ) * 0.5) + 0.5);
    highp float tmpvar_23;
    highp vec2 tmpvar_24;
    tmpvar_24 = ((tmpvar_19 + tmpvar_22) - f_10);
    tmpvar_23 = sqrt(dot (tmpvar_24, tmpvar_24));
    if ((tmpvar_23 < res_9.x)) {
    ...
    tmpvar_26.x = 1.0;
    tmpvar_26.y = float(y_8);
    highp vec2 UV_27;
    UV_27 = (tmpvar_26 + g_11);
    ...
    tmpvar_29.x = ((sin(
      (tmpvar_28.y * AngleOffset_7)
    ) * 0.5) + 0.5);
    tmpvar_29.y = ((cos(
      (tmpvar_28.x * AngleOffset_7)
    ) * 0.5) + 0.5);
    highp float tmpvar_30;
    highp vec2 tmpvar_31;
    tmpvar_31 = ((tmpvar_26 + tmpvar_29) - f_10);
    tmpvar_30 = sqrt(dot (tmpvar_31, tmpvar_31));
    if ((tmpvar_30 < res_9.x)) {
  ...
  tmpvar_33 = pow (res_9.x, _RipplesDissolve);
  finalColor_2.xyz = ((tmpvar_33 * _RippleColor) * xlv_COLOR1.w).xyz;
  finalColor_2.w = tmpvar_33;
