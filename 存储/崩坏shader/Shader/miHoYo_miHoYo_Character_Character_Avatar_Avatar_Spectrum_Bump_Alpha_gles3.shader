...
uniform 	vec4 _SpectrumBumpTex_ST;
...
void main()
{
    ...
    vs_TEXCOORD0.zw = in_TEXCOORD0.xy * _SpectrumBumpTex_ST.xy + _SpectrumBumpTex_ST.zw;
    ...
    u_xlat8 = inversesqrt(u_xlat8);
    vs_TEXCOORD1.xyz = vec3(u_xlat8) * u_xlat1.xyz;
    ...
    u_xlat8 = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat8 = inversesqrt(u_xlat8);
    vs_TEXCOORD3.xyz = vec3(u_xlat8) * u_xlat2.xyz;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture(_SpectrumBumpTex, vs_TEXCOORD0.zw).xyz;
    u_xlat0.xyz = u_xlat10_0.xyz + vec3(-0.5, -0.5, -0.0);
    u_xlat0.xy = u_xlat0.xy * vec2(vec2(_SpectrumBumpScaler, _SpectrumBumpScaler));
    u_xlat1.x = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat1.x = inversesqrt(u_xlat1.x);
    u_xlat7.xyz = u_xlat0.xyz * u_xlat1.xxx;
    u_xlat4.xyz = u_xlat7.yyy * vs_TEXCOORD3.xyz;
    u_xlat4.xyz = vs_TEXCOORD2.xyz * u_xlat7.xxx + u_xlat4.xyz;
    u_xlat7.xyz = vs_TEXCOORD4.xyz * u_xlat7.zzz + u_xlat4.xyz;
    ...
    u_xlat7.x = abs(u_xlat0.x) * -0.0187292993 + 0.0742610022;
    u_xlat7.x = u_xlat7.x * abs(u_xlat0.x) + -0.212114394;
    u_xlat7.x = u_xlat7.x * abs(u_xlat0.x) + 1.57072878;
    u_xlat12 = u_xlat12 * u_xlat7.x;
    u_xlat12 = u_xlat12 * _SpectrumRangeScaler + _SpectrumRangeOffset;
    ...
    u_xlat10_7.xyz = texture(_SpectrumTex, vec2(u_xlat12)).xyz;
    u_xlat7.xyz = u_xlat10_7.xyz * vec3(_SpectrumIntensity);
    u_xlat7.xyz = u_xlat0.xxx * u_xlat7.xyz;
    u_xlat6 = u_xlat0.y * u_xlat1.x + 0.5;
    u_xlat1.xyz = vec3(u_xlat6) * u_xlat7.xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb6 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UsingMainTexAlphaAsMask));
#else
    u_xlatb6 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UsingMainTexAlphaAsMask);
#endif
    u_xlat16_5.xyz = u_xlat10_0.www * u_xlat1.xyz;
    u_xlat16_5.xyz = (bool(u_xlatb6)) ? u_xlat16_5.xyz : u_xlat1.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _EnvColor.xyz + u_xlat16_5.xyz;
    u_xlat16_2.xyz = (-u_xlat16_3.xyz) * u_xlat16_5.xyz + u_xlat16_2.xyz;
    u_xlat16_20 = _EmissionScaler * _EmissionScalerScalerWithoutHDR;
    SV_Target0.xyz = vec3(u_xlat16_20) * u_xlat16_2.xyz;
    u_xlat16_2.x = u_xlat0.x * vs_COLOR1.y;
    u_xlat16_2.x = u_xlat16_2.x * 3.0;
    u_xlat16_2.x = min(u_xlat16_2.x, 1.0);
    u_xlat16_2.x = max(u_xlat16_2.x, _MinAlpha);
    SV_Target0.w = u_xlat10_0.w * u_xlat16_2.x;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    vs_TEXCOORD6.zw = u_xlat9.xy * _SPNoiseTex_ST.xy + _SPNoiseTex_ST.zw;
...
void main()
{
    ...
    u_xlat4.xyz = u_xlat9.yyy * vs_TEXCOORD3.xyz;
    u_xlat4.xyz = vs_TEXCOORD2.xyz * u_xlat9.xxx + u_xlat4.xyz;
    u_xlat9.xyz = vs_TEXCOORD4.xyz * u_xlat9.zzz + u_xlat4.xyz;
    u_xlat0.x = dot(vs_TEXCOORD1.xyz, vs_TEXCOORD1.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat4.xyz = u_xlat0.xxx * vs_TEXCOORD1.xyz;
    u_xlat16 = dot(u_xlat9.xyz, u_xlat4.xyz);
    u_xlat4.x = -abs(u_xlat16) + 1.0;
    u_xlat4.x = sqrt(u_xlat4.x);
    u_xlat12 = abs(u_xlat16) * -0.0187292993 + 0.0742610022;
    u_xlat12 = u_xlat12 * abs(u_xlat16) + -0.212114394;
    u_xlat12 = u_xlat12 * abs(u_xlat16) + 1.57072878;
    ...
    u_xlat16 = u_xlat16 * _SpectrumFresnel.x;
    u_xlat16 = exp2(u_xlat16);
    u_xlat16 = u_xlat16 * _SpectrumFresnel.y + _SpectrumFresnel.z;
    u_xlat10_4.xyz = texture(_SpectrumTex, u_xlat4.xx).xyz;
    u_xlat4.xyz = u_xlat10_4.xyz * vec3(_SpectrumIntensity);
    u_xlat4.xyz = vec3(u_xlat16) * u_xlat4.xyz;
    u_xlat8.x = u_xlat0.y * u_xlat1.x + 0.5;
    u_xlat4.xyz = u_xlat8.xxx * u_xlat4.xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb8 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UsingMainTexAlphaAsMask));
#else
    u_xlatb8 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_UsingMainTexAlphaAsMask);
#endif
    u_xlat16_5.xyz = u_xlat10_0.www * u_xlat4.xyz;
    u_xlat16_5.xyz = (bool(u_xlatb8)) ? u_xlat16_5.xyz : u_xlat4.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _EnvColor.xyz + u_xlat16_5.xyz;
    u_xlat16_2.xyz = (-u_xlat16_3.xyz) * u_xlat16_5.xyz + u_xlat16_2.xyz;
    u_xlat16_26 = _EmissionScaler * _EmissionScalerScalerWithoutHDR;
    u_xlat16_2.xyz = vec3(u_xlat16_26) * u_xlat16_2.xyz;
    u_xlat16_3.x = u_xlat16 * vs_COLOR1.y;
    u_xlat16_3.x = u_xlat16_3.x * 3.0;
    u_xlat16_3.x = min(u_xlat16_3.x, 1.0);
    u_xlat16_3.x = max(u_xlat16_3.x, _MinAlpha);
    u_xlat16_2.w = u_xlat10_0.w * u_xlat16_3.x;
    u_xlat10_3 = texture(_SPTex, vs_TEXCOORD6.xy);
    u_xlat16_4.w = u_xlat10_3.w * _SPOpaqueness;
    u_xlat10_8.xyz = texture(_SPNoiseTex, vs_TEXCOORD6.zw).xyz;
    u_xlat1.x = u_xlat10_8.x * _SPNoiseScaler;
    u_xlat1.x = u_xlat1.x * 1.99000001 + -1.0;
    u_xlat6.xyz = vs_TEXCOORD1.xyz * u_xlat0.xxx + (-_WorldSpaceCameraPos.xyz);
    u_xlat0.x = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat8.xyz = u_xlat10_8.xyz * vec3(_SPCubeMapNoiseIntensity);
    u_xlat0.xyz = u_xlat6.xyz * u_xlat0.xxx + u_xlat8.xyz;
    ...
    u_xlat9.xy = vec2(u_xlat24) * vec2(1.70000005, 1.5) + (-u_xlat1.xx);
    u_xlat9.xy = u_xlat9.xy + vec2(1.0, 1.0);
    u_xlat9.xy = floor(u_xlat9.xy);
    u_xlat9.xy = max(u_xlat9.xy, vec2(0.0, 0.0));
    u_xlati9.xy = ivec2(u_xlat9.xy);
    u_xlat24 = u_xlat24 * 1.70000005 + (-u_xlat1.x);
