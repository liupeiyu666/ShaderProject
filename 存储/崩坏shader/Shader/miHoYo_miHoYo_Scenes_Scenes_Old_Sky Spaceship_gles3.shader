...
uniform 	float _GradLocationY;
uniform 	float _GradHighY;
...
void main()
{
    ...
    u_xlat1.x = in_TEXCOORD0.x + _TexXLocation;
    u_xlat1.y = in_TEXCOORD0.y + (-_TexYLocation);
    vs_TEXCOORD0.xy = vec2(u_xlat1.x / float(_TexScaleX), u_xlat1.y / float(_TexScaleY));
    vs_TEXCOORD0.zw = in_TEXCOORD0.xy * _SecTex_ST.xy + _SecTex_ST.zw;
    u_xlat6 = in_TEXCOORD0.y + _GradLocationY;
    vs_TEXCOORD1.y = u_xlat6 / _GradHighY;
    u_xlat6 = in_TEXCOORD1.x + _GradLocationX;
    vs_TEXCOORD1.x = u_xlat6 / _GradHighX;
...
void main()
{
    ...
    u_xlat7.x = floor(vs_TEXCOORD0.y);
    u_xlat7.x = max(u_xlat7.x, 0.0);
    u_xlati0.y = int(u_xlat7.x);
    u_xlatb0.xy = equal(u_xlati0.xyxx, ivec4(0, 0, 0, 0)).xy;
    u_xlatb0.x = u_xlatb0.y && u_xlatb0.x;
    u_xlat16_1.xyz = (-_GradBottomColor.xyz) + _GradTopColor.xyz;
    u_xlat7.xy = vs_TEXCOORD1.xy;
#ifdef UNITY_ADRENO_ES3
    u_xlat7.xy = min(max(u_xlat7.xy, 0.0), 1.0);
#else
    u_xlat7.xy = clamp(u_xlat7.xy, 0.0, 1.0);
#endif
    u_xlat16_1.xyz = u_xlat7.yyy * u_xlat16_1.xyz + _GradBottomColor.xyz;
    u_xlat16_2.xyz = (-_GradFrontColor.xyz) + _GradBackColor.xyz;
    u_xlat16_2.xyz = u_xlat7.xxx * u_xlat16_2.xyz + _GradFrontColor.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz;
    u_xlat14 = u_xlat7.x + -1.0;
    u_xlat16_22 = (-u_xlat7.x) + 1.0;
    u_xlat7.x = _CloudMaskIntensity * u_xlat14 + 1.0;
    u_xlat7.xyz = _TexRColor.xyz * u_xlat7.xxx + (-u_xlat16_1.xyz);
    u_xlat10_3.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_23 = u_xlat10_3.x * _TexRColor.w;
    u_xlat7.xyz = vec3(u_xlat16_23) * u_xlat7.xyz + u_xlat16_1.xyz;
    u_xlat16_2.xyz = _TexGColor.xyz * u_xlat16_2.xyz + (-u_xlat7.xyz);
    u_xlat16_23 = u_xlat10_3.y * _TexGColor.w;
    u_xlat16_4.xyz = u_xlat10_3.zzz * _TexBColor.xyz;
    u_xlat16_2.xyz = vec3(u_xlat16_23) * u_xlat16_2.xyz + u_xlat7.xyz;
    ...
    u_xlat16_2.xyz = u_xlat16_4.xyz * vec3(u_xlat16_22) + u_xlat16_2.xyz;
    u_xlat16_1.xyz = (u_xlatb0.x) ? u_xlat16_2.xyz : u_xlat16_1.xyz;
...
void main()
{
    ...
    vs_TEXCOORD0.xy = vec2(u_xlat1.x / float(_TexScaleX), u_xlat1.y / float(_TexScaleY));
    vs_TEXCOORD0.zw = in_TEXCOORD0.xy * _SecTex_ST.xy + _SecTex_ST.zw;
    u_xlat12 = in_TEXCOORD0.y + _GradLocationY;
    vs_TEXCOORD1.y = u_xlat12 / _GradHighY;
    u_xlat12 = in_TEXCOORD1.x + _GradLocationX;
    vs_TEXCOORD1.x = u_xlat12 / _GradHighX;
...
void main()
{
    ...
    vs_TEXCOORD0.xy = vec2(u_xlat1.x / float(_TexScaleX), u_xlat1.y / float(_TexScaleY));
    vs_TEXCOORD0.zw = in_TEXCOORD0.xy * _SecTex_ST.xy + _SecTex_ST.zw;
    u_xlat15 = in_TEXCOORD0.y + _GradLocationY;
    vs_TEXCOORD1.y = u_xlat15 / _GradHighY;
    u_xlat15 = in_TEXCOORD1.x + _GradLocationX;
    vs_TEXCOORD1.x = u_xlat15 / _GradHighX;
