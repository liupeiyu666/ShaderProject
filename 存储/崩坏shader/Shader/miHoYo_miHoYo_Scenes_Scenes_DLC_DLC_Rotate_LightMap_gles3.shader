...
void main()
{
    ...
    vs_TEXCOORD1.xy = in_TEXCOORD0.xy * _RotateTex_ST.xy + _RotateTex_ST.zw;
...
void main()
{
    u_xlat16_0 = max(_SinTime.z, 0.0);
    u_xlat1.x = _Time.y * _RotateSpeed;
    ...
    u_xlat3.y = u_xlat2.x;
    u_xlat3.x = (-u_xlat1.x);
    u_xlat1.xy = vec2(vs_TEXCOORD1.x + float(-0.5), vs_TEXCOORD1.y + float(-0.5));
    u_xlat2.x = dot(u_xlat1.xy, u_xlat3.yz);
    u_xlat2.y = dot(u_xlat1.xy, u_xlat3.xy);
    u_xlat1.xy = u_xlat2.xy + vec2(0.5, 0.5);
    u_xlat10_0 = texture(_RotateTex, u_xlat1.xy);
    u_xlat1.xyz = u_xlat10_0.xyz * _RotateColor.xyz;
    u_xlat25 = u_xlat10_0.w * _RotateOpacity;
    u_xlat16_4.x = (-u_xlat10_0.w) * _RotateOpacity + 1.0;
    u_xlat16_12.xyz = vec3(u_xlat25) * u_xlat1.xyz;
    u_xlat10_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat2.xyz = u_xlat10_1.xyz * _MainColor.xyz;
    u_xlat16_5.xyz = u_xlat10_1.xyz * _Color.xyz;
    u_xlat16_4.xyz = u_xlat2.xyz * u_xlat16_4.xxx + u_xlat16_12.xyz;
    ...
    u_xlat16_5.xyz = (-u_xlat16_5.xyz) * u_xlat16_6.xyz + vs_COLOR1.xyz;
    u_xlat16_5.xyz = vs_COLOR1.www * u_xlat16_5.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat10_0 = texture(_RotateTex, u_xlat1.xy);
    u_xlat1.xyz = u_xlat10_0.xyz * _RotateColor.xyz;
    u_xlat22 = u_xlat10_0.w * _RotateOpacity;
    u_xlat16_4.x = (-u_xlat10_0.w) * _RotateOpacity + 1.0;
    u_xlat16_11.xyz = vec3(u_xlat22) * u_xlat1.xyz;
    u_xlat10_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat2.xyz = u_xlat10_1.xyz * _MainColor.xyz;
    u_xlat16_5.xyz = u_xlat10_1.xyz * _Color.xyz;
    u_xlat16_4.xyz = u_xlat2.xyz * u_xlat16_4.xxx + u_xlat16_11.xyz;
    u_xlat16_1.xyz = texture(unity_Lightmap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_6.xyz = u_xlat16_1.xyz * unity_Lightmap_HDR.xxx;
    u_xlat16_6.xyz = u_xlat16_6.xyz * vec3(_LightMapIntensity) + _LightingColor.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz;
    u_xlat16_25 = vs_COLOR1.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_25 = min(max(u_xlat16_25, 0.0), 1.0);
#else
    u_xlat16_25 = clamp(u_xlat16_25, 0.0, 1.0);
#endif
    u_xlat16_5.xyz = u_xlat16_5.xyz * vec3(u_xlat16_25) + vs_COLOR1.xyz;
    SV_Target0.xyz = u_xlat16_4.xyz * u_xlat16_5.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat10_1.xyz * _Color.xyz;
    u_xlat16_4.xyz = u_xlat2.xyz * u_xlat16_4.xxx + u_xlat16_12.xyz;
    u_xlat10_1.xyz = texture(_PropertyLightmapTex, vs_TEXCOORD2.xy).xyz;
    u_xlat16_6.xyz = u_xlat10_1.xyz * vec3(_LightMapIntensity) + _LightingColor.xyz;
    u_xlat16_7.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz;
    u_xlat16_5.xyz = (-u_xlat16_5.xyz) * u_xlat16_6.xyz + vs_COLOR1.xyz;
    u_xlat16_5.xyz = vs_COLOR1.www * u_xlat16_5.xyz + u_xlat16_7.xyz;
    SV_Target0.xyz = u_xlat16_4.xyz * u_xlat16_5.xyz;
