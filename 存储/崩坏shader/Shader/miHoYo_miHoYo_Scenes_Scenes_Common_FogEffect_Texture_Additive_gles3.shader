...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Common/FogEffect_Texture_Additive" {
Properties {
...
void main()
{
    ...
    u_xlat10_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_0 = u_xlat16_0 * u_xlat10_1;
    u_xlat16_0.xyz = vs_COLOR1.www * (-u_xlat16_0.xyz) + u_xlat16_0.xyz;
    SV_Target0.w = u_xlat16_0.w;
...
void main()
{
    ...
    u_xlat16_1.xyz = (-u_xlat16_0.xyz) * vec3(u_xlat16_2) + u_xlat16_1.xxx;
    SV_Target0.w = u_xlat16_0.w;
    u_xlat16_1.xyz = vec3(_LumiFactor) * u_xlat16_1.xyz + u_xlat16_5.xyz;
    SV_Target0.xyz = u_xlat16_1.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_1 = u_xlat16_1 * vec4(vec4(_EmissionScaler, _EmissionScaler, _EmissionScaler, _EmissionScaler));
    u_xlat16_0 = u_xlat10_0 * u_xlat16_1;
    u_xlat16_1.xyz = vs_COLOR1.www * (-u_xlat16_0.xyz) + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_2.x = dot(u_xlat16_4.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_2.xyz = (-u_xlat16_0.xyz) * u_xlat16_1.xxx + u_xlat16_2.xxx;
