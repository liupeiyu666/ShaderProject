...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Special/MainMenu/Lightning" {
Properties {
...
void main()
{
    ...
    vs_TEXCOORD0.x = in_TEXCOORD0.x * _TexScaleX + _TexOffsetX;
...
void main()
{
    ...
    u_xlat16_1 = u_xlat10_0.w + -0.00999999978;
    ...
    SV_Target0.xyz = u_xlat10_0.xyz * vec3(_EmissionScaler);
