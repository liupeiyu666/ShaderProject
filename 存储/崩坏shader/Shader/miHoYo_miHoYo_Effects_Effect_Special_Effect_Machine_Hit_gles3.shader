...
void main()
{
    ...
    u_xlat1 = in_TEXCOORD2.xxxx + (-_Random1234);
    u_xlat1.x = u_xlat1.y * u_xlat1.x;
    u_xlat1.x = u_xlat1.z * u_xlat1.x;
    u_xlat1.x = u_xlat1.w * u_xlat1.x;
    u_xlat2 = in_TEXCOORD2.xxxx + (-_Random5678);
    u_xlat1.x = u_xlat1.x * u_xlat2.x;
    u_xlat1.x = u_xlat2.y * u_xlat1.x;
    u_xlat1.x = u_xlat2.z * u_xlat1.x;
    u_xlat1.x = u_xlat2.w * u_xlat1.x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(abs(u_xlat1.x)>=1.0);
#else
    u_xlatb1 = abs(u_xlat1.x)>=1.0;
#endif
    vs_COLOR0.w = (u_xlatb1) ? 0.0 : in_COLOR0.w;
...
void main()
{
    u_xlat16_0 = vs_COLOR0.w * _MainColor.w;
    u_xlat16_0 = u_xlat16_0 * _OutsideEmission;
    u_xlat10_1 = texture(_MainTex, vs_TEXCOORD0.xy).w;
    u_xlat16_0 = u_xlat16_0 * u_xlat10_1;
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(0.0<vs_COLOR0.w);
#else
    u_xlatb1 = 0.0<vs_COLOR0.w;
#endif
    SV_Target0.w = (u_xlatb1) ? _BloomFactor : u_xlat16_0;
    u_xlat10_1 = texture(_LightMaskTex, vs_TEXCOORD0.xy).x;
    u_xlat16_1 = u_xlat10_1 * _InsideEmission;
    u_xlat1.xyz = vec3(u_xlat16_1) * _LightColor.xyz;
    SV_Target0.xyz = vs_COLOR1.www * (-u_xlat1.xyz) + u_xlat1.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat1 = in_TEXCOORD2.xxxx + (-_Random5678);
    u_xlat12 = u_xlat12 * u_xlat1.x;
    u_xlat12 = u_xlat1.y * u_xlat12;
    u_xlat12 = u_xlat1.z * u_xlat12;
    u_xlat12 = u_xlat1.w * u_xlat12;
#ifdef UNITY_ADRENO_ES3
    u_xlatb12 = !!(abs(u_xlat12)>=1.0);
#else
    u_xlatb12 = abs(u_xlat12)>=1.0;
#endif
    vs_COLOR0.w = (u_xlatb12) ? 0.0 : in_COLOR0.w;
    vs_COLOR0.xyz = in_COLOR0.xyz;
...
void main()
{
    ...
    u_xlat16_1 = u_xlat10_1 * _InsideEmission;
    u_xlat1.xyz = vec3(u_xlat16_1) * _LightColor.xyz;
    u_xlat16_0 = vs_COLOR1.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_0 = min(max(u_xlat16_0, 0.0), 1.0);
#else
    u_xlat16_0 = clamp(u_xlat16_0, 0.0, 1.0);
#endif
    SV_Target0.xyz = vec3(u_xlat16_0) * u_xlat1.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat15 = u_xlat1.w * u_xlat15;
#ifdef UNITY_ADRENO_ES3
    u_xlatb15 = !!(abs(u_xlat15)>=1.0);
#else
    u_xlatb15 = abs(u_xlat15)>=1.0;
#endif
    vs_COLOR0.w = (u_xlatb15) ? 0.0 : in_COLOR0.w;
    vs_COLOR0.xyz = in_COLOR0.xyz;
