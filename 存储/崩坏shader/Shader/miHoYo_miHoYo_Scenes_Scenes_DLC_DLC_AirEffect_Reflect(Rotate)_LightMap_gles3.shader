...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat10_2.xyz * _Color.xyz + u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz * _Color.xyz;
    u_xlat16_1.xyz = texture(unity_Lightmap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_1.xyz * unity_Lightmap_HDR.xxx;
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(_LightMapIntensity) + _LightingColor.xyz;
    ...
    u_xlat2.xyz = u_xlat16_0.xyz * vec3(_LightMapIntensity);
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_0.xyz = (-u_xlat1.xyz) + vs_COLOR1.xyz;
    SV_Target0.xyz = vs_COLOR1.www * u_xlat16_0.xyz + u_xlat1.xyz;
...
#endif
    u_xlat1.xyz = (bool(u_xlatb13)) ? u_xlat1.xyz : u_xlat2.xyz;
    u_xlat16_0.x = vs_COLOR1.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_0.x = min(max(u_xlat16_0.x, 0.0), 1.0);
#else
    u_xlat16_0.x = clamp(u_xlat16_0.x, 0.0, 1.0);
#endif
    SV_Target0.xyz = u_xlat1.xyz * u_xlat16_0.xxx + vs_COLOR1.xyz;
    SV_Target0.w = _BloomFactor;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_1.xyz * vec3(_LightMapIntensity) + _LightingColor.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_3.xyz;
    u_xlat1.x = _Time.y * _Speed;
    u_xlat1.x = fract(u_xlat1.x);
    u_xlat1.x = u_xlat1.x + -0.5;
