...
uniform 	float _ScrollU1;
uniform 	float _ScrollV1;
uniform 	float _ScrollU2;
uniform 	float _ScrollV2;
...
void main()
{
    u_xlat0 = _Time.xyxy * vec4(_ScrollU1, _ScrollV1, _ScrollU2, _ScrollV2) + vs_TEXCOORD0.xyxy;
    u_xlat10_1 = texture(_MainTex, u_xlat0.xy);
    u_xlat10_0 = texture(_MainTex2, u_xlat0.zw);
    u_xlat16_0 = u_xlat10_0 * u_xlat10_1;
    u_xlat16_0 = u_xlat16_0 * _Color;
    u_xlat0 = u_xlat16_0 * vs_COLOR0;
    u_xlat0 = u_xlat0 * vec4(_Boost);
