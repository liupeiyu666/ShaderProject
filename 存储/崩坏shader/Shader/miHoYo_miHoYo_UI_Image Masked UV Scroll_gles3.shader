...
void main()
{
    ...
    u_xlat0.zw = vec2(u_xlat0.x + _UVScrollVelocity.z, u_xlat0.y + _UVScrollVelocity.w);
...
void main()
{
    ...
    vs_COLOR0 = u_xlat1;
    u_xlat1.xy = _UVScrollVelocity.xy * _Time.yy + in_TEXCOORD0.xy;
    u_xlat1.zw = vec2(u_xlat1.x + _UVScrollVelocity.z, u_xlat1.y + _UVScrollVelocity.w);
...
void main()
{
    ...
    u_xlat10_2.x = texture(_MaskTex, vs_TEXCOORD0.xy).w;
    u_xlat16_2.x = u_xlat10_2.x * vs_COLOR0.w;
    SV_Target0.w = u_xlat16_0.x * u_xlat16_2.x;
