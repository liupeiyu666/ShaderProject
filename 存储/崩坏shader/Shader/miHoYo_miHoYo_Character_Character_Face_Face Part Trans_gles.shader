...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Character/Character_Face/Face Part Trans" {
Properties {
...
_SaturateOffset ("Saturation Offset", Range(-1, 1)) = 0
_ValueOffset ("Value Offset", Range(-1, 1)) = 0
[Toggle(USINGDITHERALPAH)] _UsingDitherAlpha ("UsingDitherAlpha", Float) = 0
_DitherAlpha ("Dither Alpha Value", Range(0, 1)) = 1
_Transparent ("Trans", Range(0, 1)) = 1
}
SubShader {
...
void main ()
{
  ...
  color_25 = outColor_2.xyz;
  mediump vec3 tmpvar_26;
  if ((_lightProbToggle > 0.5)) {
    tmpvar_26 = _lightProbColor.xyz;
  } else {
    tmpvar_26 = vec3(1.0, 1.0, 1.0);
  };
  color_25 = (outColor_2.xyz * tmpvar_26);
  outColor_2.xyz = color_25;
  outColor_2.w = (outColor_2.w * _Transparent);
  if (bool(_UsingDitherAlpha)) {
    highp vec4 scrpos_27;
    scrpos_27 = xlv_TEXCOORD2;
    mediump float a_28;
    a_28 = xlv_TEXCOORD2.z;
    if ((a_28 < 0.95)) {
      scrpos_27.xy = ((xlv_TEXCOORD2.xy / xlv_TEXCOORD2.w) * _ScreenParams.xy);
      a_28 = (a_28 * 17.0);
