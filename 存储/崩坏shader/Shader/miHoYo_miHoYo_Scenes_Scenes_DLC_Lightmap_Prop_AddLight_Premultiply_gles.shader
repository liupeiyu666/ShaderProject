...
void main ()
{
  ...
  if ((_EnableMatcapSpecular > 0.0)) {
    ...
    tmpvar_28 = ((tmpvar_26 * _SpecularIntensity) * matcapMaskColor_8.x).xyz;
    matcapSpecular_3 = tmpvar_28;
  };
  lowp vec4 tmpvar_29;
  tmpvar_29 = texture2D (_MatCap, tmpvar_25);
  mc_2 = tmpvar_29;
  mc_2.xyz = ((mc_2.xyz * tmpvar_20) * (vec3(2.0, 2.0, 2.0) * tmpvar_22));
  highp vec3 tmpvar_30;
  tmpvar_30 = ((mc_2.xyz * matcapMaskColor_8.x) + ((tmpvar_20 * tmpvar_22) * (1.0 - matcapMaskColor_8.x)));
  finalColor_1 = tmpvar_30;
  finalColor_1 = ((finalColor_1 * alpha_5) + matcapSpecular_3);
  mediump vec3 tmpvar_31;
  tmpvar_31 = mix (finalColor_1, xlv_COLOR1.xyz, xlv_COLOR1.www);
  finalColor_1 = tmpvar_31;
  mediump float tmpvar_32;
  tmpvar_32 = clamp (alpha_5, 0.0, 1.0);
  alpha_5 = tmpvar_32;
...
void main ()
{
  ...
  if ((_EnableMatcapSpecular > 0.0)) {
    ...
    tmpvar_30 = ((tmpvar_28 * _SpecularIntensity) * matcapMaskColor_8.x).xyz;
    matcapSpecular_3 = tmpvar_30;
  };
  lowp vec4 tmpvar_31;
  tmpvar_31 = texture2D (_MatCap, tmpvar_27);
  mc_2 = tmpvar_31;
  mc_2.xyz = ((mc_2.xyz * tmpvar_22) * (vec3(2.0, 2.0, 2.0) * tmpvar_24));
  highp vec3 tmpvar_32;
  tmpvar_32 = ((mc_2.xyz * matcapMaskColor_8.x) + ((tmpvar_22 * tmpvar_24) * (1.0 - matcapMaskColor_8.x)));
  finalColor_1 = tmpvar_32;
  finalColor_1 = ((finalColor_1 * alpha_5) + matcapSpecular_3);
  mediump vec3 tmpvar_33;
  tmpvar_33 = mix (finalColor_1, xlv_COLOR1.xyz, xlv_COLOR1.www);
  finalColor_1 = tmpvar_33;
  mediump float tmpvar_34;
  tmpvar_34 = clamp (alpha_5, 0.0, 1.0);
  alpha_5 = tmpvar_34;
