...
void main()
{
    ...
    u_xlat16_1 = u_xlat10_0 + 0.100000001;
    u_xlat16_1 = u_xlat16_1 * maskScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_1 = min(max(u_xlat16_1, 0.0), 1.0);
#else
    u_xlat16_1 = clamp(u_xlat16_1, 0.0, 1.0);
#endif
    u_xlat16_1 = u_xlat16_1 * _EmissionScaler;
...
void main()
{
    ...
    u_xlat10_2 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_0 = u_xlat16_0 * u_xlat10_2;
    u_xlat16_4.xyz = vec3(u_xlat16_1) * u_xlat16_0.xyz;
    u_xlat16_2 = dot(u_xlat16_4.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_0.xyz = (-u_xlat16_0.xyz) * vec3(u_xlat16_1) + vec3(u_xlat16_2);
    SV_Target0.w = u_xlat16_0.w;
#ifdef UNITY_ADRENO_ES3
    SV_Target0.w = min(max(SV_Target0.w, 0.0), 1.0);
#else
...
void main()
{
    ...
    u_xlat16_3 = u_xlat16_3 * maskScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_3 = min(max(u_xlat16_3, 0.0), 1.0);
#else
    u_xlat16_3 = clamp(u_xlat16_3, 0.0, 1.0);
#endif
    u_xlat16_3 = u_xlat16_3 * _EmissionScaler;
    SV_Target0.xyz = u_xlat16_1.xyz * vec3(u_xlat16_3);
...
void main()
{
    ...
    SV_Target0.w = clamp(SV_Target0.w, 0.0, 1.0);
#endif
    u_xlat16_0.x = dot(u_xlat16_7.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat16_0.xyz = (-u_xlat16_1.xyz) * vec3(u_xlat16_3) + u_xlat16_0.xxx;
    u_xlat16_0.xyz = vec3(vec3(_LumiFactor, _LumiFactor, _LumiFactor)) * u_xlat16_0.xyz + u_xlat16_7.xyz;
    SV_Target0.xyz = u_xlat16_0.xyz;
    return;
}
