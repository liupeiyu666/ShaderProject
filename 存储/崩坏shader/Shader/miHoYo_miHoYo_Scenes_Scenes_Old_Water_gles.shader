...
void main ()
{
  ...
  outcolor_1.xyz = (_RefractionColor.xyz + (tmpvar_6.xyz * _Caustic));
...
void main ()
{
  ...
  accNormal_3 = tmpvar_4;
  highp vec2 tmpvar_5;
  tmpvar_5.x = ((accNormal_3.x * _Distortion) / xlv_TEXCOORD4.y);
  tmpvar_5.y = ((accNormal_3.y * _Distortion2) / xlv_TEXCOORD4.y);
  texoffset_2 = tmpvar_5;
  outcolor_1.w = _RefractionColor.w;
  lowp vec4 tmpvar_6;
  highp vec2 P_7;
...
void main ()
{
  ...
  lowp vec4 tmpvar_6;
  highp vec2 P_7;
  P_7 = ((xlv_TEXCOORD3.xy / xlv_TEXCOORD3.w) - texoffset_2);
  tmpvar_6 = texture2D (_ReflectionTex, P_7);
  mediump vec4 tmpvar_8;
  tmpvar_8 = (tmpvar_6 * _RefColor);
  highp vec4 tmpvar_9;
  tmpvar_9 = mix (_RefractionColor, tmpvar_8, vec4((xlv_TEXCOORD4.x * xlv_TEXCOORD4.z)));
  outcolor_1 = tmpvar_9;
  lowp vec4 tmpvar_10;
  highp vec2 P_11;
  P_11 = (xlv_TEXCOORD2 - (texoffset_2 * 5.0));
  tmpvar_10 = texture2D (_CausticMap, P_11);
  outcolor_1.xyz = (outcolor_1.xyz + (tmpvar_10.xyz * _Caustic));
  outcolor_1.xyz = mix (outcolor_1.xyz, xlv_COLOR1.xyz, xlv_COLOR1.www);
  outcolor_1.w = _BloomFactor;
  gl_FragData[0] = outcolor_1;
}
