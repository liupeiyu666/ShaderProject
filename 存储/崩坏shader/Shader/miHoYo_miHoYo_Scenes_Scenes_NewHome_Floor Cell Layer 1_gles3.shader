...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_NewHome/Floor Cell Layer 1" {
Properties {
...
uniform 	mediump float _FillRatio;
...
void main()
{
    ...
    u_xlat16_2 = u_xlat16_2 * vec4(vec4(_FillRatio, _FillRatio, _FillRatio, _FillRatio));
    u_xlat16_0 = u_xlat16_0 * u_xlat10_1 + u_xlat16_2;
...
void main()
{
    ...
    u_xlat16_2 = u_xlat16_1 * u_xlat16_2.xxxx;
    u_xlat16_2 = u_xlat16_2 * vec4(vec4(_FillRatio, _FillRatio, _FillRatio, _FillRatio));
    u_xlat16_0 = u_xlat16_1 * u_xlat10_0 + u_xlat16_2;
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler));
    SV_Target0.w = u_xlat16_0.w;
#ifdef UNITY_ADRENO_ES3
    SV_Target0.w = min(max(SV_Target0.w, 0.0), 1.0);
