...
void main ()
{
  ...
  text_C_Color_4.xyz = (text_C_Color_4.xyz * _EnvColor.xyz);
  lowp vec3 tmpvar_8;
...
void main ()
{
  ...
  text_C_Color_6.xyz = (text_C_Color_6.xyz * _EnvColor.xyz);
  lowp vec3 tmpvar_10;
...
void main ()
{
  ...
  outColor_2.w = (outColor_2.w * tmpvar_3.w);
  highp vec4 scrpos_4;
...
void main ()
{
  ...
  xlv_TEXCOORD0 = tmpvar_7;
  xlv_TEXCOORD1 = ((_glesMultiTexCoord0.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
  xlv_TEXCOORD2 = ((tmpvar_16 * _SPNoiseTex_ST.xy) + _SPNoiseTex_ST.zw);
}
...
void main ()
{
  ...
  mediump vec4 outColor_5;
  outColor_5 = _SPOutlineColor;
  lowp vec4 tmpvar_6;
  tmpvar_6 = texture2D (_SPNoiseTex, xlv_TEXCOORD2);
  highp float tmpvar_7;
  tmpvar_7 = (((1.99 * tmpvar_6.x) * _SPNoiseScaler) - 1.0);
  intensity_4 = tmpvar_7;
  xlat_mutable_SPTransition = (_SPTransition * _SPNoiseScaler);
  if ((intensity_4 >= (1.7 * xlat_mutable_SPTransition))) {
    outColor_5 = outColor_2;
  };
  outColor_2 = outColor_5;
  highp vec4 scrpos_8;
  scrpos_8 = xlv_TEXCOORD0;
  mediump float a_9;
  a_9 = xlv_TEXCOORD0.z;
  if ((a_9 < 0.95)) {
    scrpos_8.xy = ((xlv_TEXCOORD0.xy / xlv_TEXCOORD0.w) * _ScreenParams.xy);
    a_9 = (a_9 * 17.0);
    highp float tmpvar_10;
    tmpvar_10 = (scrpos_8.y / 4.0);
    highp float tmpvar_11;
  ...
  outColor_2.w = clamp (outColor_5.w, 0.0, 1.0);
  tmpvar_1 = outColor_2;
  gl_FragData[0] = tmpvar_1;
}
