...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Special/Island/Platform" {
Properties {
...
SubShader {
 LOD 200
 Tags { "DrawDepth" = "FrontFace" "IGNOREPROJECTOR" = "true" "OutlineType" = "None" "QUEUE" = "Geometry" "RenderType" = "Opaque" }
 Pass {
  LOD 200
  Tags { "DrawDepth" = "FrontFace" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "OutlineType" = "None" "QUEUE" = "Geometry" "RenderType" = "Opaque" }
  GpuProgramID 31831
Program "vp" {
...
uniform 	mediump float _EmissionToggle;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * vec3(_LightMapIntensity);
    u_xlat16_14 = _EmissionScaler + -1.0;
    u_xlat16_14 = u_xlat10_1.w * u_xlat16_14 + 1.0;
    u_xlat16_3.xyz = vec3(u_xlat16_14) * u_xlat16_2.xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(0.5<_EmissionToggle);
#else
    u_xlatb0 = 0.5<_EmissionToggle;
#endif
    SV_Target0.xyz = (bool(u_xlatb0)) ? u_xlat16_3.xyz : u_xlat16_2.xyz;
    u_xlat16_2.x = _EmissionBloomFactor + (-_BloomFactor);
    u_xlat16_2.x = u_xlat10_1.w * u_xlat16_2.x + _BloomFactor;
    SV_Target0.w = (u_xlatb0) ? u_xlat16_2.x : _BloomFactor;
    return;
}
