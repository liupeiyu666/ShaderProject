...
void main()
{
    ...
    u_xlat16_1.xy = in_TEXCOORD0.xy * _FrontTex_ST.xy + _FrontTex_ST.zw;
    ...
    if(u_xlatb26){
        ...
        u_xlat26 = u_xlat26 + (-_FogStartDistance);
        u_xlat26 = max(u_xlat26, 0.0);
        u_xlat6.xy = vec2(u_xlat26) * vec2(_FogIntensity, _FogColorIntensity);
        u_xlat6.xy = u_xlat6.xy * (-u_xlat6.xy);
        u_xlat26 = u_xlat6.x * _FogTune;
        u_xlat26 = u_xlat26 * 1.44269502;
        u_xlat26 = exp2(u_xlat26);
        u_xlat26 = (-u_xlat26) + 1.0;
        u_xlat26 = u_xlat26 * _FogEffectLimit;
        u_xlat27 = _FogEffectStart * _FogTune;
        u_xlat26 = max(u_xlat26, u_xlat27);
        u_xlat7.w = min(u_xlat26, _FogEffectLimit);
        u_xlat26 = u_xlat6.y * 1.44269502;
        u_xlat26 = exp2(u_xlat26);
        u_xlat6.xyz = _FogColorNear.xyz + (-_FogColorFar.xyz);
        u_xlat7.xyz = vec3(u_xlat26) * u_xlat6.xyz + _FogColorFar.xyz;
        vs_COLOR1 = u_xlat7;
    } else {
        u_xlat6.xyz = u_xlat2.xyz + (-_WorldSpaceCameraPos.xyz);
        u_xlat26 = dot(u_xlat6.xyz, u_xlat6.xyz);
        ...
        u_xlat26 = _FogEndDistance * _FogTune + (-_FogStartDistance);
        u_xlat26 = max(u_xlat26, 0.100000001);
        u_xlat6.xy = u_xlat6.yx / vec2(u_xlat26);
        u_xlat26 = u_xlat6.y * _FogEffectLimit;
        u_xlat27 = _FogEffectStart * _FogTune;
        u_xlat26 = max(u_xlat26, u_xlat27);
        u_xlat7.w = min(u_xlat26, _FogEffectLimit);
        u_xlat6.x = u_xlat6.x;
    ...
    u_xlat0 = u_xlat0 * in_POSITION0.x + u_xlat8;
    u_xlat0 = u_xlat16 * in_POSITION0.z + u_xlat0;
    u_xlat0 = u_xlat24 * in_POSITION0.w + u_xlat0;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_4.xyz * vec3(_LightMapIntensity);
...
void main()
{
    ...
    u_xlat0.x = u_xlat5.x * in_POSITION0.w + u_xlat0.x;
    u_xlat0.x = (-u_xlat0.x) + (-_ProjectionParams.y);
    u_xlat0.x = u_xlat0.x + (-_FadeOffset);
    u_xlat0.x = u_xlat0.x / _FadeDistance;
#ifdef UNITY_ADRENO_ES3
