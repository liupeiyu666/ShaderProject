...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Character/Character_Avatar/Avatar_Crystal_Spectrum_Bump" {
Properties {
...
(101,8): error: illegal use of reserved word `input'
(101,8): error: syntax error, unexpected ERROR_TOK, expecting IDENTIFIER or TYPE_IDENTIFIER or NEW_IDENTIFIER or '{'
*/
...
/* HLSL2GLSL - NOTE: GLSL optimization failed
(260,8): error: illegal use of reserved word `input'
(260,8): error: syntax error, unexpected ERROR_TOK, expecting IDENTIFIER or TYPE_IDENTIFIER or NEW_IDENTIFIER or '{'
*/
