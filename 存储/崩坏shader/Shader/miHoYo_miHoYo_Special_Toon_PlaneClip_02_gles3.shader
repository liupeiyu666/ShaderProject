...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Special/Toon/PlaneClip_02" {
Properties {
...
void main()
{
    ...
    u_xlat12 = dot(u_xlat0, _ClipPlane);
    ...
    u_xlatb12 = u_xlat12<0.0;
#endif
    vs_COLOR0.w = (u_xlatb12) ? 0.0 : u_xlat1.x;
    ...
    u_xlat4.xy = u_xlat4.xx * vec2(0.497500002, 0.497500002) + vec2(0.5, 0.5);
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlat0.x = log2(u_xlat0.x);
    u_xlat0.x = u_xlat0.x * _Shininess;
    u_xlat0.x = exp2(u_xlat0.x);
#ifdef UNITY_ADRENO_ES3
    u_xlatb12 = !!(0.5>=u_xlat4.y);
#else
    u_xlatb12 = 0.5>=u_xlat4.y;
#endif
    vs_TEXCOORD1.xy = u_xlat4.xy;
    u_xlat16_3.xy = (bool(u_xlatb12)) ? vec2(0.0250000004, 0.0250000004) : u_xlat0.xx;
    vs_COLOR0.xyz = u_xlat16_3.yyy;
...
void main()
{
    ...
    vs_COLOR0.w = (u_xlatb6) ? 0.0 : u_xlat0.x;
