...
void main()
{
    u_xlat16_0.xyz = _miHoYo_Indoor_Tint_Color.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_0.xyz = vec3(_TiltFactor) * u_xlat16_0.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_1.xyz = (-u_xlat16_0.xyz) + vec3(vec3(_EmissionScaler, _EmissionScaler, _EmissionScaler));
    u_xlat10_2 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_1.xyz = u_xlat10_2.www * u_xlat16_1.xyz + u_xlat16_0.xyz;
