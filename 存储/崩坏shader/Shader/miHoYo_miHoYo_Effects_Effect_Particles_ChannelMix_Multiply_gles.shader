...
void main ()
{
  ...
  o_3.xyz = mix (vec3(1.0, 1.0, 1.0), o_3.xyz, o_3.www);
  gl_FragData[0] = o_3;
}
...
void main ()
{
  ...
  o_4.xyz = mix (vec3(1.0, 1.0, 1.0), o_4.xyz, o_4.www);
  gl_FragData[0] = o_4;
}
...
void main ()
{
  ...
  o_5.xyz = mix (vec3(1.0, 1.0, 1.0), o_5.xyz, o_5.www);
  gl_FragData[0] = o_5;
}
...
void main ()
{
  ...
  o_6.xyz = mix (vec3(1.0, 1.0, 1.0), o_6.xyz, o_6.www);
  gl_FragData[0] = o_6;
}
