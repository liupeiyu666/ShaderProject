...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Scenes/Scenes_Old/Water" {
Properties {
...
[Toggle(DISTORT)] _Distortion_xy ("Distortion xy", Float) = 0
_Distortion ("Distortion", Float) = 1
_Distortion2 ("Distortion 2", Float) = 1
...
void main()
{
    ...
    vs_TEXCOORD0.xy = vec2(_BumpVelocity0.x, _BumpVelocity0.y) * _Time.yy + u_xlat1.xy;
    vs_TEXCOORD1.xy = vec2(_BumpVelocity1.x, _BumpVelocity1.y) * _Time.yy + u_xlat1.zw;
    u_xlat1.xy = vec2(_Time.y * _CausticVelocity.xxyx.y, _Time.y * float(_CausticVelocity.y));
...
void main()
{
    ...
    u_xlat10_4.xy = texture(_NormalMap, vs_TEXCOORD1.xy).xy;
    ...
    u_xlat16_0.xyz = u_xlat10_0.xyz * vec3(_Caustic) + _RefractionColor.xyz;
...
void main()
{
    ...
    gl_Position = u_xlat1;
    u_xlat2 = in_TEXCOORD0.xyxy * vec4(_BumpScale0, _BumpScale0, _BumpScale1, _BumpScale1);
    vs_TEXCOORD0.xy = vec2(_BumpVelocity0.x, _BumpVelocity0.y) * _Time.yy + u_xlat2.xy;
    vs_TEXCOORD1.xy = vec2(_BumpVelocity1.x, _BumpVelocity1.y) * _Time.yy + u_xlat2.zw;
    u_xlat2.xy = vec2(_Time.y * _CausticVelocity.xxyx.y, _Time.y * float(_CausticVelocity.y));
...
uniform 	mediump vec4 _RefractionColor;
uniform 	mediump float _Distortion;
uniform 	mediump float _Distortion2;
uniform 	mediump float _Caustic;
uniform 	mediump float _BloomFactor;
uniform lowp sampler2D _NormalMap;
uniform lowp sampler2D _CausticMap;
...
void main()
{
    ...
    u_xlat16_0.xy = u_xlat10_4.xy + u_xlat10_0.xy;
    u_xlat16_0.xy = u_xlat16_0.xy + vec2(-0.600000024, -0.600000024);
    u_xlat16_1.xy = u_xlat16_0.xy * vec2(_Distortion, _Distortion2);
    u_xlat0.xy = u_xlat16_1.xy / vs_TEXCOORD4.yy;
    u_xlat0.xy = (-u_xlat0.xy) * vec2(5.0, 5.0) + vs_TEXCOORD2.xy;
    u_xlat10_0.xyz = texture(_CausticMap, u_xlat0.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * vec3(_Caustic) + _RefractionColor.xyz;
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_HEIGHT" "FOG_LERP" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    ...
    u_xlat10_0.xyz = texture(_ReflectionTex, u_xlat6.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * _RefColor.xyz + (-_RefractionColor.xyz);
    u_xlat9 = vs_TEXCOORD4.z * vs_TEXCOORD4.x;
    u_xlat0.xyz = vec3(u_xlat9) * u_xlat16_0.xyz + _RefractionColor.xyz;
    u_xlat0.xyz = u_xlat10_2.xyz * vec3(_Caustic) + u_xlat0.xyz;
...
SubProgram "gles3 hw_tier00 " {
Keywords { "_USE_REFLECTION" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LERP" "_USE_REFLECTION" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_HEIGHT" "_USE_REFLECTION" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_HEIGHT" "FOG_LERP" "_USE_REFLECTION" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LUMINANCE" "FOG_LERP" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LUMINANCE" "FOG_HEIGHT" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LUMINANCE" "FOG_HEIGHT" "FOG_LERP" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LUMINANCE" "_USE_REFLECTION" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LUMINANCE" "FOG_LERP" "_USE_REFLECTION" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LUMINANCE" "FOG_HEIGHT" "_USE_REFLECTION" "DISTORT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LUMINANCE" "FOG_HEIGHT" "FOG_LERP" "_USE_REFLECTION" "DISTORT" }
"#ifdef VERTEX
#version 300 es
