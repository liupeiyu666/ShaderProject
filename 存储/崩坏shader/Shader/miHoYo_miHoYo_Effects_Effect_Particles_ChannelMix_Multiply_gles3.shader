...
//
///////////////////////////////////////////
Shader "miHoYo/miHoYo_Effects/Effect_Particles/ChannelMix/Multiply" {
Properties {
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * vec3(_EmissionScaler) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat16_11 = (u_xlatb1.w) ? u_xlat16_0.w : vs_COLOR0.w;
    u_xlat16_11 = (u_xlatb1.z) ? u_xlat16_0.z : u_xlat16_11;
    u_xlat16_11 = (u_xlatb1.y) ? u_xlat16_0.y : u_xlat16_11;
    u_xlat16_11 = (u_xlatb1.x) ? u_xlat16_0.x : u_xlat16_11;
    SV_TARGET0.xyz = vec3(u_xlat16_11) * u_xlat16_2.xyz + vec3(1.0, 1.0, 1.0);
...
void main()
{
    ...
    u_xlat16_11 = (u_xlatb1.y) ? u_xlat16_0.y : u_xlat16_11;
    u_xlat16_11 = (u_xlatb1.x) ? u_xlat16_0.x : u_xlat16_11;
    u_xlat16_2.xyz = vec3(u_xlat16_11) * u_xlat16_2.xyz + vec3(1.0, 1.0, 1.0);
    SV_TARGET0.w = u_xlat16_11;
...
void main()
{
    ...
    u_xlat16_9 = (u_xlatb1.w) ? u_xlat2.w : 0.0;
    u_xlat16_9 = (u_xlatb1.z) ? u_xlat2.z : u_xlat16_9;
    u_xlat16_9 = (u_xlatb1.y) ? u_xlat2.y : u_xlat16_9;
    u_xlat16_9 = (u_xlatb1.x) ? u_xlat2.x : u_xlat16_9;
    u_xlat16_0.xyz = vec3(u_xlat16_9) * u_xlat16_0.xyz + _ColorB.xyz;
    ...
    u_xlat16_0.xyz = vec3(u_xlat16_9) * u_xlat16_0.xyz + _ColorC.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(_EmissionScaler) + vec3(-1.0, -1.0, -1.0);
    u_xlatb2 = equal(vec4(vec4(_AlphaChannelMapping, _AlphaChannelMapping, _AlphaChannelMapping, _AlphaChannelMapping)), vec4(0.0, 1.0, 2.0, 3.0));
...
void main()
{
    ...
    u_xlat16_9 = (u_xlatb1.x) ? u_xlat2.x : u_xlat16_9;
    u_xlat16_1 = u_xlat2 * vs_COLOR0.wwww;
    u_xlat16_0.xyz = vec3(u_xlat16_9) * u_xlat16_0.xyz + vs_TEXCOORD1.yzw;
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(_EmissionScaler) + vec3(-1.0, -1.0, -1.0);
    u_xlatb2 = equal(vec4(vec4(_AlphaChannelMapping, _AlphaChannelMapping, _AlphaChannelMapping, _AlphaChannelMapping)), vec4(0.0, 1.0, 2.0, 3.0));
    u_xlat16_9 = (u_xlatb2.w) ? u_xlat16_1.w : vs_COLOR0.w;
    u_xlat16_9 = (u_xlatb2.z) ? u_xlat16_1.z : u_xlat16_9;
