...
Shader "Yu/ToonHair"
{
    Properties
    {
	   ...
	   _Color("Color",Color)=(0,0,0,0)
		...
		_Bump("Texture", 2D) = "white" {}
		_Ramp("Texture", 2D) = "white" {}
		_DetailOutLineSize("DetailOutLineSize",float)=0.2
			_DetailOutLineColor("_DetailOutLineColor",Color)=(0,0,0,0)
			_Specular("_DetailOutLineColor",Color) = (0,0,0,0)
			_SpecularScale("DetailOutLineSize",float) = 0.2
			_MainHairSpecularSmooth("DetailOutLineSize",float) = 0.2
			_FuHairSpecularSmooth("DetailOutLineSize",float) = 0.2
			_MainHairSpecularOff("DetailOutLineSize",float) = 0.2
			_FuHairSpecularOff("DetailOutLineSize",float) = 0.2
			_HairLightRamp("Texture", 2D) = "white" {}
			_RefractionCount("DetailOutLineSize",float) = 0.2
			_ReflectionCount("DetailOutLineSize",float) = 0.2

			_edgeLightOff("DetailOutLineSize",float) = 0.2
			_LightMapMask("Texture", 2D) = "white" {}
    }
    SubShader
    {
